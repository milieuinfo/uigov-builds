"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[9164],{"./libs/components/src/pager/vl-pager.component.ts":(e,t,i)=>{i.d(t,{o:()=>o});var r=i("./libs/common/utilities/src/index.ts"),s=i("./node_modules/@domg/govflanders-style/component/index.js"),a=i("./node_modules/@domg/govflanders-style/common/index.js"),l=i("./node_modules/lit/index.js");let n=(0,l.iv)`
    [hidden] {
        display: none;
    }
...
`;class o extends(0,r.W$)(HTMLElement){static get _observedAttributes(){return["total-items","items-per-page","current-page","pagination-disabled"]}static get _observedChildClassAttributes(){return["align-center","align-right"]}constructor(){super(),this.shadow(`
          <style>
            ${a.YN}
            ${s.wM}
            ${n}
...
`,o=[...s.CX,n];class d extends(0,r.W$)(HTMLElement){static{(0,r.YV)([s.d7,s.CH,s.tB,s.YY,s.Gi,a.o])}static get _observedAttributes(){return["data","collapsed-m","collapsed-s","collapsed-xs","filter-closable","filter-closed"]}static get _defaultSearchColumnSize(){return 4}constructor(e="",t=""){super(`
          <style>
            ${o}
          </style>
          <div>
