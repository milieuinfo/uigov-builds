"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[1314],{"./apps/storybook/docs/e_ontwerp/form/2_demo/form-demo.stories.ts":(e,t,l)=>{l.r(t),l.d(t,{Demo:()=>V,__namedExportsOrder:()=>C,default:()=>$});var r=l("./node_modules/lit-html/lit-html.js"),s=l("./libs/common/utilities/src/index.ts"),o=l("./node_modules/tslib/tslib.es6.mjs"),n=l("./node_modules/lit/index.js"),i=l("./libs/form/src/next/form-label/index.ts"),a=l("./libs/form/src/next/error-message/index.ts"),d=l("./libs/elements/src/index.ts"),c=l("./libs/form/src/next/input-field/index.ts"),m=l("./libs/form/src/next/input-field-masked/vl-input-field-masked.component.ts"),u=l("./libs/form/src/next/textarea/vl-textarea.component.ts"),v=l("./libs/form/src/next/select/index.ts"),h=l("./libs/form/src/next/checkbox/vl-checkbox.component.ts"),p=l("./libs/form/src/next/radio-group/vl-radio.component.ts"),b=l("./libs/form/src/next/radio-group/vl-radio-group.component.ts"),f=l("./libs/form/src/next/datepicker/vl-datepicker.component.ts"),g=l("./libs/form/src/next/upload/vl-upload.component.ts"),x=l("./libs/form/src/utils/index.ts");class k extends n.oi{static{(0,s.YV)([i.i,c.z,m.X,u.n,f.Z1,v.k,b.X,p.P,g.F,h.E,a.m])}static get styles(){return[d.CX,(0,n.iv)`
                form {
                    margin-top: 1rem;
                    max-width: 800px;
                }
                ...
                <div class="vl-form-grid vl-form-grid--is-stacked">
                    ...
                    <div class="vl-form-col--8-12">
                        <vl-input-field-next
                            ...
                            max-length=${20}
                        ></vl-input-field-next>
                        <vl-error-message-next id="naam-valueMissing" for="naam" state="valueMissing"
                            >Gelieve een naam in te vullen.
                        </vl-error-message-next>
                        <vl-error-message-next id="naam-tooShort" for="naam" state="tooShort"
                            >Gelieve minimum 2 karakters te gebruiken.
                        </vl-error-message-next>
                        <vl-error-message-next id="naam-tooLong" for="naam" state="tooLong"
                            >Gelieve maximum 20 karakters te gebruiken.
                        </vl-error-message-next>
                        <vl-error-message-next id="naam-patternMismatch" for="naam" state="patternMismatch"
                    ...
                    <div class="vl-form-col--8-12">
                        <vl-input-field-masked-next
                            ...
                            mask="rrn"
                        ></vl-input-field-masked-next>
                        <vl-error-message-next id="rrn-valueMissing" for="rrn" state="valueMissing"
                            >Gelieve een rijksregisternummer in te vullen.</vl-error-message-next
                        >
                        <vl-error-message-next id="rrn-patternMismatch" for="rrn" state="patternMismatch"
                    ...
                    <div class="vl-form-col--8-12">
                        ...
                        <vl-error-message-next id="geboortedatum-valueMissing" for="geboortedatum" state="valueMissing">
                            Gelieve een geboortedatum in te vullen.
                        </vl-error-message-next>
                        <vl-error-message-next
                            id="geboortedatum-patternMismatch"
                            for="geboortedatum"
                    ...
                    <div class="vl-form-col--8-12">
                        ...
                        <vl-error-message-next
                            id="geboorteplaats-valueMissing"
                            for="geboorteplaats"
                            state="valueMissing"
                    ...
                    <div class="vl-form-col--8-12">
                        ...
                        <vl-error-message-next id="hobbies-valueMissing" for="hobbies" state="valueMissing"
                    ...
                    <div class="vl-form-col--8-12">
                        <vl-textarea-next
                            ...
                            rows=${10}
                        ></vl-textarea-next>
                        <vl-error-message-next id="interesses-valueMissing"" for="interesses" state="valueMissing"
                            >Gelieve je interesses in te vullen.
                        </vl-error-message-next>
                        <vl-error-message-next id="interesses-tooShort"" for="interesses" state="tooShort"
                            >Gelieve minimum 5 karakters te gebruiken.
                        </vl-error-message-next>
                        <vl-error-message-next id="interesses-tooLong"" for="interesses" state="tooLong"
                    ...
                    <div class="vl-form-col--8-12">
                        <vl-input-field-next
                            ...
                            max=${99}
                        ></vl-input-field-next>
                        <vl-error-message-next id="leeftijd-valueMissing" for="leeftijd" state="valueMissing"
                            >Gelieve een leeftijd in te vullen.
                        </vl-error-message-next>
                        <vl-error-message-next id="leeftijd-rangeUnderflow" for="leeftijd" state="rangeUnderflow"
                            >De minimum leeftijd is 0 jaar.
                        </vl-error-message-next>
                        <vl-error-message-next id="leeftijd-rangeOverflow" for="leeftijd" state="rangeOverflow"
                    ...
                    <div class="vl-form-col--8-12">
                        ...
                        <vl-error-message-next id="contactmethode-valueMissing" for="contactmethode" state="valueMissing">
                    ...
                    <div class="vl-form-col--8-12">
                        ...
                        ></vl-upload-next>
                        <vl-error-message-next id="foto-valueMissing" for="foto" state="valueMissing">
                    ...
                    <div class="vl-form-col--8-12">
                        ...
                        <vl-error-message-next id="waarheidsgetrouw-valueMissing" for="waarheidsgetrouw" state="valueMissing">
...
`;var d=l("./libs/form/src/next/form-control/form-control.ts"),c=l("./libs/common/utilities/src/index.ts");let m={...d.E,block:!1,value:"",checked:!1,isSwitch:!1};class u extends d.N{static get styles(){return[n.YN,n.Oh,i.CX,o.k3,a]}static get properties(){return{block:{type:Boolean},value:{type:String},checked:{type:Boolean,reflect:!0},isSwitch:{type:Boolean,attribute:"switch"}}}connectedCallback(){super.connectedCallback(),this.initialValue||(this.initialValue=this.value,this.initialCheckedValue=this.checked)}updated(e){if(super.updated(e),e.has("checked")||e.has("value")){let e=this.checked?this.value||"on":"",t={checked:this.checked};this.checked&&(t.value=e),this.setValue(e),this.dispatchEvent(new CustomEvent("vl-checked",{bubbles:!0,composed:!0,detail:t})),this.dispatchEventIfValid(t)}}render(){return(0,r.dy)` ${this.isSwitch?this.renderCheckboxSwitch():this.renderCheckboxDefault()} `}renderCheckboxDefault(){let e={"vl-checkbox":!0,"vl-checkbox--disabled":this.disabled,"vl-checkbox--error":this.isInvalid||this.error,"vl-checkbox--success":this.success,"vl-checkbox--block":this.block};return(0,r.dy)`
        ...
        `}get validationTarget(){return this.shadowRoot?.querySelector("input")}resetFormControl(){super.resetFormControl(),this.checked=this.initialCheckedValue,this.value=this.initialValue}toggle(){this.checked=!this.checked}constructor(...e){super(...e),this.block=m.block,this.value=m.value,this.checked=m.checked,this.isSwitch=m.isSwitch,this.initialValue="",this.initialCheckedValue=!1}}u=function(e,t,l,r){var s,o=arguments.length,n=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,l):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,l,r);else for(var i=e.length-1;i>=0;i--)(s=e[i])&&(n=(o<3?s(n):o>3?s(t,l,n):s(t,l))||n);return o>3&&n&&Object.defineProperty(t,l,n),n}([(0,c.a6)("vl-checkbox-next")],u)},"./libs/form/src/next/datepicker/vl-datepicker.component.ts":(e,t,l)=>{l.d(t,{yE:()=>b,Z1:()=>g,_R:()=>f});var r=l("./node_modules/@domg/govflanders-style/common/index.js"),s=l("./node_modules/@domg/govflanders-style/component/index.js"),o=l("./node_modules/@open-wc/form-control/src/validators.js"),n=l("./node_modules/lit/index.js");let i=(0,n.iv)`
    :host {
...
`},"./libs/form/src/next/select/index.ts":(e,t,l)=>{l.d(t,{k:()=>r.kI});var r=l("./libs/form/src/next/select/vl-select.component.ts")},"./libs/form/src/next/textarea/vl-textarea.component.ts":(e,t,l)=>{l.d(t,{n:()=>m,q:()=>c});var r=l("./node_modules/lit/index.js"),s=l("./node_modules/@domg/govflanders-style/component/index.js"),o=l("./node_modules/lit/directives/live.js"),n=l("./node_modules/lit/directives/class-map.js"),i=l("./node_modules/@domg/govflanders-style/common/index.js"),a=l("./libs/form/src/next/form-control/form-control.ts"),d=l("./libs/common/utilities/src/index.ts");let c={...a.E,block:!1,readonly:!1,value:"",placeholder:"",autocomplete:"",minLength:null,maxLength:null,rows:null,cols:null};class m extends a.N{static get styles(){return[i.YN,i.Oh,s.Qu]}static get properties(){return{block:{type:Boolean},readonly:{type:Boolean},value:{type:String,reflect:!0},placeholder:{type:String},autocomplete:{type:String},minLength:{type:Number,attribute:"min-length"},maxLength:{type:Number,attribute:"max-length"},rows:{type:Number},cols:{type:Number}}}connectedCallback(){super.connectedCallback(),this.initialValue||(this.initialValue=this.value)}updated(e){if(super.updated(e),e.has("value")){let e={value:this.value};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-input",{composed:!0,bubbles:!0,detail:e})),this.dispatchEventIfValid(e)}}render(){let e={"vl-textarea":!0,"vl-textarea--disabled":this.disabled,"vl-textarea--error":this.isInvalid||this.error,"vl-textarea--success":this.success,"vl-textarea--block":this.block};return(0,r.dy)`
            <textarea
                id=${this.id||r.Ld}
                name=${this.name||r.Ld}
                class=${(0,n.$)(e)}
                ...
                @input=${this.onInput}
            />
        `}get validationTarget(){return this.shadowRoot?.querySelector("textarea")}resetFormControl(){super.resetFormControl(),this.value=this.initialValue}onInput(e){this.value=e?.target?.value}constructor(...e){super(...e),this.block=c.block,this.readonly=c.readonly,this.value=c.value,this.placeholder=c.placeholder,this.autocomplete=c.autocomplete,this.minLength=c.minLength,this.maxLength=c.maxLength,this.rows=c.rows,this.cols=c.cols,this.initialValue=""}}m=function(e,t,l,r){var s,o=arguments.length,n=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,l):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,l,r);else for(var i=e.length-1;i>=0;i--)(s=e[i])&&(n=(o<3?s(n):o>3?s(t,l,n):s(t,l))||n);return o>3&&n&&Object.defineProperty(t,l,n),n}([(0,d.a6)("vl-textarea-next")],m)},"./libs/form/src/utils/index.ts":(e,t,l)=>{l.d(t,{u:()=>s});var r=l("./libs/form/src/next/form-control/form-control.ts");let s=(e,t)=>{if(!e)return;let l=new FormData(e),s=t||Array.from(e.querySelectorAll("*")).filter(e=>e instanceof r.N&&e.hasAttribute("multiple")).map(e=>e.getAttribute("name"));return Array.from(l.keys()).reduce((e,t)=>{if(!s.includes(t))return{...e,[t]:l.get(t)};{let r=l.getAll(t);return 1===r.length&&""===r[0]?{...e,[t]:[]}:{...e,[t]:r}}},{})}}}]);