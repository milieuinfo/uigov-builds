"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[7374],{"./apps/storybook/docs/d_applicatief/d_voorbeelden/form/form-demo/form-demo.stories.ts":(e,t,l)=>{l.r(t),l.d(t,{Demo:()=>w,__namedExportsOrder:()=>j,default:()=>y});var r=l("./node_modules/lit-html/lit-html.js"),o=l("./apps/storybook/docs/d_applicatief/d_voorbeelden/form/form-demo/form-demo.stories-doc.mdx"),s=l("./libs/common/utilities/src/index.ts"),n=l("./node_modules/lit/decorators.js"),i=l("./node_modules/lit/index.js"),a=l("./libs/form/src/next/form-label/vl-form-label.component.ts"),d=l("./libs/form/src/next/error-message/index.ts"),c=l("./libs/elements/src/index.ts"),m=l("./libs/form/src/next/input-field/index.ts"),u=l("./libs/form/src/next/input-field-masked/vl-input-field-masked.component.ts"),h=l("./libs/form/src/next/textarea/vl-textarea.component.ts"),v=l("./libs/form/src/next/select/vl-select.component.ts"),p=l("./libs/form/src/next/checkbox/vl-checkbox.component.ts"),b=l("./libs/form/src/next/radio-group/vl-radio.component.ts"),f=l("./libs/form/src/next/radio-group/vl-radio-group.component.ts"),x=l("./libs/form/src/next/datepicker/vl-datepicker.component.ts"),g=l("./libs/form/src/next/upload/vl-upload.component.ts");class k extends i.oi{static{(0,s.YV)([a.i,m.z,u.X,h.n,x.Z1,v.kI,f.X,b.P,g.F,p.E,d.m])}static get styles(){return[c.CX,(0,i.iv)`
                form {
                    margin-top: 1rem;
                    max-width: 800px;
                }
            ...
            <form id="form" class="vl-form" @submit=${this.onSubmit}>
                <div class="vl-form-grid vl-form-grid--is-stacked">
                    <div class="vl-form-col--4-12">
                        <vl-form-label-next id="naam-label" for="naam" block>Naam *</vl-form-label-next>
                    </div>
                    ...
                    <div class="vl-form-col--4-12">
                        <vl-form-label-next id="rrn-label" for="rrn" block>Rijksregisternummer *</vl-form-label-next>
                    </div>
                    <div class="vl-form-col--8-12">
                    ...
                    <div class="vl-form-col--4-12">
                        <vl-form-label-next id="geboortedatum-label" for="geboortedatum" block
                            >Geboortedatum *</vl-form-label-next
                        >
                    </div>
                    <div class="vl-form-col--8-12">
                        <vl-datepicker-next
                    ...
                    <div class="vl-form-col--4-12">
                        <vl-form-label-next id="geboorteplaats-label" for="geboorteplaats" block
                            >Geboorteplaats *</vl-form-label-next
                        >
                    </div>
                    <div class="vl-form-col--8-12">
                        <vl-select-next
                    ...
                    <div class="vl-form-col--4-12">
                        <vl-form-label-next id="hobbies-label" for="hobbies" block>Hobbies *</vl-form-label-next>
                    </div>
                    <div class="vl-form-col--8-12">
                        <vl-select-next
                            id="hobbies"
                    ...
                    <div class="vl-form-col--4-12">
                        <vl-form-label-next id="interesses-label" for="interesses" block
                            >Interesses *</vl-form-label-next
                        >
                    </div>
                    <div class="vl-form-col--8-12">
                        <vl-textarea-next
                    ...
                    <div class="vl-form-col--4-12">
                        <vl-form-label-next id="leeftijd-label" for="leeftijd" block>Leeftijd *</vl-form-label-next>
                    </div>
                    <div class="vl-form-col--8-12">
                        <vl-input-field-next
                            id="leeftijd"
                    ...
                    <div class="vl-form-col--4-12">
                        <vl-form-label-next id="contactmethode-label" for="contactmethode" block
                            >Contactmethode *</vl-form-label-next
                        >
                    </div>
                    <div class="vl-form-col--8-12">
                    ...
                    <div class="vl-form-col--4-12">
                        <vl-form-label-next id="foto-label" for="foto" block>Pasfoto *</vl-form-label-next>
                    </div>
                    <div class="vl-form-col--8-12">
                        <vl-upload-next
                            id="foto"
                    ...
                    <div class="vl-form-col--4-12">
                        <vl-form-label-next id="waarheidsgetrouw-label" for="waarheidsgetrouw" block
                            >Waarheidsgetrouw *</vl-form-label-next
                        >
                    </div>
                    <div class="vl-form-col--8-12">
...
`},"./libs/form/src/next/textarea/vl-textarea.component.ts":(e,t,l)=>{l.d(t,{n:()=>m,q:()=>c});var r=l("./node_modules/lit/index.js"),o=l("./node_modules/@domg/govflanders-style/component/index.js"),s=l("./node_modules/lit/directives/live.js"),n=l("./node_modules/lit/directives/class-map.js"),i=l("./node_modules/@domg/govflanders-style/common/index.js"),a=l("./libs/form/src/next/form-control/form-control.ts"),d=l("./libs/common/utilities/src/index.ts");let c={...a.E,block:!1,readonly:!1,value:"",placeholder:"",autocomplete:"",minLength:null,maxLength:null,rows:null,cols:null};class m extends a.N{static get styles(){return[i.YN,i.Oh,o.Qu]}static get properties(){return{block:{type:Boolean},readonly:{type:Boolean},value:{type:String,reflect:!0},placeholder:{type:String},autocomplete:{type:String},minLength:{type:Number,attribute:"min-length"},maxLength:{type:Number,attribute:"max-length"},rows:{type:Number},cols:{type:Number}}}connectedCallback(){super.connectedCallback(),this.initialValue||(this.initialValue=this.value)}updated(e){if(super.updated(e),e.has("value")){let e={value:this.value};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-input",{composed:!0,bubbles:!0,detail:e})),this.dispatchEventIfValid(e)}}render(){let e={"vl-textarea":!0,"vl-textarea--disabled":this.disabled,"vl-textarea--error":this.isInvalid||this.error,"vl-textarea--success":this.success,"vl-textarea--block":this.block};return(0,r.dy)`
            <textarea
                id=${this.id||r.Ld}
                name=${this.name||r.Ld}
                class=${(0,n.$)(e)}
