(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[4216],{"../../node_modules/memoizerific sync recursive":e=>{function o(e){var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}o.keys=()=>[],o.resolve=o,o.id="../../node_modules/memoizerific sync recursive",e.exports=o},"../../libs/common/utilities/src/css/global-styles-decorator.ts":(e,o,n)=>{"use strict";n.d(o,{n:()=>g});var t=n("../../node_modules/lit/index.js");let c=(0,t.AH)`
    :root {
        --vl-white: #ffffff;
...
`;var l="https://cdn.omgeving.vlaanderen.be/domg/govflanders-font/22.0.2",f="FlandersArtSans",v="FlandersArtSerif",b="vlaanderen-icon-classic",a="".concat(l,"/iconfont/").concat(b);let F=(0,t.AH)`
    :root {
        /* Flanders font */
        --vl-font: ${(0,t.iz)(f)}, sans-serif;
        --vl-accent-font: ${(0,t.iz)(v)}, serif;
        ...
        /* Icon font */
        --vl-icon-font: ${(0,t.iz)(b)};
    }
`,s=(e,o,n,c)=>(0,t.AH)`
    @font-face {
        font-family: ${(0,t.iz)(e)};
        src: url(${(0,t.iz)(`${o}.woff2`)}) format('woff2'),
            url(${(0,t.iz)(`${o}.woff`)}) format('woff');
        font-weight: ${(0,t.iz)(n)};
        font-style: ${(0,t.iz)(c)};
    }
`,d=(0,t.AH)`
    /* Flanders font */
    ${s(f,`${l}/flanders/sans/${f}-Light`,300,"normal")}
    ${s(f,`${l}/flanders/sans/${f}-Regular`,400,"normal")}
    ${s(f,`${l}/flanders/sans/${f}-Medium`,500,"normal")}
    ${s(f,`${l}/flanders/sans/${f}-Bold`,700,"normal")}

    ${s(f,`${l}/flanders/italic/${f}-Light`,300,"italic")}
    ${s(f,`${l}/flanders/italic/${f}-Regular`,400,"italic")}
    ${s(f,`${l}/flanders/italic/${f}-Medium`,500,"italic")}
    ${s(f,`${l}/flanders/italic/${f}-Bold`,700,"italic")}

    ${s(v,`${l}/flanders/serif/${v}-Light`,300,"normal")}
    ${s(v,`${l}/flanders/serif/${v}-Regular`,400,"normal")}
    ${s(v,`${l}/flanders/serif/${v}-Medium`,500,"normal")}
    ${s(v,`${l}/flanders/serif/${v}-Bold`,700,"normal")}

    /* Icon font */
    ${s(b,a,"normal","normal")}
`;var m=n("../../libs/common/utilities/src/css/mixin/media-queries.mixin.css.ts");let u=[c,r,i,F,d,(0,t.AH)`
    html {
...
`];class h{static{this.registered=!1}static register(){this.registered||(document.adoptedStyleSheets=[...document.adoptedStyleSheets,...u.map(e=>e.styleSheet)],this.registered=!0,console.log("RegisterGlobalStyles: global styling toegevoegd aan het document"))}}let g=()=>e=>{h.register()}},"../../libs/common/utilities/src/css/icon/icon.css.ts":(e,o,n)=>{"use strict";n.d(o,{A:()=>i});var t=n("../../node_modules/lit/index.js");let c=(0,t.AH)`
        ...
        `;var r=n("../../libs/common/utilities/src/css/mixin/outline.mixin.css.ts");let i=(0,t.AH)`
    ${(0,t.iz)(c)}
...
`},"../../libs/common/utilities/src/css/mixin/media-queries.mixin.css.ts":(e,o,n)=>{"use strict";n.d(o,{M:()=>r,i:()=>c});var t=n("../../node_modules/lit/index.js");let c=e=>(0,t.AH)`
...
`},"../../libs/common/utilities/src/css/mixin/outline.mixin.css.ts":(e,o,n)=>{"use strict";n.d(o,{H:()=>c});var t=n("../../node_modules/lit/index.js");let c=()=>(0,t.AH)`
    box-shadow: none;
