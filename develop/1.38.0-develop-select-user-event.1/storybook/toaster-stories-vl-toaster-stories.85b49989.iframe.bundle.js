 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let r={attribute:!0,type:String,converter:s.W3,reflect:!1,hasChanged:s.Ec},n=(t=r,e,o)=>{let{kind:a,metadata:s}=o,n=globalThis.litPropertyMetadata.get(s);if(void 0===n&&globalThis.litPropertyMetadata.set(s,n=new Map),n.set(o.name,t),"accessor"===a){let{name:a}=o;return{set(o){let s=e.get.call(this);e.set.call(this,o),this.requestUpdate(a,s,t)},init(e){return void 0!==e&&this.C(a,void 0,t),e}}}if("setter"===a){let{name:a}=o;return function(o){let s=this[a];e.call(this,o),this.requestUpdate(a,s,t)}}throw Error("Unsupported decorator location: "+a)};function l(t){return(e,o)=>"object"==typeof o?n(t,e,o):((t,e,o)=>{let a=e.hasOwnProperty(o);return e.constructor.createProperty(o,a?{...t,wrapped:!0}:t),a?Object.getOwnPropertyDescriptor(e,o):void 0})(t,e,o)}},"../../node_modules/lit/directives/class-map.js":(t,e,o)=>{"use strict";o.d(e,{H:()=>r});var a=o("../../node_modules/lit-html/lit-html.js"),s=o("../../node_modules/lit-html/directive.js"),r=(0,s.u$)(class extends s.WL{constructor(t){var e;if(super(t),t.type!==s.OA.ATTRIBUTE||"class"!==t.name||(null===(e=t.strings)||void 0===e?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,e){var[o]=e;if(void 0===this.it){for(var s in this.it=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t))),o)o[s]&&!(null!==(i=this.st)&&void 0!==i&&i.has(s))&&this.it.add(s);return this.render(o)}var r=t.element.classList;for(var n of this.it)n in o||(r.remove(n),this.it.delete(n));for(var l in o){var i,c,d=!!o[l];d===this.it.has(l)||(null===(c=this.st)||void 0===c?void 0:c.has(l))||(d?(r.add(l),this.it.add(l)):(r.remove(l),this.it.delete(l)))}return a.c0}})},"../../libs/components/src/alert/vl-alert.component.ts":(t,e,o)=>{"use strict";o.d(e,{r:()=>u});var a=o("../../node_modules/lit/index.js"),s=o("../../node_modules/lit/decorators.js"),r=o("../../libs/common/utilities/src/index.ts"),n=o("../../node_modules/@domg/govflanders-style/component/index.js"),l=o("../../node_modules/@domg/govflanders-style/common/index.js"),i=o("../../libs/components/src/alert/vl-alert.model.ts"),c=o("../../node_modules/lit/directives/class-map.js");let d=(0,a.AH)`
    :host {
...
`;class u extends r.jW{static get styles(){return[l.h8,n.cY,n.py,l.Wq,l.rn,d]}static get properties(){return{icon:{type:String,attribute:"data-vl-icon"},title:{type:String,attribute:"data-vl-title"},closable:{type:Boolean,attribute:"data-vl-closable"},type:{type:String,attribute:"data-vl-type"},size:{type:String,attribute:"data-vl-size"},naked:{type:Boolean,attribute:"data-vl-naked"},message:{type:String,attribute:"data-vl-message"}}}updated(t){super.updated(t),this.processButtons()}render(){let t={"vl-alert":!0,[`vl-alert--${this.type}`]:!!this.type,"vl-alert--small":"small"===this.size,"vl-alert--naked":this.naked},e=this.naked?`vl-u-mark--${this.type}`:"",o=r.ax(this,"actions")?.length?"":"vl-u-visually-hidden";return(0,a.qy)`
            <div id="alert" class=${(0,c.H)(t)} role="alert">
                ${this.icon&&(0,a.qy)` <div class="vl-alert__icon">
        ...
        `}removeAlert(){this.parentElement?.removeChild(this),this.dispatchEvent(new i.Xf)}processButtons(){let t=this.renderRoot.querySelector('slot[name="actions"]');(t?.assignedNodes().filter(t=>t instanceof HTMLButtonElement)).forEach(t=>t.setAttribute("data-vl-narrow",""))}constructor(...t){super(...t),this.icon="",this.title="",this.type="",this.size="",this.message="",this.naked=!1,this.closable=!1}}u=function(t,e,o,a){var s,r=arguments.length,n=r<3?e:null===a?a=Object.getOwnPropertyDescriptor(e,o):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,o,a);else for(var l=t.length-1;l>=0;l--)(s=t[l])&&(n=(r<3?s(n):r>3?s(e,o,n):s(e,o))||n);return r>3&&n&&Object.defineProperty(e,o,n),n}([(0,s.EM)("vl-alert")],u)},"../../libs/components/src/alert/vl-alert.model.ts":(t,e,o)=>{"use strict";o.d(e,{Xf:()=>n,if:()=>a,ng:()=>r,tF:()=>s});let a={INFO:"info",SUCCESS:"success",WARNING:"warning",ERROR:"error"},s={WARNING:"warning",CHECK:"check",INFO_CIRCLE:"info-circle"},r={SMALL:"small"};class n extends Event{static{this.eventType="vl-alert-closed"}constructor(){super(n.eventType,{bubbles:!0})}}},"../../libs/components/src/toaster/vl-toaster.element.ts":(t,e,o)=>{"use strict";o.d(e,{L:()=>s});var a=o("../../libs/common/utilities/src/index.ts");o("../../node_modules/@govflanders/vl-ui-core/dist/js/core.js"),o("../../node_modules/@govflanders/vl-ui-util/dist/js/util.js"),o("../../libs/components/src/toaster/vl-toaster.lib.js");class s extends(0,a.H3)(HTMLDivElement){static get _observedAttributes(){return["fadeout"]}static get _observedClassAttributes(){return["top-left","top-right","bottom-left","bottom-right"]}static get _dressedAttributeName(){return"data-vl-toaster-dressed"}connectedCallback(){this.classList.add("vl-toaster"),this._dress()}get _classPrefix(){return"vl-toaster--"}get toasterFadeClass(){return"vl-alert--fade-out"}get _dressed(){return!!this.getAttribute(s._dressedAttributeName)}push(t){setTimeout(()=>{this._element.appendChild(t)})}closeAlert(t){vl.util.addClass(t,this.toasterFadeClass),window.setTimeout(()=>{t.remove()},300)}_fadeoutChangedCallback(t,e){void 0!=e?this._element.setAttribute("data-vl-toaster-fadeout",!0):this._element.removeAttribute("data-vl-toaster-fadeout")}_dress(){this._dressed||vl.toaster.dress(this)}}s=function(t,e,o,a){var s,r=arguments.length,n=r<3?e:null===a?a=Object.getOwnPropertyDescriptor(e,o):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,o,a);else for(var l=t.length-1;l>=0;l--)(s=t[l])&&(n=(r<3?s(n):r>3?s(e,o,n):s(e,o))||n);return r>3&&n&&Object.defineProperty(e,o,n),n}([(0,a.M1)("vl-toaster",{extends:"div"})],s)},"../../libs/components/src/toaster/vl-toaster.lib.js":function(t){var e;this||window,e=()=>{var t="".concat(vl.ns,"toaster"),e="".concat(vl.ns,"alert"),o="".concat(e,"--fade-out"),a="".concat(e,"__close"),s="data-".concat(vl.ns),r="".concat(s,"toaster"),n="".concat(r,"-dressed"),l="".concat(r,"-fadeout"),i=function(t){vl.util.addClass(t,o),window.setTimeout(()=>{vl.util.removeClass(t,o)},300)},c=function(t){vl.util.addClass(t,o),window.setTimeout(()=>{t.remove()},300)},d=function(t){vl.util.each(t,t=>{t.addEventListener("click",t=>{c(t.currentTarget.parentElement)})})},u=function(t){var e=t[0].target,o=e.firstElementChild,s=e.lastElementChild;t[0].addedNodes.length>0&&(i(s),d(s.shadowRoot?s.shadowRoot.querySelectorAll(".".concat(a)):s.querySelectorAll(".".concat(a))),"true"===e.getAttribute(l)&&window.setTimeout(()=>{c(s)},5e3)),e.childElementCount>5&&c(o)},v=function(){var e;function o(){!function(t,e){if(!(t instanceof e))throw TypeError("Cannot call a class as a function")}(this,o)}return e=[{key:"dress",value:function(t){t.setAttribute(n,!0);var e=new window.MutationObserver(u),o=t.shadowRoot?t.shadowRoot.querySelectorAll(".".concat(a)):t.querySelectorAll(".".concat(a));e.observe(t,{attributes:!0,childList:!0}),d(o)}},{key:"dressAll",value:function(){var e=this,o=document.querySelectorAll(".".concat(t,":not([").concat(n,"]):not([data-").concat(vl.ns,'js-dress="false"]),\n      [').concat(r,"]:not([").concat(n,"]):not([data-").concat(vl.ns,'js-dress="false"])'));vl.util.each(o,t=>{e.dress(t)})}}],function(t,e){for(var o=0;o<e.length;o++){var a=e[o];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(t,a.key,a)}}(o.prototype,e),o}();return"toaster"in vl||(vl.toaster=new v,vl.toaster.dressAll()),v},t.exports=e()}}]);