...
`;class a extends r.fS{static get styles(){return[s.Z,n]}static get properties(){return{layer:{type:String,attribute:"data-vl-layer"},iconText:{type:String,attribute:"data-vl-icon-text"},iconTextColor:{type:String,attribute:"data-vl-icon-text-color",reflect:!0}}}render(){return(0,i.dy)`
        ...
        ${this.hideTitle?"":(0,i.dy)`<div>
            ...
            ${this.items.map(t=>{if(!t)return"";switch(t.type){case"custom":return(0,i.dy)` ${t.styleElement} `;case"styled":return(0,i.dy)` <div class="uig-map-legend-item">
                        ...
                        </div>`;case"url":return(0,i.dy)`<div class="uig-map-legend-item uig-map-legend-image">
                            <img alt="map legend image" class="uig-map-legend-icon" src="${t.url}" />
                        </div>`;default:return""}})}
        </div>`:null}generateItemStyle(){let e=this.getPosition();return(e.left?`;left:${e.left}`:"")+(e.top?`;top:${e.top}`:"")+(e.right?`;right:${e.right}`:"")+(e.bottom?`;bottom:${e.bottom}`:"")}generateIconStyle(e){let t="";return e instanceof s.e&&(t="border-radius: 50%;"),`border: ${e.borderSize}px solid ${e.borderColor}; color:${e.textColor}; background-color:${e.color}; ${t}`}}m=function(e,t,o,i){var l,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(l=e[n])&&(s=(r<3?l(s):r>3?l(t,o,s):l(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s}([(0,l.Mo)("vl-map-legend")],m)},"./libs/map/src/components/legend/vl-map-legend.uig-css.ts":(e,t,o)=>{o.d(t,{Z:()=>n});var i=o("./node_modules/lit/index.js"),l=o("./libs/map/src/actions/map-actions.uig-css.ts"),r=o("./libs/elements/src/index.ts");let s=(0,i.iv)`
    .ol-box {
