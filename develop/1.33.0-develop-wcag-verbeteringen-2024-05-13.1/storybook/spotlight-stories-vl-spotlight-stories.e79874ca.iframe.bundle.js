"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[1998],{"./libs/components/src/spotlight/stories/vl-spotlight.stories.ts":(t,e,s)=>{s.r(e),s.d(e,{__namedExportsOrder:()=>m,default:()=>n,spotLightDefault:()=>o,spotlightNoLink:()=>p,spotlightWithContent:()=>c,spotlightWithImage:()=>d,spotlightWithLink:()=>r,spotlightWithSubtitle:()=>u,spotlightWithText:()=>g});var l=s("./node_modules/lit-html/lit-html.js");s("./libs/components/src/spotlight/vl-spotlight.component.ts");var a=s("./libs/components/src/spotlight/vl-spotlight.model.ts"),i=s("./libs/common/storybook/src/index.ts");let n={title:"components/spotlight",tags:["autodocs"],args:{...i._O,link:"",alt:!1,size:a.N.S,imgSrc:"",imgAlt:"",title:"Premies voor renovatie",subtitle:"",text:"",content:""},argTypes:{...(0,i.Wp)(),link:{name:"data-vl-link",description:"De component wordt een link. Door te klikken op de component wordt de gebruiker doorgestuurd naar de link die gezet is in dit attribuut.",table:{type:{summary:i.vK.STRING,required:!1},defaultValue:{summary:""},category:i.aA.ATTRIBUTES}},alt:{name:"data-vl-alt",description:"Geeft de component een alternatieve stijl. De achtergrond wordt grijs.",table:{type:{summary:i.vK.BOOLEAN,required:!1},defaultValue:{summary:!1},category:i.aA.ATTRIBUTES}},size:{name:"data-vl-size",description:"Dit attribuut bepaalt de grootte van de component.",table:{type:{summary:(0,i.G_)(Object.values(a.N)),required:!1},category:i.aA.ATTRIBUTES,defaultValue:{summary:`${a.N.S}`}},control:{type:i.Hy.SELECT},options:Object.values(a.N)},imgSrc:{name:"data-vl-img-src",description:"Het path van de image dat getoond moet worden in de spotlight.",table:{type:{summary:i.vK.STRING,required:!1},defaultValue:{summary:""},category:i.aA.ATTRIBUTES}},imgAlt:{name:"data-vl-img-alt",description:"De alternatieve tekst van de image dat getoond moet worden in de spotlight.",table:{type:{summary:i.vK.STRING,required:!1},defaultValue:{summary:""},category:i.aA.ATTRIBUTES}},title:{name:"title",description:"Titel van de spotlight.",table:{type:{summary:i.vK.STRING,required:!1},defaultValue:{summary:""},category:i.aA.SLOTS}},subtitle:{name:"subtitle",description:"Subtitle van de spotlight.",table:{type:{summary:i.vK.STRING,required:!1},defaultValue:{summary:""},category:i.aA.SLOTS}},text:{name:"text",description:"Text van de spotlight.",table:{type:{summary:i.vK.STRING,required:!1},defaultValue:{summary:""},category:i.aA.SLOTS}},content:{name:"content",description:"Content van de spotlight.",table:{type:{summary:i.vK.STRING,required:!1},defaultValue:{summary:""},category:i.aA.SLOTS}}},parameters:{controls:{hideNoControlsWarning:!0}}},o=(({link:t,alt:e,size:s,imgSrc:a,imgAlt:i,title:n,subtitle:o,text:r,content:p})=>(0,l.dy)`
    <vl-spotlight
        data-vl-link=${t}
        ?data-vl-alt=${e}
        data-vl-size=${s}
