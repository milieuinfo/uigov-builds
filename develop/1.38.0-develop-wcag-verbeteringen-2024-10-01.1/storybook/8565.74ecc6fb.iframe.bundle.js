"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[8565],{"../../libs/form/src/next/error-message/vl-error-message.component.ts":(e,t,l)=>{l.d(t,{O:()=>a,X:()=>d});var i=l("../../libs/common/utilities/src/index.ts"),s=l("../../node_modules/@domg/govflanders-style/common/index.js"),o=l("../../node_modules/@domg/govflanders-style/component/index.js"),r=l("../../node_modules/lit/index.js"),c=l("../../libs/form/src/next/error-message/vl-error-message.defaults.ts");let n=(0,r.AH)`
    .vl-form__error {
        margin-top: 0.2rem;
    }
`,a="vl-error-message-next";class d extends i.jW{static get styles(){return[s.h8,o.xV,n]}static get properties(){return{show:{type:Boolean,reflect:!0},for:{type:String},state:{type:String}}}render(){return(0,r.qy)`
            <p class="vl-form__error" ?hidden=${!this.show}>
                <slot></slot>
            </p>
        `}constructor(...e){super(...e),this.show=c.M.show,this.for=c.M.for,this.state=c.M.state}}d=function(e,t,l,i){var s,o=arguments.length,r=o<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,l):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,l,i);else for(var c=e.length-1;c>=0;c--)(s=e[c])&&(r=(o<3?s(r):o>3?s(t,l,r):s(t,l))||r);return o>3&&r&&Object.defineProperty(t,l,r),r}([(0,i.M1)(a)],d)},"../../libs/form/src/next/error-message/vl-error-message.defaults.ts":(e,t,l)=>{l.d(t,{M:()=>i});let i={show:!1,for:null,state:null}},"../../libs/form/src/next/form-control/form-control.defaults.ts":(e,t,l)=>{l.d(t,{i:()=>i});let i={id:"",name:"",label:"",required:!1,disabled:!1,error:!1,success:!1}},"../../libs/form/src/next/form-control/form-control.ts":(e,t,l)=>{l.d(t,{M:()=>d});var i=l("../../libs/form/src/next/form-control/form-control.defaults.ts"),s=l("../../node_modules/@open-wc/form-control/src/FormControlMixin.js"),o=l("../../node_modules/@open-wc/form-control/src/validators.js"),r=l("../../node_modules/lit/index.js"),c=l("../../node_modules/@open-wc/form-helpers/src/index.js"),n=l("../../libs/form/src/next/error-message/vl-error-message.component.ts"),a=l("../../libs/common/utilities/src/index.ts");l("../../node_modules/reflect-metadata/Reflect.js");class d extends(0,s.F)(a.jW){static{this.formControlValidators=[o.yt,o.Bt]}static{this.shadowRootOptions={...r.WF.shadowRootOptions,delegatesFocus:!0}}static get properties(){return{id:{type:String},name:{type:String},label:{type:String},required:{type:Boolean},disabled:{type:Boolean},error:{type:Boolean},success:{type:Boolean},isInvalid:{type:Boolean,state:!0}}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeydown),this.addEventListener("invalid",this.onInvalid)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeydown),this.removeEventListener("invalid",this.onInvalid)}updated(e){super.updated(e),e.has("isInvalid")||(this.isInvalid=!1,this.hideErrorMessages())}resetFormControl(){this.isInvalid=!1,this.hideErrorMessages(),this.dispatchEvent(new Event("vl-reset",{bubbles:!0,composed:!0}))}dispatchEventIfValid(e){this.validity.valid&&this.dispatchEvent(new CustomEvent("vl-valid",{composed:!0,bubbles:!0,detail:e}))}onKeydown(e){"Enter"===e.code&&this.form&&this.submitFormOnEnter&&(0,c.tA)(this.form)}onInvalid(e){e.preventDefault(),this.isInvalid=!0,this.focusFirstInvalidInput(),this.showErrorMessage()}focusFirstInvalidInput(){let e=this.form?.querySelector(":invalid");this===e&&(e?.focus(),e?.scrollIntoView({behavior:"smooth",block:"center"}))}showErrorMessage(){let e="";for(let t in this.validity)if(this.validity[t]){e=t;break}let t=this.form?.querySelector(`${n.O}[for="${this.id}"][state="${e}"]`);t?t?.textContent?this.validationTarget?.setAttribute("aria-description",t?.textContent||""):this.validationTarget?.removeAttribute("aria-description"):t=this.form?.querySelector(`${n.O}[for="${this.id}"]:not([state])`),t?.setAttribute("show","")}hideErrorMessages(){let e=this.form?.querySelectorAll(`${n.O}[for="${this.id}"]`);e?.forEach(e=>{e.removeAttribute("show")})}constructor(...e){super(...e),this.id=i.i.id,this.name=i.i.name,this.label=i.i.label,this.required=i.i.required,this.disabled=i.i.disabled,this.error=i.i.error,this.success=i.i.success,this.isInvalid=!1,this.submitFormOnEnter=!0}}},"../../libs/form/src/next/select-rich/vl-select-rich.component.ts":(e,t,l)=>{l.d(t,{Al:()=>b});var i=l("../../libs/common/utilities/src/index.ts"),s=l("../../node_modules/@domg/govflanders-style/common/index.js"),o=l("../../node_modules/@domg/govflanders-style/component/index.js"),r=l("../../node_modules/lit/index.js"),c=l("../../node_modules/lit/directives/class-map.js"),n=l("../../libs/form/src/next/form-control/form-control.ts");let a=(0,r.AH)`
    .vl-pill {
        display: inline-flex;
        max-width: 100%;
        align-items: center;
