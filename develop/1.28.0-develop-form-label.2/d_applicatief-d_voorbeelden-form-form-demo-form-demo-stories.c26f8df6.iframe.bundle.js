"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[7374],{"./apps/storybook/docs/d_applicatief/d_voorbeelden/form/form-demo/form-demo.stories.ts":(e,t,l)=>{l.r(t),l.d(t,{Demo:()=>O,__namedExportsOrder:()=>S,default:()=>R});var r=l("./node_modules/lit-html/lit-html.js"),o=l("./apps/storybook/docs/d_applicatief/d_voorbeelden/form/form-demo/form-demo.stories-doc.mdx"),s=l("./libs/common/utilities/src/index.ts"),n=l("./node_modules/lit/decorators.js"),i=l("./node_modules/lit/index.js"),a=l("./libs/form/src/next/form-label/vl-form-label.component.ts"),c=l("./node_modules/@domg/govflanders-style/common/index.js"),d=l("./node_modules/@domg/govflanders-style/component/index.js"),m=l("./node_modules/lit/directives/class-map.js");let u={id:"",for:"",block:!1,light:!1,label:""};class h extends s.fS{static get styles(){return[c.YN,d.J8]}static get properties(){return{id:{type:String},for:{type:String},block:{type:Boolean},light:{type:Boolean},label:{type:String}}}render(){let e={"vl-form__label":!0,"vl-form__label--block":this.block,"vl-form__label--light":this.light};return(0,i.dy)`<label for=${this.for} class=${(0,m.$)(e)}>${this.label}</label>`}createRenderRoot(){return this}constructor(...e){super(...e),this.id=u.id,this.for=u.for,this.block=u.block,this.light=u.light,this.label=u.label}}h=function(e,t,l,r){var o,s=arguments.length,n=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,l):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,l,r);else for(var i=e.length-1;i>=0;i--)(o=e[i])&&(n=(s<3?o(n):s>3?o(t,l,n):o(t,l))||n);return s>3&&n&&Object.defineProperty(t,l,n),n}([(0,s.a6)("vl-form-label-2-next")],h);let v={id:"",for:"",block:!1,light:!1,label:""};class p extends s.fS{static get styles(){return[c.YN,d.J8]}static get properties(){return{id:{type:String},for:{type:String},block:{type:Boolean},light:{type:Boolean},label:{type:String}}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.focusFormControl)}updated(e){super.updated(e);let t=this.getFormControl();t?.setAttribute("label",this.id)}disconnectedCallback(){super.disconnectedCallback();let e=this.getFormControl();e?.setAttribute("label",this.id),this.removeEventListener("click",this.focusFormControl)}render(){let e={"vl-form__label":!0,"vl-form__label--block":this.block,"vl-form__label--light":this.light};return(0,i.dy)`<label class=${(0,m.$)(e)}>${this.label}</label>`}getFormControl(){let e=this.closest("form");return e?.querySelector(`[id="${this.for}"]`)}focusFormControl(){let e=this.getFormControl();e?.focus()}constructor(...e){super(...e),this.id=v.id,this.for=v.for,this.block=v.block,this.light=v.light,this.label=v.label}}p=function(e,t,l,r){var o,s=arguments.length,n=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,l):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,l,r);else for(var i=e.length-1;i>=0;i--)(o=e[i])&&(n=(s<3?o(n):s>3?o(t,l,n):o(t,l))||n);return s>3&&n&&Object.defineProperty(t,l,n),n}([(0,s.a6)("vl-form-label-3-next")],p);var b=l("./libs/form/src/next/error-message/index.ts"),f=l("./libs/elements/src/index.ts"),g=l("./libs/form/src/next/input-field/index.ts"),x=l("./libs/form/src/next/input-field-masked/vl-input-field-masked.component.ts"),k=l("./libs/form/src/next/textarea/vl-textarea.component.ts"),y=l("./libs/form/src/next/select/vl-select.component.ts"),w=l("./libs/form/src/next/checkbox/vl-checkbox.component.ts"),j=l("./libs/form/src/next/radio-group/vl-radio.component.ts"),_=l("./libs/form/src/next/radio-group/vl-radio-group.component.ts"),C=l("./libs/form/src/next/datepicker/vl-datepicker.component.ts"),$=l("./libs/form/src/next/upload/vl-upload.component.ts");class V extends i.oi{static{(0,s.YV)([a.i,h,p,g.z,x.X,k.n,C.Z1,y.kI,_.X,j.P,$.F,w.E,b.m])}static get styles(){return[f.CX,(0,i.iv)`
                form {
                    margin-top: 1rem;
                    max-width: 800px;
                }
            ...
            <form id="form" class="vl-form" @submit=${this.onSubmit}>
                <div class="vl-form-grid vl-form-grid--is-stacked">
                    ...
                    <div class="vl-form-col--8-12">
                        <vl-input-field-next id="naam" name="naam" block required></vl-input-field-next>
                    ...
                    <div class="vl-form-col--8-12">
                        <vl-input-field-next id="rrn" name="rrn" block required></vl-input-field-next>
                    ...
                    <div class="vl-form-col--4-12">
                        <vl-form-label-2-next for="geboortedatum" block label="Geboortedatum *"></vl-form-label-2-next>
                    </div>
                    <div class="vl-form-col--8-12">
                        <vl-input-field-next
                            id="geboortedatum"
