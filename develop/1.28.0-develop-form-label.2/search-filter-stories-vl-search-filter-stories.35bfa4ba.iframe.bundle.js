"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[9826],{"./libs/elements/src/search-filter/stories/vl-search-filter.stories.ts":(e,l,t)=>{t.r(l),t.d(l,{__namedExportsOrder:()=>m,default:()=>i,searchFilterDefault:()=>o,searchFilterMobile:()=>r});var a=t("./node_modules/lit-html/lit-html.js");t("./libs/elements/src/form/vl-form.element.ts"),t("./libs/elements/src/button/vl-button.element.ts"),t("./libs/elements/src/select/vl-select.element.ts"),t("./libs/elements/src/input-field/vl-input-field.element.ts"),t("./libs/elements/src/search-filter/vl-search-filter.element.ts"),t("./libs/elements/src/link/vl-link.element.ts");let i={title:"Elements/search-filter",tags:["autodocs"],args:{title:"Lorem ipsum",alt:!1,mobileModal:!1,mobileModalTitle:"Lorem ipsum dolor set",maxWidth:"800px"},argTypes:{title:{name:"data-vl-title",description:"The title of this search filter.",table:{type:{summary:"string"},category:"Attributes",defaultValue:{summary:""}}},alt:{name:"data-vl-alt",description:"Alternative (transparent) background.",table:{type:{summary:"boolean"},category:"Attributes",defaultValue:{summary:"false"}}},mobileModal:{name:"data-vl-mobile-modal",description:"Activates optimized display for mobile devices.",table:{type:{summary:"boolean"},category:"Attributes",defaultValue:{summary:"false"}}},mobileModalTitle:{name:"data-vl-mobile-modal-title",description:"The title of this search filter on mobile devices. If not declared, the value of data-vl-title will be used.",table:{type:{summary:"string"},category:"Attributes",defaultValue:{summary:""}}},maxWidth:{table:{disable:!0}}}},s=({title:e,alt:l,mobileModal:t,mobileModalTitle:i,maxWidth:s})=>(0,a.dy)`
