...
`,u={key:"customError",message:"Something went wrong when adding a file",isValid(e){let t=!1;return e.getFiles().forEach(e=>{"error"===e.status&&(t=!0)}),!t}},h={...d.E,readonly:!1,acceptedFiles:"",autoProcess:!1,disallowDuplicates:!1,errorMessageAcceptedFiles:"Dit bestandstype is niet toegestaan.",errorMessageFilesize:"Het bestand mag maximaal {{maxFilesize}} MB zijn.",errorMessageMaxFiles:"Je kan maximaal {{maxFiles}} bestand(en) uploaden.",maxFiles:1,maxSize:2,subTitle:"Sleep de bijlage naar hier om toe te voegen",mainTitle:"Bijlage toevoegen",url:""};class c extends d.N{static{this.formControlValidators=[...d.N.formControlValidators,u]}static get styles(){return[n.YN,n.Oh,a.RP,a.zm,p,a.oQ,n.PC]}static get properties(){return{type:{type:String},acceptedFiles:{type:String,attribute:"accepted-files"},autoProcess:{type:Boolean,attribute:"auto-process"},disallowDuplicates:{type:Boolean,attribute:"disallow-duplicates"},errorMessageAcceptedFiles:{type:String,attribute:"error-message-accepted-files"},errorMessageFilesize:{type:String,attribute:"error-message-filesize"},errorMessageMaxFiles:{type:String,attribute:"error-message-max-files"},maxFiles:{type:Number,attribute:"max-files"},maxSize:{type:Number,attribute:"max-size"},subTitle:{type:String,attribute:"sub-title"},mainTitle:{type:String,attribute:"main-title"},url:{type:String},readonly:{type:Boolean},value:{type:Object,state:!0}}}firstUpdated(e){super.firstUpdated(e),this.initializeComponent()}updated(e){if(super.updated(e),e.has("value")&&this.setValue(this.value??""),e.has("disabled")){let e=this.getInput();this.disabled?(this.dropzoneInstance?.hiddenFileInput?.setAttribute("disabled","disabled"),this.getUploadButton()?.setAttribute("disabled","disabled"),this.dropzoneInstance?.disable()):(this.dropzoneInstance?.hiddenFileInput?.removeAttribute("disabled"),this.getUploadButton()?.removeAttribute("disabled"),this.dropzoneInstance?.enable()),e&&(e.disabled=this.disabled)}if(e.has("required")&&this.updateInputForAttribute("required"),e.has("readonly")){let e=this.getInput();if(this.updateInputForAttribute("readonly"),this.disabled||(this.readonly?e?.setAttribute("disabled",""):e?.removeAttribute("disabled")),this.dropzoneInstance){let e=this.dropzoneInstance;this.readonly?e.removeEventListeners():e.setupEventListeners()}}if(e.has("name")&&this.updateInputForAttribute("name"),e.has("id")&&(this.updateInputForAttribute("id"),this.name||this.getInput()?.setAttribute("name",this.id)),e.has("error")&&this.updateInputForAttribute("error"),e.has("isInvalid")&&this.updateInputForAttribute("isInvalid"),e.has("success")&&this.updateInputForAttribute("success"),e.has("label")){let e=this.getInput();this.label?e?.setAttribute("aria-label",this.label):e?.removeAttribute("aria-label")}e.has("autoProcess")&&this.dropzoneInstance&&(this.dropzoneInstance.options.autoProcessQueue=this.autoProcess),e.has("url")&&this.dropzoneInstance&&(this.dropzoneInstance.options.url=this.url),e.has("maxSize")&&this.dropzoneInstance&&(this.dropzoneInstance.options.maxFilesize=this.maxSize),e.has("maxFiles")&&this.dropzoneInstance&&(this.dropzoneInstance.options.maxFiles=this.maxFiles)}disconnectedCallback(){super.disconnectedCallback(),this.removeDropzoneEvents(),this.dropzoneInstance&&(this.updateFileList(this.dropzoneInstance),this.dropzoneInstance.destroy())}render(){let e={"vl-upload":!0,"vl-upload--disabled":this.disabled,"vl-upload--error":this.isInvalid||this.error,"vl-upload--success":this.success},t={"dz-clickable":this.readonly,dropzone:!0,"vl-upload__element__label":!0};return(0,i.dy)`
        ...
        `}updateInputForAttribute(e){this[e]?this.getInput()?.setAttribute(e,"boolean"==typeof this[e]?"":this[e]):this.getInput()?.removeAttribute(e)}async updateFileList(e,t){let s=this.shadowRoot?.querySelector(".vl-upload__files");e.files.length?(s?.classList.add("vl-upload__files--has-files"),this.disallowDuplicates&&t&&this.dropzoneInstance&&await this.detectDuplicate(this.dropzoneInstance.files,t)&&(this.dropzoneInstance.removeFile(t),this.dispatchEvent(new CustomEvent("vl-input",{composed:!0,bubbles:!0,detail:{type:"removedduplicatefile",file:t,value:this.value}})))):s?.classList.remove("vl-upload__files--has-files")}initializeComponent(){this.setupDropzone(),this.setupTitles(),this.setupEventListeners(),this.dropzoneInstance?.hiddenFileInput?.classList.add("vl-upload__element__input")}setupDropzone(){let e=this.shadowRoot?.querySelector("div#dropzone-container"),t=this.shadowRoot?.querySelector("#uploadTemplate"),s=this.shadowRoot?.querySelector("#previewTemplate"),i={autoProcessQueue:this.autoProcess,maxFiles:this.maxFiles,maxFilesize:this.maxSize,acceptedFiles:this.acceptedFiles,createImageThumbnails:!1,previewsContainer:this.shadowRoot?.querySelector(".vl-upload__files__container")||void 0,hiddenInputContainer:this.shadowRoot?.querySelector(".vl-upload__files__input__container")||void 0,dictDefaultMessage:t?.innerHTML,previewTemplate:s?.innerHTML,url:this.url,dictFileTooBig:this.errorMessageFilesize,dictInvalidFileType:this.errorMessageAcceptedFiles,dictMaxFilesExceeded:this.errorMessageMaxFiles,dictResponseError:"Er liep iets fout bij het uploaden.",dictRemoveFile:"Verwijder bestand",dictCancelUpload:"Annuleer upload",dictCancelUploadConfirmation:"Ben je zeker dat je de upload wil annuleren?"};e&&(this.dropzoneInstance=new o.Dropzone(e,i))}setupTitles(){if(!(0,r.F1)(this,"sub-title").length){let e=document.createElement("span");e.textContent=this.subTitle,e.slot="sub-title",this.appendChild(e)}if(!(0,r.F1)(this,"main-title").length){let e=document.createElement("span");e.textContent=this.mainTitle,e.slot="title",this.appendChild(e)}}setupEventListeners(){this.getFilesCloseButton()?.addEventListener("click",this.handleFilesCloseButtonClick),[...(0,r.F1)(this,"sub-title"),...(0,r.F1)(this,"title")].forEach(e=>{e.addEventListener("click",this.handleTitleClick)}),this.dropzoneInstance&&(this.dropzoneInstance.on("addedfile",this.handleAddedFile),this.dropzoneInstance.on("removedfile",this.handleRemovedFile),this.dropzoneInstance.on("error",this.handleError),this.dropzoneInstance.on("dragover",this.handleDragOver),this.dropzoneInstance.on("dragleave",this.handleDragLeave),this.dropzoneInstance.on("drop",this.handleDragLeave))}removeDropzoneEvents(){this.getFilesCloseButton()?.removeEventListener("click",this.handleFilesCloseButtonClick),[...(0,r.F1)(this,"sub-title"),...(0,r.F1)(this,"title")].forEach(e=>{e.removeEventListener("click",this.handleTitleClick)}),this.dropzoneInstance&&(this.dropzoneInstance.off("addedfile",this.handleAddedFile),this.dropzoneInstance.off("removedfile",this.handleRemovedFile),this.dropzoneInstance.off("error",this.handleError),this.dropzoneInstance.off("dragover",this.handleDragOver),this.dropzoneInstance.off("dragleave",this.handleDragLeave),this.dropzoneInstance.off("drop",this.handleDragLeave))}updateValue(e){this.value=this.collectFormData(),this.dispatchEvent(new CustomEvent("vl-input",{composed:!0,bubbles:!0,detail:e})),this.dispatchEventIfValid(e)}collectFormData(){let e=this.name||this.id;return this.getFiles()?.length?this.getFiles().reduce((t,s,i)=>(i?t.append(e,s,s.name):t.set(e,s,s.name),t),new FormData):""}async areFileHashesEqual(e,t){async function s(e){let t=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(t)).map(e=>e.toString(16).padStart(2,"0")).join("")}async function i(e){let t=await e.arrayBuffer();return await s(t)}return await i(e)===await i(t)}async detectDuplicate(e,t){if(e){let s=e.length,i=e.slice();for(let e=0;e<s-1;e++)if(i[e]&&t){let s=await this.areFileHashesEqual(i[e],t);if(i[e].name===t.name&&i[e].size===t.size||s)return!0}}return!1}constructor(...e){super(...e),this.readonly=h.readonly,this.acceptedFiles=h.acceptedFiles,this.autoProcess=h.autoProcess,this.disallowDuplicates=h.disallowDuplicates,this.errorMessageAcceptedFiles=h.errorMessageAcceptedFiles,this.errorMessageFilesize=h.errorMessageFilesize,this.errorMessageMaxFiles=h.errorMessageMaxFiles,this.maxFiles=h.maxFiles,this.maxSize=h.maxSize,this.subTitle=h.subTitle,this.mainTitle=h.mainTitle,this.url=h.url,this.value="",this.handleAddedFile=async e=>{await this.updateFileList(this.dropzoneInstance,e),this.updateValue({type:"addedfile",file:e,value:this.value})},this.handleRemovedFile=async e=>{await this.updateFileList(this.dropzoneInstance),this.updateValue({type:"removedfile",file:e,value:this.value})},this.handleError=(e,t)=>{this.dispatchEvent(new CustomEvent("vl-error",{composed:!0,bubbles:!0,detail:{type:"error",file:e,value:this.value,errorMessage:t}}))},this.handleFilesCloseButtonClick=e=>{this.dropzoneInstance?.removeAllFiles(),this.dropzoneInstance&&this.updateFileList(this.dropzoneInstance),e.preventDefault()},this.handleTitleClick=()=>{this.getInput()?.click()},this.handleDragOver=()=>{this.getUploadElement()?.classList.add("vl-upload--dragging")},this.handleDragLeave=()=>{this.getUploadElement()?.classList.remove("vl-upload--dragging")}}}c=function(e,t,s,i){var a,l=arguments.length,o=l<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,s):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,s,i);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(l<3?a(o):l>3?a(t,s,o):a(t,s))||o);return l>3&&o&&Object.defineProperty(t,s,o),o}([(0,r.a6)("vl-upload-next")],c)}}]);