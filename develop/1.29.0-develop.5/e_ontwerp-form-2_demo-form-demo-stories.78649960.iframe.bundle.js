"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[1314],{"./apps/storybook/docs/e_ontwerp/form/2_demo/form-demo.stories.ts":(e,t,l)=>{l.r(t),l.d(t,{Demo:()=>D,__namedExportsOrder:()=>R,default:()=>C});var r={};l.r(r),l.d(r,{Demo:()=>D,__namedExportsOrder:()=>R,default:()=>C});var o=l("./node_modules/lit-html/lit-html.js"),s=l("./libs/common/utilities/src/index.ts"),n=l("./node_modules/tslib/tslib.es6.mjs"),a=l("./node_modules/lit/index.js"),i=l("./libs/form/src/next/form-label/index.ts"),c=l("./libs/form/src/next/error-message/index.ts"),d=l("./libs/elements/src/index.ts"),m=l("./libs/form/src/next/input-field/index.ts"),u=l("./libs/form/src/next/input-field-masked/vl-input-field-masked.component.ts"),v=l("./libs/form/src/next/textarea/vl-textarea.component.ts"),h=l("./libs/form/src/next/select/index.ts"),b=l("./libs/form/src/next/checkbox/vl-checkbox.component.ts"),p=l("./libs/form/src/next/radio-group/vl-radio.component.ts"),f=l("./libs/form/src/next/radio-group/vl-radio-group.component.ts"),x=l("./libs/form/src/next/datepicker/vl-datepicker.component.ts"),g=l("./libs/form/src/next/upload/index.ts"),k=l("./libs/form/src/util/utils.ts");class y extends a.oi{static{(0,s.YV)([i.i,m.z,u.X,v.n,x.Z1,h.k,f.X,p.P,g.F,b.E,c.m])}static get styles(){return[d.CX,(0,a.iv)`
                form {
                    margin-top: 1rem;
                    max-width: 800px;
                }
            `]}render(){return(0,a.dy)`
