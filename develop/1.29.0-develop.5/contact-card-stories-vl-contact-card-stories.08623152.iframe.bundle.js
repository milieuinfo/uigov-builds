"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[9791],{"./libs/components/src/contact-card/stories/vl-contact-card.stories.ts":(t,e,n)=>{n.r(e),n.d(e,{__namedExportsOrder:()=>r,contactCardDefault:()=>i,default:()=>l});var a=n("./libs/common/storybook/src/index.ts"),o=n("./node_modules/lit-html/lit-html.js");n("./libs/components/src/infoblock/vl-infoblock.component.ts"),n("./libs/components/src/contact-card/vl-contact-card.component.ts");let l={title:"Components/contact-card",tags:["autodocs"],args:a._O,argTypes:(0,a.Wp)(),parameters:{controls:{hideNoControlsWarning:!0}}},i=(0,a.yg)({},()=>(0,o.dy)` <vl-contact-card>
        <vl-infoblock
            slot="info"
...
`;class d extends(0,a.W$)(HTMLElement){static{(0,a.YV)([o.CH,o.YY])}constructor(){super(`
            <style>
                ${l.YN}
                ${l.R8}
                ${i.o7}
