"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[2223],{"../../libs/components/src/typography/stories/vl-typography.stories.ts":(e,t,i)=>{i.r(t),i.d(t,{__namedExportsOrder:()=>d,default:()=>r,typographyDefault:()=>n,typographyLists:()=>s,typographyMarkup:()=>u,typographyParameters:()=>m,typographyTable:()=>p,typographyTitles:()=>l});var a=i("../../node_modules/lit-html/lit-html.js");i("../../libs/components/src/typography/vl-typography.component.ts");var o=i("../../libs/common/storybook/src/index.ts");let r={title:"Components/typography",tags:["autodocs"],args:{...o.D8,parameters:'{"key1": "tempus" , "key2": "ipsum" }'},argTypes:{...(0,o.RN)(),parameters:{name:"data-vl-parameters",description:"De key/value parameters die verwerkt en getoond zullen worden in het content element.",control:{disable:!0},table:{type:{summary:"string"}}}},parameters:{controls:{hideNoControlsWarning:!0}}},n=()=>(0,a.qy)` <vl-typography data-cy="typography">
    ...
    <h5>Heading 5</h5>
    <h6>Heading 6</h6>
</vl-typography>`;l.storyName="vl-typography - titles";let s=()=>(0,a.qy)` <vl-typography data-cy="typography">
    <ul>
...
</vl-typography>`;s.storyName="vl-typography - lists";let u=()=>(0,a.qy)` <vl-typography data-cy="typography">
    ...
    <p></p>
</vl-typography>`;u.storyName="vl-typography - markup";let p=()=>(0,a.qy)` <vl-typography data-cy="typography">
    <table>
        <caption>
            table title
        </caption>
