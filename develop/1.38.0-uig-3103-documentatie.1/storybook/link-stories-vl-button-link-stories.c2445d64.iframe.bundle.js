"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[6964],{"../../libs/elements/src/link/stories/vl-button-link.stories.ts":(a,t,e)=>{e.r(t),e.d(t,{__namedExportsOrder:()=>i,buttonLinkDefault:()=>r,buttonLinkWithIcon:()=>s,default:()=>o});var l=e("../../node_modules/lit-html/lit-html.js"),n=e("../../libs/elements/src/link/stories/vl-link.stories-arg.ts");e("../../libs/elements/src/link/vl-button-link.element.ts"),e("../../libs/elements/src/icon/vl-icon.element.ts");let o={title:"Elements/link/button-link",tags:["autodocs"],args:n.ly,argTypes:n.le},r=({block:a,error:t,content:e,inline:n,small:o,large:r,bold:s})=>(0,l.qy)` <button
        is="vl-button-link"
        ?data-vl-block=${a}
        ?data-vl-error=${t}
        ?data-vl-inline=${n}
    ...
    >
        ${e}
    </button>`;r.storyName="vl-button-link - default";let s=({block:a,error:t,content:e,type:n,icon:o,inline:r,small:s,large:i,bold:d})=>"before"===n?(0,l.qy)` <button
            is="vl-button-link"
            ?data-vl-block=${a}
            ?data-vl-error=${t}
            ?data-vl-inline=${r}
