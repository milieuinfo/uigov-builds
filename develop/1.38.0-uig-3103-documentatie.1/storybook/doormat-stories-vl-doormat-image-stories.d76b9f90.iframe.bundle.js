"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[2196],{"../../libs/elements/src/doormat/stories/vl-doormat-image.stories.ts":(e,a,o)=>{o.r(a),o.d(a,{__namedExportsOrder:()=>r,default:()=>i,doormatWithImage:()=>n});var t=o("../../node_modules/lit-html/lit-html.js");o("../../libs/elements/src/doormat/vl-doormat.element.ts");let i={title:"Elements/doormat/doormat-image",tags:["autodocs"],args:{graphic:!1},argTypes:{graphic:{name:"data-vl-graphic",description:"Default doormat with a large image above.",type:{summary:"boolean"},defaultValue:{summary:"false"}}}},n=({graphic:e})=>(0,t.qy)` <div style="max-width: 780px">
