"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[9878],{"../../libs/components/src/proza-message/vl-proza-message-preloader.component.ts":(e,t,a)=>{a.d(t,{k:()=>r});var s=a("../../libs/common/utilities/src/index.ts"),o=a("../../libs/components/src/proza-message/vl-proza-rest-client.util.ts");class r extends(0,s.H3)(HTMLElement){static get _observedAttributes(){return["domain"]}constructor(){super(),this._preload()}_domainChangedCallback(){this._preload()}get _domain(){return this.dataset.vlDomain}get _baseUrl(){return this.dataset.vlBaseUrl}_preload(){this._domain&&r._preload(this._domain,this._baseUrl)}static _preload(e,t){r.isPreloaded(e)||r.__setPreloadedMessagesCacheForDomain(e,o.s.getMessages(e,t))}static getMessage(e,t){return r._getMessages(e).then(a=>{let s=a[t];if(s)return s;throw Error(`Bericht voor {domein: ${e}, code: ${t}} niet gevonden`)})}static async getProzaCodes(e,t,a){return r._preload(e,a),Object.keys(await r._getMessages(e)).filter(e=>e.startsWith(t))}static isPreloaded(e){return!!r.__getPreloadedMessagesCacheForDomain(e)}static _getMessages(e){return r.isPreloaded(e)?r.__getPreloadedMessagesCacheForDomain(e):Promise.reject(Error(`Berichten voor domein ${e} zijn niet preloaded`))}static get __domainCache(){return r.__cache||(r.__cache={}),r.__cache}static __getCacheForDomain(e){let t=r.__domainCache;return t[e]||(t[e]={}),t[e]}static __getPreloadedMessagesCacheForDomain(e){return r.__getCacheForDomain(e).messages}static __setPreloadedMessagesCacheForDomain(e,t){r.__getCacheForDomain(e).messages=t}}r=function(e,t,a,s){var o,r=arguments.length,n=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,a):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,a,s);else for(var i=e.length-1;i>=0;i--)(o=e[i])&&(n=(r<3?o(n):r>3?o(t,a,n):o(t,a))||n);return r>3&&n&&Object.defineProperty(t,a,n),n}([(0,s.M1)("vl-proza-message-preloader")],r)},"../../libs/components/src/proza-message/vl-proza-message.component.ts":(e,t,a)=>{a.d(t,{W:()=>p});var s=a("../../libs/common/utilities/src/index.ts"),o=a("../../libs/elements/src/index.ts"),r=a("../../libs/components/src/typography/vl-typography.component.ts"),n=a("../../libs/components/src/proza-message/vl-proza-message-preloader.component.ts"),i=a("../../node_modules/lit/index.js");let l=(0,i.AH)`
    :host {
...
`,c=[...o.hF,l];var d=a("../../libs/components/src/proza-message/vl-proza-rest-client.util.ts");class p extends(0,s.H3)(HTMLElement){static{(0,s.gy)([o.lC,o.yF,o.I5,r.I])}static get _observedAttributes(){return["domain","code","block","parameters"]}constructor(){super(),this.shadow(`
          <style>
            ${c}
          </style>
          <div>
