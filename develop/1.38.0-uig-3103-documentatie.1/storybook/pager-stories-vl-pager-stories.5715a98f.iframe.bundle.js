"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[4857],{"../../libs/components/src/pager/stories/vl-pager.stories.ts":(e,t,a)=>{a.r(t),a.d(t,{__namedExportsOrder:()=>d,default:()=>l,pagerDefault:()=>g,pagerSinglePage:()=>o,pagerWithoutPageItems:()=>p});var s=a("../../node_modules/lit-html/lit-html.js");a("../../libs/components/src/pager/vl-pager.component.ts");var i=a("../../libs/common/storybook/src/index.ts"),r=a("../../node_modules/@storybook/addon-actions/dist/index.mjs");let l={title:"Components/pager",tags:["autodocs"],args:{...i.D8,totalItems:50,currentPage:1,itemsPerPage:7,paginationDisabled:!1,alignCenter:!1,alignRight:!1,change:(0,r.XI)("change")},argTypes:{...(0,i.RN)(),totalItems:{name:"data-vl-total-items",description:"This attribute determines the total number of elements.",table:{type:{summary:"number"},category:"Attributes",defaultValue:{summary:100}}},currentPage:{name:"data-vl-current-page",description:"This attribute determines the current page.",table:{type:{summary:"number"},category:"Attributes",defaultValue:{summary:1}}},itemsPerPage:{name:"data-vl-items-per-page",description:"This attribute determines the number of rows to show per page.",table:{type:{summary:"number"},category:"Attributes",defaultValue:{summary:10}}},paginationDisabled:{name:"data-vl-pagination-disabled",description:"This attribute determines if the page links should be disabled.",table:{type:{summary:"boolean"},category:"Attributes",defaultValue:{summary:"false"}}},alignCenter:{name:"data-vl-align-center",description:"This attribute is used to center the pagination.",table:{type:{summary:"boolean"},category:"Attributes",defaultValue:{summary:"false"}}},alignRight:{name:"data-vl-align-right",description:"This attribute is used to align the pagination to the right.",table:{type:{summary:"boolean"},category:"Attributes",defaultValue:{summary:"false"}}},change:{name:"change",description:"This event is triggered when a click on a pager item happens. In the detail of the event you can find the current page, total page number, items per page number and the total amount of items of the pagination.",table:{category:"Events"}}}},n=({totalItems:e,itemsPerPage:t,currentPage:a,paginationDisabled:i,alignCenter:r,alignRight:l,change:n})=>(0,s.qy)`
    <vl-pager
...
`;class g extends(0,s.H3)(HTMLElement){static get _observedAttributes(){return["total-items","items-per-page","current-page","pagination-disabled"]}static get _observedChildClassAttributes(){return["align-center","align-right"]}constructor(){super(),this.shadow(`
          <style>
            ${r.h8}
            ${i.bJ}
            ${n}
