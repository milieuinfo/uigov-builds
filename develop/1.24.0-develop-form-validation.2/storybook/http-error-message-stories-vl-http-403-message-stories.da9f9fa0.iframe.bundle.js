"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[5937],{"./libs/components/src/http-error-message/stories/vl-http-403-message.stories.ts":(e,t,s)=>{s.r(t),s.d(t,{__namedExportsOrder:()=>i,default:()=>r,http403MessageDefault:()=>a});var l=s("./node_modules/lit-html/lit-html.js");s("./libs/components/src/http-error-message/vl-http-403-message.component.ts");let r={title:"components/http-error-message"},a=()=>(0,l.dy)` <vl-http-403-message></vl-http-403-message>`;a.storyName="vl-http-403-message - default",a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => html` <vl-http-403-message></vl-http-403-message>`",...a.parameters?.docs?.source}}};let i=["http403MessageDefault"]},"./libs/components/src/http-error-message/vl-http-403-message.component.ts":(e,t,s)=>{var l=s("./libs/common/utilities/src/index.ts"),r=s("./libs/elements/src/index.ts"),a=s("./node_modules/@domg/govflanders-style/common/index.js"),i=s("./node_modules/@domg/govflanders-style/component/index.js"),n=s("./node_modules/lit/index.js"),o=s("./libs/components/src/http-error-message/vl-http-error-message.component.ts");class c extends l.fS{static{(0,l.YV)([o.k,r.uu])}static get styles(){return[a.Oh,i.jn]}render(){return(0,n.dy)`
        ...
        `}}c=function(e,t,s,l){var r,a=arguments.length,i=a<3?t:null===l?l=Object.getOwnPropertyDescriptor(t,s):l;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,s,l);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(i=(a<3?r(i):a>3?r(t,s,i):r(t,s))||i);return a>3&&i&&Object.defineProperty(t,s,i),i}([(0,l.a6)("vl-http-403-message")],c)},"./libs/components/src/http-error-message/vl-http-error-message.component.ts":(e,t,s)=>{s.d(t,{k:()=>i});var l=s("./libs/common/utilities/src/index.ts"),r=s("./libs/elements/src/index.ts"),a=s("./libs/components/src/typography/vl-typography.component.ts");class i extends(0,l.W$)(HTMLElement){static{(0,l.YV)([r.CH,r.YY,r.Br,a.P])}static get _observedAttributes(){return["title","image","image-alt"]}constructor(){super(`
          <style>
            ${r.CX}
          </style>
