(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[8091],{"../../node_modules/@govflanders/vl-ui-accordion/dist/js/accordion.js":function(e){var t;"undefined"!=typeof self&&self,t=function(){"use strict";var e="js-".concat(vl.ns,"accordion"),t="".concat(e,"--open"),o="".concat(e,"__toggle"),n=".".concat(o,"__text"),c="".concat(vl.ns,"step--disabled"),r="".concat(vl.ns,"vi-plus"),i="".concat(vl.ns,"vi-minus"),l="".concat(vl.ns,"accordion__content"),d="data-".concat(vl.ns),a="".concat(d,"accordion"),s="".concat(a,"-dressed"),v="".concat(a,"-toggle"),u=function(){var d;function u(){!function(e,t){if(!(e instanceof t))throw TypeError("Cannot call a class as a function")}(this,u)}return d=[{key:"_listenToHash",value:function(e){window.location.hash&&e.hasAttribute("id")&&"#".concat(e.getAttribute("id"))===window.location.hash&&this.open(e)}},{key:"open",value:function(e){var o=e.querySelector("[".concat(v,"]"));o&&!vl.util.hasClass(e,t)&&o.click()}},{key:"toggle",value:function(e){var t=e.querySelector("[".concat(v,"]"));t&&t.click()}},{key:"dress",value:function(o){var d,v,u,g,m=this,h=o.getAttribute("id")||vl.util.uniqueId(),_=!0;o.setAttribute(s,!0),d=o.querySelector(n),v=o.closest(".".concat(e,", [").concat(a,"]")).querySelector(".".concat(l)),vl.util.exists(v)&&v.setAttribute("aria-hidden",_),d?(u=d.dataset.vlAccordionCloseText,g=d.dataset.vlAccordionOpenText,vl.util.hasClass(o,t)?d.innerHTML=u:d.innerHTML=g,d.setAttribute("id",h)):o.setAttribute("aria-expanded",!1),o.addEventListener("click",function(n){var l=n.target.closest(".".concat(e,", [").concat(a,"]"));if(l&&!vl.util.hasClass(o,c)){n.preventDefault(),_=!_,vl.util.toggleClass(l,t),d||o.setAttribute("aria-expanded",!_);var s=new CustomEvent("vl.accordion.hook.onChange",{detail:!_,target:l}),u=o.querySelector(".vl-vi");l.dispatchEvent(s),u&&vl.util.hasClass(u,r)?(vl.util.removeClass(u,r),vl.util.addClass(u,i)):u&&vl.util.hasClass(u,i)&&(vl.util.removeClass(u,i),vl.util.addClass(u,r)),vl.util.exists(v)&&v.setAttribute("aria-hidden",_),d&&(vl.util.hasClass(l,t)?d.innerHTML=d.dataset.vlAccordionCloseText:d.innerHTML=d.dataset.vlAccordionOpenText)}},!1),this._listenToHash(o),window.addEventListener("hashchange",function(){m._listenToHash(o)})}},{key:"dressAll",value:function(){var t=this,n=document.querySelectorAll("\n      .".concat(e,':not([data-vl-js-dress="false"]) .').concat(o,":not([").concat(s,"]),\n      [").concat(a,"]:not([data-").concat(vl.ns,'js-dress="false"]) [').concat(v,"]:not([").concat(s,"])\n    "));vl.util.each(n,function(e){t.dress(e)})}}],function(e,t){for(var o=0;o<t.length;o++){var n=t[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}(u.prototype,d),Object.defineProperty(u,"prototype",{writable:!1}),u}();return"accordion"in vl||(vl.accordion=new u,document.addEventListener("DOMContentLoaded",function(){vl.accordion.dressAll()})),u},e.exports=t()},"../../node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js":(e,t,o)=>{"use strict";o.d(t,{BN:()=>c,RP:()=>i,gz:()=>r,xA:()=>d});var n=o("../../node_modules/react/index.js");let c=n.createContext({});function r(e){return function(t){let o=i(t.components);return n.createElement(e,{...t,allComponents:o})}}function i(e){let t=n.useContext(c);return n.useMemo(()=>"function"==typeof e?e(t):{...t,...e},[t,e])}let l={};function d({components:e,children:t,disableParentContext:o}){let r;return r=o?"function"==typeof e?e({}):e||l:i(e),n.createElement(c.Provider,{value:r},t)}},"../../libs/components/src/accordion-list/stories/vl-accordion-list.stories.ts":(e,t,o)=>{"use strict";o.r(t),o.d(t,{AccordionListDefault:()=>u,AccordionListNested:()=>g,__namedExportsOrder:()=>m,default:()=>v});var n=o("../../libs/common/storybook/src/index.ts"),c=o("../../node_modules/lit-html/lit-html.js");o("../../libs/components/src/accordion/vl-accordion.component.ts"),o("../../libs/components/src/accordion-list/vl-accordion-list.component.ts");let r={...n.D8,bordered:!1},i={...(0,n.RN)(),bordered:{name:"data-vl-bordered",description:"Beeldt een border af boven en onder de accordions.",table:{type:{summary:n.QE.BOOLEAN},category:n.R6.ATTRIBUTES,defaultValue:{summary:!1}}}};o("../../node_modules/react/index.js");var l=o("../../node_modules/react/jsx-runtime.js"),d=o("../../node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),a=o("../../node_modules/@storybook/blocks/dist/index.mjs");function s(e){let t=Object.assign({h1:"h1",p:"p",a:"a",h2:"h2",pre:"pre",code:"code",h3:"h3"},(0,d.RP)(),e.components);return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(t.h1,{id:"accordion-list",children:"Accordion List"}),"\n",(0,l.jsxs)(t.p,{children:["Een lijst component die kan gebruikt worden als je meerdere accordions wilt afbeelden.\nVoor meer informatie over accordions zie de ",(0,l.jsx)(t.a,{href:"/docs/components-accordion--documentatie",children:"accordion"})," component."]}),"\n",(0,l.jsx)(t.h2,{id:"voorbeeld",children:"Voorbeeld"}),"\n",(0,l.jsx)(t.pre,{children:(0,l.jsx)(t.code,{className:"language-js",children:"import { VlAccordionListComponent } from '@domg-wc/components';\n"})}),"\n",(0,l.jsx)(t.pre,{children:(0,l.jsx)(t.code,{className:"language-html",children:"<vl-accordion-list></vl-accordion-list>\n"})}),"\n",(0,l.jsx)(a.Hl,{of:u}),"\n",(0,l.jsx)(t.h2,{id:"configuratie",children:"Configuratie"}),"\n",(0,l.jsx)(a.ov,{of:u}),"\n",(0,l.jsx)(t.h2,{id:"varianten",children:"Varianten"}),"\n",(0,l.jsx)(t.h3,{id:"nested",children:"Nested"}),"\n",(0,l.jsx)(a.Hl,{of:g}),"\n",(0,l.jsx)(t.h2,{id:"referenties",children:"Referenties"}),"\n",(0,l.jsx)(t.h3,{id:"digitaal-vlaanderen",children:"Digitaal Vlaanderen"}),"\n",(0,l.jsx)(t.p,{children:(0,l.jsx)(t.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/js-components/vl-ui-accordion",target:"_blank",rel:"nofollow noopener noreferrer",children:"Documentatie Digitaal Vlaanderen - Accordion List"})})]})}let v={title:"Components/accordion-list",tags:["autodocs"],args:r,argTypes:i,parameters:{docs:{page:function(e={}){let{wrapper:t}=Object.assign({},(0,d.RP)(),e.components);return t?(0,l.jsx)(t,Object.assign({},e,{children:(0,l.jsx)(s,e)})):s(e)}}}},u=(0,n._7)(r,({bordered:e})=>(0,c.qy)`
    ...
    `);u.storyName="vl-accordion-list - default";let g=(0,n._7)(r,({bordered:e})=>(0,c.qy)`
        <vl-accordion-list ?data-vl-bordered=${e}>
