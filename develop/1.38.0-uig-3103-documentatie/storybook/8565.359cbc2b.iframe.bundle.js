"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[8565],{"../../libs/form/src/next/error-message/vl-error-message.component.ts":(e,l,t)=>{t.d(l,{O:()=>a,X:()=>d});var s=t("../../libs/common/utilities/src/index.ts"),i=t("../../node_modules/@domg/govflanders-style/common/index.js"),o=t("../../node_modules/@domg/govflanders-style/component/index.js"),r=t("../../node_modules/lit/index.js"),c=t("../../libs/form/src/next/error-message/vl-error-message.defaults.ts");let n=(0,r.AH)`
    .vl-form__error {
        margin-top: 0.2rem;
    }
`,a="vl-error-message-next";class d extends s.jW{static get styles(){return[i.h8,o.xV,n]}static get properties(){return{show:{type:Boolean,reflect:!0},for:{type:String},state:{type:String}}}render(){return(0,r.qy)`
        ...
        `}constructor(...e){super(...e),this.show=c.M.show,this.for=c.M.for,this.state=c.M.state}}d=function(e,l,t,s){var i,o=arguments.length,r=o<3?l:null===s?s=Object.getOwnPropertyDescriptor(l,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,l,t,s);else for(var c=e.length-1;c>=0;c--)(i=e[c])&&(r=(o<3?i(r):o>3?i(l,t,r):i(l,t))||r);return o>3&&r&&Object.defineProperty(l,t,r),r}([(0,s.M1)(a)],d)},"../../libs/form/src/next/error-message/vl-error-message.defaults.ts":(e,l,t)=>{t.d(l,{M:()=>s});let s={show:!1,for:null,state:null}},"../../libs/form/src/next/form-control/form-control.defaults.ts":(e,l,t)=>{t.d(l,{i:()=>s});let s={id:"",name:"",label:"",required:!1,disabled:!1,error:!1,success:!1}},"../../libs/form/src/next/form-control/form-control.ts":(e,l,t)=>{t.d(l,{M:()=>d});var s=t("../../libs/form/src/next/form-control/form-control.defaults.ts"),i=t("../../node_modules/@open-wc/form-control/src/FormControlMixin.js"),o=t("../../node_modules/@open-wc/form-control/src/validators.js"),r=t("../../node_modules/lit/index.js"),c=t("../../node_modules/@open-wc/form-helpers/src/index.js"),n=t("../../libs/form/src/next/error-message/vl-error-message.component.ts"),a=t("../../libs/common/utilities/src/index.ts");t("../../node_modules/reflect-metadata/Reflect.js");class d extends(0,i.F)(a.jW){static{this.formControlValidators=[o.yt,o.Bt]}static{this.shadowRootOptions={...r.WF.shadowRootOptions,delegatesFocus:!0}}static get properties(){return{id:{type:String},name:{type:String},label:{type:String},required:{type:Boolean},disabled:{type:Boolean},error:{type:Boolean},success:{type:Boolean},isInvalid:{type:Boolean,state:!0}}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeydown),this.addEventListener("invalid",this.onInvalid)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeydown),this.removeEventListener("invalid",this.onInvalid)}updated(e){super.updated(e),e.has("isInvalid")||(this.isInvalid=!1,this.hideErrorMessages())}resetFormControl(){this.isInvalid=!1,this.hideErrorMessages(),this.dispatchEvent(new Event("vl-reset",{bubbles:!0,composed:!0}))}dispatchEventIfValid(e){this.validity.valid&&this.dispatchEvent(new CustomEvent("vl-valid",{composed:!0,bubbles:!0,detail:e}))}onKeydown(e){"Enter"===e.code&&this.form&&this.submitFormOnEnter&&(0,c.tA)(this.form)}onInvalid(e){e.preventDefault(),this.isInvalid=!0,this.focusFirstInvalidInput(),this.showErrorMessage()}focusFirstInvalidInput(){let e=this.form?.querySelector(":invalid");this===e&&(e?.focus(),e?.scrollIntoView({behavior:"smooth",block:"center"}))}showErrorMessage(){let e="";for(let l in this.validity)if(this.validity[l]){e=l;break}let l=this.form?.querySelector(`${n.O}[for="${this.id}"][state="${e}"]`);l||(l=this.form?.querySelector(`${n.O}[for="${this.id}"]:not([state])`)),l?.setAttribute("show","")}hideErrorMessages(){let e=this.form?.querySelectorAll(`${n.O}[for="${this.id}"]`);e?.forEach(e=>{e.removeAttribute("show")})}constructor(...e){super(...e),this.id=s.i.id,this.name=s.i.name,this.label=s.i.label,this.required=s.i.required,this.disabled=s.i.disabled,this.error=s.i.error,this.success=s.i.success,this.isInvalid=!1,this.submitFormOnEnter=!0}}},"../../libs/form/src/next/select-rich/vl-select-rich.component.ts":(e,l,t)=>{t.d(l,{Al:()=>b});var s=t("../../libs/common/utilities/src/index.ts"),i=t("../../node_modules/@domg/govflanders-style/common/index.js"),o=t("../../node_modules/@domg/govflanders-style/component/index.js"),r=t("../../node_modules/lit/index.js"),c=t("../../node_modules/lit/directives/class-map.js"),n=t("../../libs/form/src/next/form-control/form-control.ts");let a=(0,r.AH)`
    .vl-pill {
        display: inline-flex;
        max-width: 100%;
        align-items: center;
...
`;var m=t("../../libs/form/src/next/select-rich/vl-select-rich.defaults.ts"),p=t("../../node_modules/choices.js/public/assets/scripts/choices.js"),v=t.n(p);let h=p.DEFAULT_CLASSNAMES,_=v();class b extends n.M{static get styles(){return[i.h8,i.BI,o._T,u,a,o.py,d]}static get properties(){return{options:{type:Array},placeholder:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},multiple:{type:Boolean},search:{type:Boolean},position:{type:String},resultLimit:{type:Number,attribute:"result-limit"},noResultsText:{type:String,attribute:"no-results-text"},noChoicesText:{type:String,attribute:"no-choices-text"},searchPlaceholder:{type:String,attribute:"search-placeholder"},value:{type:FormData,state:!0,hasChanged:(e,l)=>e instanceof FormData&&l instanceof FormData?JSON.stringify([...e.entries()])!==JSON.stringify([...l.entries()]):e!==l}}}constructor(){super(),this.options=m.X.options,this.placeholder=m.X.placeholder,this.notDeletable=m.X.notDeletable,this.multiple=m.X.multiple,this.search=m.X.search,this.position=m.X.position,this.resultLimit=m.X.resultLimit,this.noResultsText=m.X.noResultsText,this.noChoicesText=m.X.noChoicesText,this.searchPlaceholder=m.X.searchPlaceholder,this.value=null,this.choices=null,this.initialOptions=[],this.onClickChoices=e=>{e.stopPropagation(),this.disabled||this.choices?.showDropdown()},this.onSearchInput=e=>{let l=e?.target?.value;this.dispatchEvent(new CustomEvent("vl-select-search",{bubbles:!0,composed:!0,detail:{value:l}}))},this.submitFormOnEnter=!1}firstUpdated(e){super.firstUpdated(e),this.choices=new _(this.validationTarget,this.getChoicesConfig()),this.initialOptions=[...JSON.parse(JSON.stringify(this.options))],setTimeout(()=>{this.getChoicesElement()?.addEventListener("click",this.onClickChoices),this.internals.labels[0]?.addEventListener("click",this.onClickChoices),this.value||this.setValue(null),this.choices?.input?.element?.addEventListener("input",this.onSearchInput)},0)}updated(e){if(super.updated(e),this.choices){if(e.has("options")&&(this.choices.clearStore(),this.choices.setChoices(this.getOptions(),"value","label",!0),this.onChange()),e.has("value")){let e={value:this.getSelected()};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-select",{bubbles:!0,composed:!0,detail:e})),this.dispatchEventIfValid(e)}e.has("disabled")&&(this.disabled?this.choices.disable():this.choices.enable()),e.has("error")&&this.internals.setValidity({customError:this.error},"custom-error"),e.has("resultLimit")&&(this.choices.config.searchResultLimit=this.resultLimit)}}disconnectedCallback(){super.disconnectedCallback(),this.getChoicesElement()?.removeEventListener("click",this.onClickChoices),this.internals.labels[0]?.removeEventListener("click",this.onClickChoices),this.choices?.input?.element?.removeEventListener("input",this.onSearchInput)}render(){let e={"vl-select":!this.multiple,"vl-multiselect":this.multiple,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success};return(0,r.qy)`
            <select
                id=${this.id||r.s6}
                name=${this.name||r.s6}
                class=${(0,c.H)(e)}
        ...
        `}get validationTarget(){return this.shadowRoot?.querySelector("select")}resetFormControl(){super.resetFormControl(),this.options=[...this.initialOptions]}getSelected(){return this.multiple?this.getSelectedValues():this.getSelectedValues()[0]||null}getSelectedValues(){return Array.from(this.validationTarget.selectedOptions).filter(e=>e.value).map(e=>e.value)}collectFormData(){let e=this.name||this.id,l=this.getSelectedValues();return l?.length?l.reduce((l,t,s)=>(s?l.append(e,t):l.set(e,t),l),new FormData):null}getChoicesElement(){return this.shadowRoot?.querySelector(".js-vl-select")}getChoicesConfig(){return{shouldSort:!1,removeItemButton:!this.notDeletable,removeItems:!this.notDeletable,searchEnabled:this.search,placeholder:!!this.placeholder,placeholderValue:this.placeholder,position:this.position,noResultsText:this.noResultsText,searchResultLimit:this.resultLimit,noChoicesText:this.noChoicesText,searchPlaceholderValue:this.searchPlaceholder,classNames:{...h,containerOuter:"js-vl-select",containerInner:"vl-select__inner",input:"vl-input-field",inputCloned:"vl-input-field-cloned",list:"vl-select__list",listItems:"vl-select__list--multiple",listSingle:"vl-select__list--single",listDropdown:"vl-select__list--dropdown",item:"vl-select__item",itemSelectable:"vl-select__item--selectable",itemDisabled:"vl-select__item--disabled",itemChoice:"vl-select__item--choice",placeholder:"vl-select__placeholder",group:"vl-select__group",groupHeading:"vl-select__heading",button:"vl-select__button"},callbackOnCreateTemplates:e=>({containerOuter:()=>e(`<div
                        ...
                        `):e(`<div class="
                                ...
                                </div>`),itemList:()=>this.multiple?e('<div class="vl-input-field vl-select__list--multiple"></div>'):e('<div class="vl-input-field"></div>'),input:()=>e('<input type="text" class="vl-input-field vl-input-field-cloned" autocomplete="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" aria-label="zoek item">'),dropdown:()=>e('<div class="vl-select__list vl-select__list--dropdown" role="group" id="vl-select__list"></div>'),choiceList:()=>e('<div class="vl-select__list" role="listbox" aria-label="item lijst" tabindex="0"></div>')})}}getOptions(){let e=[...this.options];if(this.placeholder&&!this.multiple){let l={value:"",label:this.placeholder,placeholder:!0,disabled:!0,selected:!0};e.unshift(l)}return e}onChange(){this.value=this.collectFormData()}}b=function(e,l,t,s){var i,o=arguments.length,r=o<3?l:null===s?s=Object.getOwnPropertyDescriptor(l,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,l,t,s);else for(var c=e.length-1;c>=0;c--)(i=e[c])&&(r=(o<3?i(r):o>3?i(l,t,r):i(l,t))||r);return o>3&&r&&Object.defineProperty(l,t,r),r}([(0,s.M1)("vl-select-rich-next")],b)},"../../libs/form/src/next/select-rich/vl-select-rich.defaults.ts":(e,l,t)=>{t.d(l,{X:()=>o});var s=t("../../libs/form/src/next/form-control/form-control.defaults.ts"),i=t("../../libs/form/src/next/select-rich/vl-select-rich.model.ts");let o={...s.i,options:[],placeholder:"",notDeletable:!1,multiple:!1,search:!1,position:i.u.AUTO,resultLimit:4,noResultsText:"Geen resultaten gevonden",noChoicesText:"Geen resterende opties gevonden",searchPlaceholder:"Zoek item"}},"../../libs/form/src/next/select-rich/vl-select-rich.model.ts":(e,l,t)=>{t.d(l,{u:()=>s});let s={AUTO:"auto",TOP:"top",BOTTOM:"bottom"}}}]);