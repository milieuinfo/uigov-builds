"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[9736],{"./libs/components/src/http-error-message/stories/vl-http-404-message.stories.ts":(e,t,s)=>{s.r(t),s.d(t,{__namedExportsOrder:()=>i,default:()=>a,http404MessageDefault:()=>r});var l=s("./node_modules/lit-html/lit-html.js");s("./libs/components/src/http-error-message/vl-http-404-message.component.ts");let a={title:"components/http-error-message"},r=()=>(0,l.dy)` <vl-http-404-message></vl-http-404-message>`;r.storyName="vl-http-404-message - default",r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => html` <vl-http-404-message></vl-http-404-message>`",...r.parameters?.docs?.source}}};let i=["http404MessageDefault"]},"./libs/components/src/http-error-message/vl-http-404-message.component.ts":(e,t,s)=>{var l=s("./libs/common/utilities/src/index.ts"),a=s("./libs/elements/src/index.ts"),r=s("./node_modules/@domg/govflanders-style/common/index.js"),i=s("./node_modules/@domg/govflanders-style/component/index.js"),n=s("./node_modules/lit/index.js"),o=s("./libs/components/src/http-error-message/vl-http-error-message.component.ts");class c extends l.fS{static{(0,l.YV)([o.k,a.uu])}static get styles(){return[r.Oh,i.jn]}render(){return(0,n.dy)`
...
`,o=[a.$4,n];class c extends(0,l.W$)(HTMLElement){static get _observedAttributes(){return["parameters"]}constructor(){super(`
          <style>
            ${a.YN}
            ${a.Oh}
            ${a.QT}
