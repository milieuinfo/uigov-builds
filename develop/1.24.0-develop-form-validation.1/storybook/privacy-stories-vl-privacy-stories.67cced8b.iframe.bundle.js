(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[6417],{"./libs/sections/src/privacy/stories/vl-privacy.stories.ts":(e,n,i)=>{"use strict";i.r(n),i.d(n,{PrivacyDefault:()=>O,PrivacyHeaderSlot:()=>V,__namedExportsOrder:()=>x,default:()=>y});var a=i("./node_modules/lit-html/lit-html.js"),r=i("./node_modules/lit/directives/unsafe-html.js"),t=i("./libs/common/utilities/src/index.ts"),o=i("./libs/components/src/index.ts"),d=i("./libs/elements/src/index.ts"),v=i("./node_modules/lit/index.js"),s=i("./node_modules/lit/decorators.js");let l=({disableBackLink:e})=>(0,v.dy)`
    ...
    ></vl-functional-header>
`,g={date:"data-vl-date",disableBackLink:"data-vl-disable-back-link",version:"data-vl-version"},{date:p,disableBackLink:m,version:c}=g;class h extends t.fS{static{(0,t.YV)([d.CH,d.YY,d.Oj,d.Br,d.$z,d.jc,d.Gi,d.Fn,d.bs,d.gG,d.lo,d.aL,d.HD,d.M3,d.lV,d.Tj,d.oS,d.rL,d.r2,d.EK,d.xJ,d.lb,o.d4,o.Jy,o.Ui,o.Pz])}static get properties(){return{[p]:{type:String},[m]:{type:Boolean},[c]:{type:String}}}constructor(){super(),this.allowCustomCSS=!1,this[p]="3 maart 2021",this[m]=!1,this[c]="1.0.0"}render(){return(0,v.dy)`
            <style>
                ${d.CX}
            </style>
            <slot name="header">${l(g)}</slot>
                    ...
                    <div is="vl-grid" data-vl-is-stacked>
                        ...
                        <div is="vl-column" data-vl-size="10">
                            <p is="vl-introduction">
                                <span>Versie</span>
                                <span id="introduction-version">${this[c]}</span> -
                                <span id="introduction-date">${this[p]}</span>
                            </p>
                        </div>
        ...
        `}}h=function(e,n,i,a){var r,t=arguments.length,o=t<3?n:null===a?a=Object.getOwnPropertyDescriptor(n,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,n,i,a);else for(var d=e.length-1;d>=0;d--)(r=e[d])&&(o=(t<3?r(o):t>3?r(n,i,o):r(n,i))||o);return t>3&&o&&Object.defineProperty(n,i,o),o}([(0,s.Mo)("vl-privacy")],h),i("./node_modules/react/index.js");var k=i("./node_modules/react/jsx-runtime.js"),u=i("./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),b=i("./node_modules/@storybook/blocks/dist/index.mjs");function w(e){let n=Object.assign({h1:"h1",p:"p",h2:"h2",pre:"pre",code:"code",ul:"ul",li:"li",a:"a",h3:"h3"},(0,u.ah)(),e.components);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(n.h1,{id:"privacy",children:"Privacy"}),"\n",(0,k.jsx)(n.p,{children:"Privacy pagina."}),"\n",(0,k.jsx)(n.h2,{id:"voorbeeld",children:"Voorbeeld"}),"\n",(0,k.jsx)(n.pre,{children:(0,k.jsx)(n.code,{className:"language-js",children:"import { VlPrivacy } from '@domg-lib/sections';\n"})}),"\n",(0,k.jsx)(n.pre,{children:(0,k.jsx)(n.code,{className:"language-html",children:"<vl-privacy></vl-privacy>\n"})}),"\n",(0,k.jsx)(b.Xz,{of:O}),"\n",(0,k.jsx)(n.h2,{id:"configuratie",children:"Configuratie"}),"\n",(0,k.jsx)(b.Ed,{of:O}),"\n",(0,k.jsx)(n.h2,{id:"header-slot",children:"Header Slot"}),"\n",(0,k.jsxs)(n.p,{children:["Standaard wordt deze template gebruikt om de ",(0,k.jsx)(n.code,{children:"functional-header"})," te bepalen in dit component."]}),"\n",(0,k.jsx)(b.Hw,{code:'import { html } from \'lit\';\nexport const header = ({ disableBackLink })=>html`\n    <vl-functional-header\n        data-vl-title="Departement Omgeving"\n        data-vl-sub-title="Privacy"\n        data-vl-link="https://omgeving.vlaanderen.be"\n        ?data-vl-disable-back-link=${disableBackLink}\n    ></vl-functional-header>\n`;\n',language:"ts",dark:!0}),"\n",(0,k.jsxs)(n.p,{children:["Als je wijzigingen wil aanbrengen in de functional header, kan je de standaard ",(0,k.jsx)(n.code,{children:"vl-functional-header"})," vervangen door\neen ander, eventueel aangepaste header element."]}),"\n",(0,k.jsx)(n.p,{children:"Je kan dit bijvoorbeeld vervangen door:"}),"\n",(0,k.jsxs)(n.ul,{children:["\n",(0,k.jsxs)(n.li,{children:["een ",(0,k.jsx)(n.a,{href:"/docs/components-content-header--content-header-default",children:"vl-content-header"})]}),"\n",(0,k.jsxs)(n.li,{children:["of een ",(0,k.jsx)(n.a,{href:"/docs/components-functional-header--functional-header-default",children:"vl-functional-header"})," met andere opties dan de standaard ",(0,k.jsx)(n.code,{children:"functional-header"})," van dit component."]}),"\n"]}),"\n",(0,k.jsxs)(n.p,{children:["In het voorbeeld hieronder kan je zien hoe je voor de ",(0,k.jsx)(n.code,{children:"vl-functional-header"})," bij de teruglink (",(0,k.jsx)(n.code,{children:"data-vl-back"}),') "Start"\nals label kan geven in plaats van "Terug".']}),"\n",(0,k.jsx)(b.Xz,{of:V}),"\n",(0,k.jsx)(n.h2,{id:"referenties",children:"Referenties"}),"\n",(0,k.jsx)(n.h3,{id:"legacy-documentatie",children:"Legacy Documentatie"}),"\n",(0,k.jsx)(n.p,{children:(0,k.jsx)(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/storybook/?path=/docs/custom-elements-vl-privacy--default",target:"_blank",rel:"nofollow noopener noreferrer",children:"Legacy Storybook - Privacy"})}),"\n",(0,k.jsx)(n.p,{children:(0,k.jsx)(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/doc/VlPrivacy.html",target:"_blank",rel:"nofollow noopener noreferrer",children:"Legacy Documentatie - Privacy"})}),"\n",(0,k.jsx)(n.p,{children:(0,k.jsx)(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-privacy.html",target:"_blank",rel:"nofollow noopener noreferrer",children:"Legacy Demo - Privacy"})})]})}var f=i("./libs/common/storybook/src/index.ts");let z={date:"3 maart 2021",disableBackLink:!1,version:"1.0.0",onClickBack:(0,i("./node_modules/@storybook/addon-actions/dist/index.mjs").aD)("vl-click-back"),headerSlot:""},j={date:{name:"data-vl-date",description:"De datum waarop de pagina werd uitgegeven.",table:{type:{summary:f.vK.STRING},category:f.aA.ATTRIBUTES,defaultValue:{summary:z.date}}},disableBackLink:{name:"data-vl-disable-back-link",description:"Zet de terug-link uit.",table:{type:{summary:f.vK.BOOLEAN},category:f.aA.ATTRIBUTES,defaultValue:{summary:z.disableBackLink}}},version:{name:"data-vl-version",description:"De pagina versie.",table:{type:{summary:f.vK.STRING},category:f.aA.ATTRIBUTES,defaultValue:{summary:z.version}}},onClickBack:{name:"vl-click-back",description:"Afgevuurd na het klikken op de terug-link.",table:{type:{summary:"-"},category:f.aA.EVENTS}},headerSlot:{name:"header",description:"Hiermee kan je de standaard functional header vervangen door een header naar keuze.",table:{type:{summary:f.vK.HTML},category:f.aA.SLOTS,defaultValue:z.headerSlot}}},y={title:"sections/privacy",tags:["autodocs"],args:z,argTypes:j,parameters:{layout:"fullscreen",docs:{page:function(e={}){let{wrapper:n}=Object.assign({},(0,u.ah)(),e.components);return n?(0,k.jsx)(n,Object.assign({},e,{children:(0,k.jsx)(w,e)})):w(e)}}}},D=(0,f.yg)(z,({date:e,disableBackLink:n,version:i,onClickBack:t,headerSlot:o})=>(0,a.dy)`
        <vl-privacy
            data-vl-date=${e}
    ...
    `),O=D.bind({});O.storyName="vl-privacy - default";let V=D.bind({});V.storyName="vl-privacy - header slot",V.args={headerSlot:`
    <vl-functional-header
        slot="header"
        data-vl-title="Departement Omgeving"
        data-vl-sub-title="Privacy"
        ...
        data-vl-back="Start"
    ></vl-functional-header>
`},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:"story(privacyArgs, ({\n  date,\n  disableBackLink,\n  version,\n  onClickBack,\n  headerSlot\n}) => html`\n        <vl-privacy\n            data-vl-date=${date}\n            ?data-vl-disable-back-link=${disableBackLink}\n            data-vl-version=${version}\n            @vl-click-back=${onClickBack}\n        >\n            ${unsafeHTML(headerSlot)}\n        </vl-privacy>\n    `)",...O.parameters?.docs?.source}}},V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:"story(privacyArgs, ({\n  date,\n  disableBackLink,\n  version,\n  onClickBack,\n  headerSlot\n}) => html`\n        <vl-privacy\n            data-vl-date=${date}\n            ?data-vl-disable-back-link=${disableBackLink}\n            data-vl-version=${version}\n            @vl-click-back=${onClickBack}\n        >\n            ${unsafeHTML(headerSlot)}\n        </vl-privacy>\n    `)",...V.parameters?.docs?.source}}};let x=["PrivacyDefault","PrivacyHeaderSlot"]},"./node_modules/memoizerific sync recursive":e=>{function n(e){var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}n.keys=()=>[],n.resolve=n,n.id="./node_modules/memoizerific sync recursive",e.exports=n}}]);