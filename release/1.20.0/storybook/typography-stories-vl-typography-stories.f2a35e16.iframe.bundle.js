"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[6881],{"./libs/components/src/typography/vl-typography.component.ts":(e,t,i)=>{i.d(t,{P:()=>u});var a=i("./libs/common/utilities/src/index.ts"),o=i("./node_modules/@domg/govflanders-style/common/index.js"),r=i("./node_modules/@domg/govflanders-style/component/index.js"),n=i("./node_modules/lit/index.js");let l=(0,n.iv)`
    .vl-typography {
        display: inline;
    }
`,s=[o.$4,l],u=class extends(0,a.W$)(HTMLElement){static get _observedAttributes(){return["parameters"]}constructor(){super(`
          <style>
            ${o.YN}
            ${o.Oh}
            ${o.QT}
