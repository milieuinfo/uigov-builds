"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[6697],{"./libs/components/src/http-error-message/vl-http-error-message.component.ts":(e,t,s)=>{s.d(t,{k:()=>i});var a=s("./libs/common/utilities/src/index.ts"),l=s("./libs/elements/src/index.ts"),r=s("./libs/components/src/typography/vl-typography.component.ts");let i=class extends(0,a.W$)(HTMLElement){static{(0,a.YV)([l.CH,l.YY,l.Br,r.P])}static get _observedAttributes(){return["title","image","image-alt"]}constructor(){super(`
          <style>
            ${l.CX}
          </style>
...
`,n=[l.$4,o],m=class extends(0,a.W$)(HTMLElement){static get _observedAttributes(){return["parameters"]}constructor(){super(`
          <style>
            ${l.YN}
            ${l.Oh}
            ${l.QT}
