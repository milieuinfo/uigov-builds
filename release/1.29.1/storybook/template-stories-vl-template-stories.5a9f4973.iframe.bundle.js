"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[2966],{"./libs/components/src/template/stories/vl-template.stories.ts":(t,e,o)=>{o.r(e),o.d(e,{__namedExportsOrder:()=>p,default:()=>c,templateDefault:()=>v});var l=o("./libs/common/utilities/src/index.ts"),s=o("./libs/elements/src/index.ts"),n=o("./node_modules/lit-html/lit-html.js"),a=o("./libs/components/src/content-header/vl-content-header.component.ts");o("./libs/components/src/template/vl-template.component.ts");var i=o("./libs/common/storybook/src/index.ts");let r={...i._O,center:!1,stretch:!1},d={...(0,i.Wp)(),center:{name:"data-vl-v-center",description:"Attribuut wordt gebruikt om ervoor te zorgen dat de content verticaal gecentreerd wordt.",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},stretch:{name:"data-vl-v-stretch",description:"Attribuut wordt gebruikt om ervoor te zorgen dat de content 100% zal innemen.",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}}};(0,l.YV)([a.q,s.YY,s.Oj,s.bs]);let c={title:"components/template",tags:["autodocs"],args:r,argTypes:d},m=(0,n.dy)`
    <vl-content-header>
        <img
            is="vl-image"
            slot="image"
...
>
    ${t}
</div>`,v=({center:t,stretch:e})=>h((0,n.dy)`
        ...
        `,!0);v.storyName="vl-template - default",v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:'({\n  center,\n  stretch\n}: typeof templateArgs) => bodySimulation(html`\n            <vl-template ?data-vl-v-center=${center} ?data-vl-v-stretch=${stretch}>\n                <vl-header\n                    slot="header"\n                    data-vl-identifier="59188ff6-662b-45b9-b23a-964ad48c2bfb"\n                    data-vl-development\n                ></vl-header>\n                <div slot="main">${mainHtml}</div>\n                <vl-footer\n                    slot="footer"\n                    data-vl-identifier="0337f8dc-3266-4e7a-8f4a-95fd65189e5b"\n                    data-vl-development\n                ></vl-footer>\n            </vl-template>\n        `, true)',...v.parameters?.docs?.source}}};let p=["templateDefault"]},"./libs/components/src/content-header/vl-content-header.component.ts":(t,e,o)=>{o.d(e,{q:()=>a});var l=o("./libs/common/utilities/src/index.ts"),s=o("./node_modules/@domg/govflanders-style/component/index.js"),n=o("./node_modules/@domg/govflanders-style/common/index.js");class a extends(0,l.W$)(HTMLElement){constructor(){super(`
          <style>
            ${n.YN}
            ${n.Oh}
            ${n.LF}
...
`;class i extends(0,l.W$)(HTMLElement){constructor(){super(`
      <style>
        ${s.YN}
        ${a}
        ${s.Oh}
