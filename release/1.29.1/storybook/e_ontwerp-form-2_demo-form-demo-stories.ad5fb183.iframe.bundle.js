"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[1314],{"./apps/storybook/docs/e_ontwerp/form/2_demo/form-demo.stories.ts":(e,t,l)=>{l.r(t),l.d(t,{Demo:()=>V,__namedExportsOrder:()=>C,default:()=>$});var r=l("./node_modules/lit-html/lit-html.js"),o=l("./libs/common/utilities/src/index.ts"),s=l("./node_modules/tslib/tslib.es6.mjs"),n=l("./node_modules/lit/index.js"),a=l("./libs/form/src/next/form-label/index.ts"),i=l("./libs/form/src/next/error-message/index.ts"),c=l("./libs/elements/src/index.ts"),d=l("./libs/form/src/next/input-field/index.ts"),m=l("./libs/form/src/next/input-field-masked/vl-input-field-masked.component.ts"),u=l("./libs/form/src/next/textarea/vl-textarea.component.ts"),v=l("./libs/form/src/next/select/index.ts"),h=l("./libs/form/src/next/checkbox/vl-checkbox.component.ts"),b=l("./libs/form/src/next/radio-group/vl-radio.component.ts"),p=l("./libs/form/src/next/radio-group/vl-radio-group.component.ts"),f=l("./libs/form/src/next/datepicker/vl-datepicker.component.ts"),x=l("./libs/form/src/next/upload/index.ts"),g=l("./libs/form/src/utils/index.ts");class k extends n.oi{static{(0,o.YV)([a.i,d.z,m.X,u.n,f.Z1,v.k,p.X,b.P,x.F,h.E,i.m])}static get styles(){return[c.CX,(0,n.iv)`
                form {
                    margin-top: 1rem;
                    max-width: 800px;
                }
