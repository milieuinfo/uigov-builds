"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[4173],{"./libs/components/src/side-sheet/vl-side-sheet.component.ts":(t,e,o)=>{o.d(e,{v:()=>h});var i=o("./libs/common/utilities/src/index.ts"),s=o("./libs/components/src/toggle-button/index.ts"),l=o("./libs/elements/src/index.ts"),n=o("./node_modules/swipe-detect/dist/index.js"),a=o("./node_modules/lit/index.js");let r=(0,a.iv)`
    .vl-vi::before,
    .vl-vi::after {
...
`,d=[...l.CX,r];class h extends(0,i.W$)(HTMLElement){static{(0,i.YV)([l.bs,l.lV,l.yK,s.e])}static get _observedAttributes(){return["enable-swipe","toggle-text","tooltip-text","custom-icon","hide-toggle-button","icon-position","custom-size","open"]}static get _observedClassAttributes(){return["left","right","absolute"]}constructor(t=""){super(`
          <style>
            ${d}
          </style>
          <div>
...
`;class g extends i.fS{static{(0,i.YV)([s.d7,s.Gi,s.yK])}static get properties(){return{icon:{type:String,attribute:"data-vl-icon",reflect:!0},iconPlacement:{type:String,attribute:"data-vl-icon-placement",reflect:!0},textHidden:{type:Boolean,attribute:"data-vl-text-hidden",reflect:!0},error:{type:Boolean,attribute:"data-vl-error",reflect:!0},block:{type:Boolean,attribute:"data-vl-block",reflect:!0},large:{type:Boolean,attribute:"data-vl-large",reflect:!0},wide:{type:Boolean,attribute:"data-vl-wide",reflect:!0},narrow:{type:Boolean,attribute:"data-vl-narrow",reflect:!0},loading:{type:Boolean,attribute:"data-vl-loading",reflect:!0},disabled:{type:Boolean,attribute:"disabled",reflect:!0},_active:{type:Boolean,state:!0},active:{type:Boolean||void 0}}}static get styles(){return[l.YN,n.jn,c,l.PC,n.oQ]}createRenderRoot(){let t=super.createRenderRoot();return t.addEventListener("click",t=>{let{disabled:e}=this;e&&t.stopPropagation()}),t}constructor(){super(),this.icon="",this.iconPlacement="",this.textHidden=!1,this.error=!1,this.block=!1,this.large=!1,this.wide=!1,this.narrow=!1,this.loading=!1,this.disabled=!1,this.isInMap=!1,this._active=!1,this.active=void 0,this.iconPlacement=h.T.AFTER,this.textHidden=!1,this.disabled=!1}_isControlled(){return void 0!==this.active}_fireChange(){this.dispatchEvent(new CustomEvent("change",{detail:{isActive:this._active}}))}updated(t){t.forEach((t,e)=>{switch(e){case"active":this._isControlled()&&(this._active=this.active);break;case"_active":(!this._isControlled()||this._isControlled()&&void 0!==t)&&this._fireChange()}})}_buttonWrap(t){return(0,a.dy)`
            <button
        ...
        `}_iconTemplate(){return this.textHidden?(0,a.dy)`${this._buttonWrap((0,a.dy)`<span is="vl-icon" data-vl-icon=${this.icon}></span>
                    <span is="vl-text" data-vl-visually-hidden><slot></slot></span>`)}`:this.iconPlacement===h.T.BEFORE?(0,a.dy)`${this._buttonWrap((0,a.dy)`<span is="vl-icon" data-vl-icon=${this.icon} data-vl-before></span> <slot></slot>`)}`:(0,a.dy)`${this._buttonWrap((0,a.dy)` <slot></slot><span is="vl-icon" data-vl-icon=${this.icon} data-vl-after></span>`)}`}render(){return this.icon?this._iconTemplate():(0,a.dy)`${this._buttonWrap((0,a.dy)` <slot></slot>`)}`}}g=function(t,e,o,i){var s,l=arguments.length,n=l<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,o,i);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(l<3?s(n):l>3?s(e,o,n):s(e,o))||n);return l>3&&n&&Object.defineProperty(e,o,n),n}([(0,r.Mo)("vl-toggle-button")],g)},"./libs/components/src/toggle-button/vl-toggle-button.model.ts":(t,e,o)=>{o.d(e,{T:()=>i});let i={BEFORE:"before",AFTER:"after"}}}]);