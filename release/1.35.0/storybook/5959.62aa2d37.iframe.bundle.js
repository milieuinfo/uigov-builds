...
`;class c extends(0,l.W$)(HTMLElement){static{(0,l.YV)([i.CH,i.YY])}constructor(){super(`
        ...
        </div>`}constructor(...e){super(...e),this.size=0,this.maxSize=0,this.mediumSize=0,this.mediumMaxSize=0,this.smallSize=0,this.smallMaxSize=0,this.extraSmallSize=0,this.extraSmallMaxSize=0}}c=function(e,t,s,l){var i,r=arguments.length,o=r<3?t:null===l?l=Object.getOwnPropertyDescriptor(t,s):l;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,s,l);else for(var n=e.length-1;n>=0;n--)(i=e[n])&&(o=(r<3?i(o):r>3?i(t,s,o):i(t,s))||o);return r>3&&o&&Object.defineProperty(t,s,o),o}([(0,o.Mo)("vl-description-data")],c)},"./libs/components/src/document/index.ts":(e,t,s)=>{"use strict";s.d(t,{J:()=>l.J});var l=s("./libs/components/src/document/vl-document.component.ts")},"./libs/components/src/document/vl-document.component.ts":(e,t,s)=>{"use strict";s.d(t,{J:()=>o});var l=s("./libs/common/utilities/src/index.ts"),i=s("./node_modules/@domg/govflanders-style/common/index.js"),r=s("./node_modules/@domg/govflanders-style/component/index.js");class o extends l.F9{static get _observedAttributes(){return["href","target"]}constructor(){super(`
          <style>
            ${i.YN}
            ${i.Oh}
            ${i.QT}
