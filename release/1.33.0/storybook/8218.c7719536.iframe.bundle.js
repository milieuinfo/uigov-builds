...
`,c=[...o.CX,a];class d extends(0,l.W$)(HTMLElement){static{(0,l.YV)([o.bs,o.lV,o.yK,i.e])}static get _observedAttributes(){return["enable-swipe","toggle-text","tooltip-text","custom-icon","hide-toggle-button","icon-position","custom-size"]}static get _observedClassAttributes(){return["left","right","absolute"]}constructor(e=""){super(`
    ...
    ${e?"vl-spotlight--s":""} ${s?"vl-spotlight--l":""}`}__processHeader(){return this.imgSrc?(0,l.dy)` <header role="none" class="vl-spotlight__header">
        ...
        </header>`:(0,l.dy)``}}c=function(e,t,s,l){var i,o=arguments.length,r=o<3?t:null===l?l=Object.getOwnPropertyDescriptor(t,s):l;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,s,l);else for(var n=e.length-1;n>=0;n--)(i=e[n])&&(r=(o<3?i(r):o>3?i(t,s,r):i(t,s))||r);return o>3&&r&&Object.defineProperty(t,s,r),r}([(0,i.Mo)("vl-spotlight")],c)},"./libs/components/src/spotlight/vl-spotlight.model.ts":(e,t,s)=>{"use strict";s.d(t,{N:()=>l});let l={XS:"xs",S:"s",L:"l"}},"./libs/components/src/steps/vl-duration-step.component.ts":(e,t,s)=>{"use strict";s.d(t,{Y:()=>i});var l=s("./libs/common/utilities/src/index.ts");class i extends(0,l.W$)(HTMLElement){constructor(){super(`
