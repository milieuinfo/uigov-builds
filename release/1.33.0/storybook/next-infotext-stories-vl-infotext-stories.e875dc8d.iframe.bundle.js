(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[9491],{"./node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs":(e,t,r)=>{"use strict";r.d(t,{r:()=>v});var o=r("./node_modules/react/index.js"),n=r("./node_modules/react-dom/client.js"),s=new Map,l=({callback:e,children:t})=>{let r=(0,o.useRef)();return(0,o.useLayoutEffect)(()=>{r.current!==e&&(r.current=e,e())},[e]),t},i=async(e,t)=>{let r=await d(t);return new Promise(t=>{r.render(o.createElement(l,{callback:()=>t(null)},e))})},a=(e,t)=>{let r=s.get(e);r&&(r.unmount(),s.delete(e))},d=async e=>{let t=s.get(e);return t||(t=n.createRoot(e),s.set(e,t)),t},c=r("./node_modules/@storybook/blocks/dist/index.mjs"),u={code:c.bD,a:c.Ct,...c.lO},m=class extends o.Component{constructor(){super(...arguments),this.state={hasError:!1}}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(e){let{showException:t}=this.props;t(e)}render(){let{hasError:e}=this.state,{children:t}=this.props;return e?null:o.createElement(o.Fragment,null,t)}},v=class{constructor(){this.render=async(e,t,n)=>{let s={...u,...t?.components},l=c.WI;return new Promise((a,d)=>{r.e(9506).then(r.bind(r,"./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/index.js")).then(({MDXProvider:r})=>i(o.createElement(m,{showException:d,key:Math.random()},o.createElement(r,{components:s},o.createElement(l,{context:e,docsParameter:t}))),n)).then(()=>a())})},this.unmount=e=>{a(e)}}}},"./node_modules/@storybook/addon-docs/dist/index.mjs":(e,t,r)=>{"use strict";r.d(t,{$4:()=>o.$4,Ed:()=>o.Ed,Hw:()=>o.Hw,Uh:()=>o.Uh,Xz:()=>o.Xz,Z$:()=>o.Z$,h_:()=>o.h_}),r("./node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs");var o=r("./node_modules/@storybook/blocks/dist/index.mjs")},"./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js":(e,t,r)=>{"use strict";r.d(t,{NF:()=>s,Zo:()=>a,ah:()=>l,pC:()=>n});var o=r("./node_modules/react/index.js");let n=o.createContext({});function s(e){return function(t){let r=l(t.components);return o.createElement(e,{...t,allComponents:r})}}function l(e){let t=o.useContext(n);return o.useMemo(()=>"function"==typeof e?e(t):{...t,...e},[t,e])}let i={};function a({components:e,children:t,disableParentContext:r}){let s;return s=r?"function"==typeof e?e({}):e||i:l(e),o.createElement(n.Provider,{value:s},t)}},"./libs/components/src/next/infotext/stories/vl-infotext.stories.ts":(e,t,r)=>{"use strict";r.r(t),r.d(t,{InfotextBadge:()=>_,InfotextDefault:()=>j,InfotextLink:()=>S,__namedExportsOrder:()=>w,default:()=>y});var o=r("./libs/common/storybook/src/index.ts"),n=r("./node_modules/lit-html/lit-html.js"),s=r("./node_modules/lit/index.js"),l=r("./libs/common/utilities/src/css/mixin/media-queries.mixin.css.ts");let i=(0,s.iv)`
    .vl-infotext {
        display: flex;
...
`;var a=r("./libs/common/utilities/src/index.ts"),d=r("./node_modules/lit/directives/class-map.js"),c=r("./libs/common/utilities/src/css/global-styles-decorator.ts");let u={badge:!1,href:"",external:!1};class m extends a.fS{static get styles(){return[i]}static get properties(){return{badge:{type:Boolean},href:{type:String},external:{type:Boolean},value:{type:String,state:!0}}}connectedCallback(){super.connectedCallback(),this.adjustValue(),this.valueObserver=new MutationObserver(()=>this.adjustValue()),this.getValueSlot()&&this.valueObserver.observe(this.getValueSlot(),{subtree:!0,childList:!0}),window.addEventListener("resize",this.throttledAdjustValue),this.shadowRoot.adoptedStyleSheets=[...this.shadowRoot.adoptedStyleSheets,this.customStyleSheet]}disconnectedCallback(){super.disconnectedCallback(),this.valueObserver?.disconnect(),window.removeEventListener("resize",this.throttledAdjustValue)}render(){let e={"vl-infotext":!0,"vl-infotext--badge":this.badge};if(this.href){let t=this.external?"_blank":s.Ld;return(0,s.dy)`<a class=${(0,d.$)(e)} href=${this.href} target=${t}>${this.renderContent()}</a>`}return(0,s.dy)`<div class=${(0,d.$)(e)}>${this.renderContent()}</div>`}renderContent(){return(0,s.dy)`
 ...
 */var o={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},n=e=>function(){for(var t=arguments.length,r=Array(t),o=0;o<t;o++)r[o]=arguments[o];return{_$litDirective$:e,values:r}};class s{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}},"./node_modules/lit/directives/class-map.js":(e,t,r)=>{"use strict";r.d(t,{$:()=>s});var o=r("./node_modules/lit-html/lit-html.js"),n=r("./node_modules/lit-html/directive.js"),s=(0,n.XM)(class extends n.Xe{constructor(e){var t;if(super(e),e.type!==n.pX.ATTRIBUTE||"class"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,t){var[r]=t;if(void 0===this.it){for(var n in this.it=new Set,void 0!==e.strings&&(this.st=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e))),r)r[n]&&!(null!==(a=this.st)&&void 0!==a&&a.has(n))&&this.it.add(n);return this.render(r)}var s=e.element.classList;for(var l of this.it)l in r||(s.remove(l),this.it.delete(l));for(var i in r){var a,d,c=!!r[i];c===this.it.has(i)||(null===(d=this.st)||void 0===d?void 0:d.has(i))||(c?(s.add(i),this.it.add(i)):(s.remove(i),this.it.delete(i)))}return o.Jb}})},"./node_modules/lit/directives/unsafe-html.js":(e,t,r)=>{"use strict";r.d(t,{A:()=>l});var o=r("./node_modules/lit-html/lit-html.js"),n=r("./node_modules/lit-html/directive.js");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */var o=r("./node_modules/react/index.js"),n=Symbol.for("react.element"),s=Symbol.for("react.fragment"),l=Object.prototype.hasOwnProperty,i=o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,a={key:!0,ref:!0,__self:!0,__source:!0};function d(e,t,r){var o,s={},d=null,c=null;for(o in void 0!==r&&(d=""+r),void 0!==t.key&&(d=""+t.key),void 0!==t.ref&&(c=t.ref),t)l.call(t,o)&&!a.hasOwnProperty(o)&&(s[o]=t[o]);if(e&&e.defaultProps)for(o in t=e.defaultProps)void 0===s[o]&&(s[o]=t[o]);return{$$typeof:n,type:e,key:d,ref:c,props:s,_owner:i.current}}t.Fragment=s,t.jsx=d,t.jsxs=d},"./node_modules/react/jsx-runtime.js":(e,t,r)=>{"use strict";e.exports=r("./node_modules/react/cjs/react-jsx-runtime.production.min.js")},"./libs/common/utilities/src/css/global-styles-decorator.ts":(e,t,r)=>{"use strict";r.d(t,{Q:()=>p});var o=r("./node_modules/lit/index.js");let n=(0,o.iv)`
    :root {
        --vl-white: #ffffff;
...
`,a="Flanders Art Sans",d="Flanders Art Serif",c="FlandersArtSans",u="FlandersArtSerif",m="https://cdn.omgeving.vlaanderen.be/domg/govflanders-font/22.0.2/flanders/",v=(0,o.iv)`
    ${i(a,`${m}sans/${c}-Light`,300,"normal")}
    ${i(a,`${m}sans/${c}-Regular`,400,"normal")}
    ${i(a,`${m}sans/${c}-Medium`,500,"normal")}
    ${i(a,`${m}sans/${c}-Bold`,700,"normal")}

    ${i(a,`${m}italic/${c}-Light`,300,"italic")}
    ${i(a,`${m}italic/${c}-Regular`,400,"italic")}
    ${i(a,`${m}italic/${c}-Medium`,500,"italic")}
    ${i(a,`${m}italic/${c}-Bold`,700,"italic")}

    ${i(d,`${m}serif/${u}-Light`,300,"normal")}
    ${i(d,`${m}serif/${u}-Regular`,400,"normal")}
    ${i(d,`${m}serif/${u}-Medium`,500,"normal")}
    ${i(d,`${m}serif/${u}-Bold`,700,"normal")}
`,h=(0,o.iv)`
    :root {
        --vl-font: ${(0,o.$m)(a)}, sans-serif;
...
`;var f=r("./libs/common/utilities/src/css/mixin/media-queries.mixin.css.ts");let x=[n,s,l,h,v,(0,o.iv)`
    html {
