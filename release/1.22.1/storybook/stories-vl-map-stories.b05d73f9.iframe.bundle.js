"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[9539],{"./libs/map/src/stories/vl-map.stories.ts":(e,t,a)=>{a.r(t),a.d(t,{MapDefault:()=>_,MapFullHeight:()=>k,MapPlayground:()=>j,__namedExportsOrder:()=>I,default:()=>w});var l=a("./libs/common/storybook/src/index.ts");a("./libs/components/src/index.ts"),a("./libs/elements/src/index.ts");var n=a("./node_modules/lit/index.js");a("./libs/map/src/components/action/draw-action/draw-line-action/vl-map-draw-line-action.ts"),a("./libs/map/src/components/action/draw-action/draw-point-action/vl-map-draw-point-action.ts"),a("./libs/map/src/components/action/draw-action/draw-polygon-action/vl-map-draw-polygon-action.ts"),a("./libs/map/src/components/action/draw-action/measure-action/vl-map-measure-action.ts"),a("./libs/map/src/components/action/layer-action/delete-action/vl-map-delete-action.ts"),a("./libs/map/src/components/action/layer-action/modify-action/vl-map-modify-action.ts"),a("./libs/map/src/components/action/layer-action/select-action/vl-map-select-action.ts"),a("./libs/map/src/components/baselayer/vl-map-base-layer-grb-gray/vl-map-base-layer-grb-gray.ts"),a("./libs/map/src/components/baselayer/vl-map-base-layer-grb-ortho/vl-map-base-layer-grb-ortho.ts"),a("./libs/map/src/components/baselayer/vl-map-base-layer-grb/vl-map-base-layer-grb.ts"),a("./libs/map/src/components/controls/measure-control/vl-map-measure-control.ts"),a("./libs/map/src/components/controls/vl-map-action-controls.ts"),a("./libs/map/src/components/layer-style/vl-map-layer-circle-style/vl-map-layer-circle-style.ts"),a("./libs/map/src/components/layer-style/vl-map-layer-style.ts"),a("./libs/map/src/components/layer-switcher/vl-map-layer-switcher.ts"),a("./libs/map/src/components/layer/vector-layer/vl-map-features-layer/vl-map-features-layer.ts");var o=a("./libs/map/src/components/legend/vl-map-legend.ts");a("./libs/map/src/components/overview-map/vl-map-overview-map.ts"),a("./libs/map/src/components/side-sheet/vl-map-side-sheet.ts"),a("./libs/map/src/vl-map.ts");var i=a("./node_modules/@storybook/addon-actions/dist/index.mjs"),r=a("./libs/map/src/vl-map.model.ts");let s={...l._O,allowFullscreen:!1,disableEscape:!1,disableRotation:!1,disableMousewheelZoom:!1,disableKeyboard:!1,fullHeight:!1,noBorder:!1,activeActionChange:(0,i.aD)(r.Ks.ACTIVE_ACTION_CHANGED),layerVisibleChange:(0,i.aD)(r.Ks.LAYER_VISIBLE_CHANGED)},c={...(0,l.Wp)(),allowFullscreen:{name:"data-vl-allow-fullscreen",description:"Laat de map toe afgebeeld te worden in fullscreen.<br>Dit kan niet gebruikt worden op mobile.<br>Dit attribuut is niet reactief.",table:{type:{summary:l.vK.BOOLEAN},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.allowFullscreen}}},disableEscape:{name:"data-vl-disable-escape-key",description:"Schakelt de escape-key uit.<br>Dit attribuut is niet reactief.",table:{type:{summary:l.vK.BOOLEAN},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.disableEscape}}},disableRotation:{name:"data-vl-disable-rotation",description:"Schakelt het roteren van de map uit.<br>Dit attribuut is niet reactief.",table:{type:{summary:l.vK.BOOLEAN},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.disableRotation}}},disableMousewheelZoom:{name:"data-vl-disable-mouse-wheel-zoom",description:"Schakelt het zoomen van de map via het muiswiel uit.<br>Dit attribuut is niet reactief.",table:{type:{summary:l.vK.BOOLEAN},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.disableMousewheelZoom}}},disableKeyboard:{name:"data-vl-disable-keyboard",description:"Schakelt de keyboard input uit voor de map.<br>Dit attribuut is niet reactief.",table:{type:{summary:l.vK.BOOLEAN},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.disableKeyboard}}},fullHeight:{name:"data-vl-full-height",description:"De map neemt de volledige beschikbare hoogte in van zijn parent.<br>Zie de docs pagina voor meer informatie over het gebruik van dit attribuut.",table:{type:{summary:l.vK.BOOLEAN},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.fullHeight}}},noBorder:{name:"data-vl-no-border",description:"De border rond de map wordt niet afgebeeld.",table:{type:{summary:l.vK.BOOLEAN},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.noBorder}}},activeActionChange:{name:r.Ks.ACTIVE_ACTION_CHANGED,description:"Afgevuurd als de actieve map-actie verandert.",table:{type:{summary:"{ previous?: VlMapAction, current?: VlMapAction }"},category:l.aA.EVENTS}},layerVisibleChange:{name:r.Ks.LAYER_VISIBLE_CHANGED,description:"Afgevuurd als de visible state van een map-layer verandert.",table:{type:{summary:"{ layer: VlMapLayer, visible: boolean }"},category:l.aA.EVENTS}}};a("./node_modules/react/index.js");var d=a("./node_modules/react/jsx-runtime.js"),p=a("./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),m=a("./node_modules/@storybook/blocks/dist/index.mjs");function g(e){let t=Object.assign({h1:"h1",p:"p",code:"code",h2:"h2",pre:"pre",h3:"h3",ul:"ul",li:"li",strong:"strong",a:"a"},(0,p.ah)(),e.components);return(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(t.h1,{id:"map",children:"Map"}),"\n",(0,d.jsxs)(t.p,{children:["Gebruik de ",(0,d.jsx)(t.code,{children:"map"})," component om een kaart af te beelden met verschillende lagen en acties."]}),"\n",(0,d.jsx)(t.h2,{id:"voorbeeld",children:"Voorbeeld"}),"\n",(0,d.jsx)(t.pre,{children:(0,d.jsx)(t.code,{className:"language-js",children:"import { VlMap } from '@domg-wc/map';\n"})}),"\n",(0,d.jsx)(t.pre,{children:(0,d.jsx)(t.code,{className:"language-html",children:"<vl-map></vl-map>\n"})}),"\n",(0,d.jsx)(m.Xz,{of:_}),"\n",(0,d.jsx)(t.h2,{id:"configuratie",children:"Configuratie"}),"\n",(0,d.jsx)(m.Ed,{of:_}),"\n",(0,d.jsx)(t.h2,{id:"varianten",children:"Varianten"}),"\n",(0,d.jsx)(t.h3,{id:"volledige-hoogte",children:"Volledige hoogte"}),"\n",(0,d.jsx)(t.p,{children:"De map de volledige beschikbare hoogte in laten nemen kan op de volgende manier:"}),"\n",(0,d.jsxs)(t.ul,{children:["\n",(0,d.jsxs)(t.li,{children:["plaats op de parent een ",(0,d.jsx)(t.code,{children:"height"})," of een ",(0,d.jsx)(t.code,{children:"min-height"})]}),"\n",(0,d.jsxs)(t.li,{children:["plaats op de parent ",(0,d.jsx)(t.code,{children:"display: flex"})," en ",(0,d.jsx)(t.code,{children:"flex-direction: column"})]}),"\n",(0,d.jsxs)(t.li,{children:["plaats op de vl-map het attribuut ",(0,d.jsx)(t.code,{children:"data-vl-full-height"})]}),"\n",(0,d.jsxs)(t.li,{children:["zorg dat de parent ",(0,d.jsx)(t.strong,{children:"geen elementen"})," heeft met ",(0,d.jsx)(t.code,{children:"position: fixed"})," die deel uit moeten maken van de hoogte"]}),"\n"]}),"\n",(0,d.jsx)(m.Xz,{of:k}),"\n",(0,d.jsx)(t.h3,{id:"playground",children:"Playground"}),"\n",(0,d.jsx)(t.p,{children:"Zie de code onder de story voor het volledige voorbeeld."}),"\n",(0,d.jsx)(m.Xz,{of:j}),"\n",(0,d.jsxs)("details",{children:[(0,d.jsx)("summary",{children:"TypeScript code"}),(0,d.jsx)(m.Hw,{code:"export const getActionElement = (name)=>getLastElementByClassName(`${name}-action`);\nexport const getToggleButton = (name)=>getLastElementByClassName(`${name}-toggle-button`);\nexport const actionIdentifiers = [\n    'draw-point',\n    'draw-line',\n    'draw-polygon',\n    'modify',\n    'delete'\n];\n// Make sure the class that is given is unique and is not being used in other stories of the component.\nexport const getLastElementByClassName = (className)=>{\n    const items = document.getElementsByClassName(className);\n    return items[items.length - 1];\n};\nexport const handleActiveActionChange = ({ detail: { previous, current } })=>{\n    // Activate/deactivate external controls when an action changes its state\n    actionIdentifiers.forEach((actionIdentifier)=>{\n        if (previous === getActionElement(actionIdentifier)) {\n            getToggleButton(actionIdentifier).active = false;\n        } else if (current === getActionElement(actionIdentifier)) {\n            getToggleButton(actionIdentifier).active = true;\n        }\n    });\n};\nexport const handleLayerVisibleChange = ({ detail: { layer, visible } })=>{\n    // Enable/disable external controls when an action changes its state\n    const layerActions = layer.getElementsByClassName('action');\n    for (const layerAction of layerActions){\n        actionIdentifiers.forEach((actionIdentifier)=>{\n            if (layerAction === getActionElement(actionIdentifier)) {\n                getToggleButton(actionIdentifier).disabled = !visible;\n            }\n        });\n    }\n};\nexport const handleOpacitySliderChange = ({ detail: { value } })=>{\n    // Set the opacity of all feature layers based on the value of the input slider\n    const featureLayers = document.querySelectorAll('vl-map-features-layer');\n    featureLayers?.forEach((layer)=>{\n        layer.setAttribute('data-vl-opacity', value / 100);\n    });\n};\n",language:"ts",dark:!0})]}),"\n",(0,d.jsx)(t.h2,{id:"referenties",children:"Referenties"}),"\n",(0,d.jsx)(t.h3,{id:"digitaal-vlaanderen",children:"Digitaal Vlaanderen"}),"\n",(0,d.jsxs)(t.p,{children:["De ",(0,d.jsx)(t.code,{children:"map"})," component is een component van Departement Omgeving en heeft geen Digitaal Vlaanderen documentatie."]}),"\n",(0,d.jsx)(t.h3,{id:"legacy-documentatie",children:"Legacy Documentatie"}),"\n",(0,d.jsx)(t.p,{children:(0,d.jsx)(t.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/storybook/?path=/docs/custom-elements-vl-map--default",target:"_blank",rel:"nofollow noopener noreferrer",children:"Legacy Storybook - Map"})}),"\n",(0,d.jsx)(t.p,{children:(0,d.jsx)(t.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/doc/VlMap.html",target:"_blank",rel:"nofollow noopener noreferrer",children:"Legacy Documentatie - Map"})}),"\n",(0,d.jsx)(t.p,{children:(0,d.jsx)(t.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-map.html",target:"_blank",rel:"nofollow noopener noreferrer",children:"Legacy Demo - Map"})})]})}let u=e=>b(`${e}-action`),h=e=>b(`${e}-toggle-button`),v=["draw-point","draw-line","draw-polygon","modify","delete"],b=e=>{let t=document.getElementsByClassName(e);return t[t.length-1]},y=({detail:{previous:e,current:t}})=>{v.forEach(a=>{e===u(a)?h(a).active=!1:t===u(a)&&(h(a).active=!0)})},f=({detail:{layer:e,visible:t}})=>{for(let a of e.getElementsByClassName("action"))v.forEach(e=>{a===u(e)&&(h(e).disabled=!t)})},x=({detail:{value:e}})=>{let t=document.querySelectorAll("vl-map-features-layer");t?.forEach(t=>{t.setAttribute("data-vl-opacity",e/100)})},w={title:"map/map",tags:["autodocs"],args:s,argTypes:c,parameters:{docs:{page:function(e={}){let{wrapper:t}=Object.assign({},(0,p.ah)(),e.components);return t?(0,d.jsx)(t,Object.assign({},e,{children:(0,d.jsx)(g,e)})):g(e)}}}},_=(0,l.yg)(s,({allowFullscreen:e,disableEscape:t,disableRotation:a,disableMousewheelZoom:l,disableKeyboard:o,noBorder:i,fullHeight:r})=>(0,n.dy)`
        <vl-map
    ...
    `);_.storyName="vl-map - default";let k=(0,l.yg)(s,({allowFullscreen:e,disableEscape:t,disableRotation:a,disableMousewheelZoom:l,disableKeyboard:o,noBorder:i,fullHeight:r})=>(0,n.dy)`
    ...
    `);k.storyName="vl-map - full height",k.args={noBorder:!0,fullHeight:!0};let A="rgba(102, 51, 153, 0.6)",E="display: flex; gap: 1rem; align-items: center; margin-bottom: 1rem;",$={},j=(0,l.yg)(s,({allowFullscreen:e,disableEscape:t,disableRotation:a,disableMousewheelZoom:l,disableKeyboard:i,noBorder:r,fullHeight:s,activeActionChange:c,layerVisibleChange:d})=>(0,n.dy)`
        <vl-map
            ?data-vl-allow-fullscreen=${e}
            ?data-vl-disable-escape-key=${t}
            ?data-vl-disable-rotation=${a}
            ?data-vl-disable-mouse-wheel-zoom=${l}
            ?data-vl-disable-keyboard=${i}
            ?data-vl-no-border=${r}
            ?data-vl-full-height=${s}
            @vl-active-action-changed=${e=>{c({previous:e.detail.previous}),c({current:e.detail.current}),y(e)}}
            @vl-layer-visible-changed=${e=>{d(e.detail),f(e)}}
        >
            ...
            <vl-map-side-sheet>
                ...
                <vl-input-slider data-vl-value=${100} @vl-change-value=${x}></vl-input-slider>
                ...
                <div>
                    <button
                        is="vl-button"
                        @click=${()=>{u("measure").active=!0}}
                    >
                        Start
                    </button>
                    <button
                        is="vl-button"
                        @click=${()=>{u("measure").active=!1}}
                    >
                        Stop
                    </button>
                </div>
                ...
                <div style=${"width: 100%;"}>
                    ...
                    <div style="margin-bottom: 2rem;">
                        <vl-toggle-button
                            ...
                            @click=${()=>{u("modify").active=!h("modify").active}}
                        >
                            Modify
                        </vl-toggle-button>
                        <vl-toggle-button
                            class="delete-toggle-button"
                            @click=${()=>{u("delete").active=!h("delete").active}}
                        >
                            Delete
                        </vl-toggle-button>
                    </div>
                    ...
                    <div style=${E}>
                        <vl-toggle-button
                            ...
                            data-vl-icon="pencil"
                            data-vl-text-hidden
                            @click=${()=>{u("draw-point").active=!h("draw-point").active}}
                        >
                    ...
                    <div style=${E}>
                        <vl-toggle-button
                            ...
                            data-vl-icon="pencil"
                            data-vl-text-hidden
                            @click=${()=>{u("draw-line").active=!h("draw-line").active}}
                        >
                    ...
                    <div style=${E}>
                        <vl-toggle-button
                            ...
                            data-vl-icon="pencil"
                            data-vl-text-hidden
                            @click=${()=>{u("draw-polygon").active=!h("draw-polygon").active}}
                        >
