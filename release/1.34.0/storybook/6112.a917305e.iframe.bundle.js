...
`,c=[...o.CX,l];var d=a("./libs/components/src/proza-message/vl-proza-rest-client.util.ts");class p extends(0,s.W$)(HTMLElement){static{(0,s.YV)([o.d7,o.Gi,o.yK,r.P])}static get _observedAttributes(){return["domain","code","block","parameters"]}constructor(){super(),this.shadow(`
          <style>
            ${c}
          </style>
          <div>
...
`,l=[o.$4,i];class c extends(0,s.W$)(HTMLElement){static get _observedAttributes(){return["parameters"]}constructor(){super(`
          <style>
            ${o.YN}
            ${o.Oh}
            ${o.QT}
