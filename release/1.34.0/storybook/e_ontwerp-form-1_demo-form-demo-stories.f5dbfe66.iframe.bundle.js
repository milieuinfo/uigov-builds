...
`;var m=l("./node_modules/@domg/govflanders-style/component/index.js");let v={...i.E,options:[],block:!1,placeholder:"",autocomplete:"",notDeletable:!1};class u extends i.N{static get styles(){return[s.YN,s.Oh,c,m.oQ,d]}static get properties(){return{options:{type:Array},block:{type:Boolean},readonly:{type:Boolean},placeholder:{type:String},autocomplete:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},value:{type:String,state:!0}}}connectedCallback(){super.connectedCallback();let e=this.getSelectedOption();this.value=e?.value??null,this.initialOptions=JSON.parse(JSON.stringify(this.options))}updated(e){if(super.updated(e),e.has("options")){let e=this.getSelectedOption();this.value=e?.value??null}if(e.has("value")){let e={value:this.value};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-select",{composed:!0,bubbles:!0,detail:e})),this.dispatchEventIfValid(e)}}render(){let e={"vl-select__container":!0,"vl-select__container--block":this.block},t={"vl-select":!0,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success,"vl-select--block":this.block},l=null!==this.value,s=this.options.some(e=>e.group);return(0,r.dy)`
            <div class=${(0,n.$)(e)}>
                ...
                ${l&&!this.notDeletable?this.renderClearButton():r.Ld}
        ...
        `}renderPlaceholder(e){return(0,r.dy)`<option class="vl-select__placeholder" value="" ?selected=${!e} disabled>
            ...
            <textarea
                ...
                @input=${this.onInput}
            />
        `}get validationTarget(){return this.shadowRoot?.querySelector("textarea")}resetFormControl(){super.resetFormControl(),this.value=this.initialValue}onInput(e){this.value=e?.target?.value}constructor(...e){super(...e),this.block=m.block,this.readonly=m.readonly,this.value=m.value,this.placeholder=m.placeholder,this.autocomplete=m.autocomplete,this.minLength=m.minLength,this.maxLength=m.maxLength,this.rows=m.rows,this.cols=m.cols,this.initialValue=""}}v=function(e,t,l,r){var o,n=arguments.length,s=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,l):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,r);else for(var i=e.length-1;i>=0;i--)(o=e[i])&&(s=(n<3?o(s):n>3?o(t,l,s):o(t,l))||s);return n>3&&s&&Object.defineProperty(t,l,s),s}([(0,c.a6)("vl-textarea-next")],v)},"./libs/form/src/utils/index.ts":(e,t,l)=>{l.d(t,{u:()=>o});var r=l("./libs/form/src/next/form-control/form-control.ts");let o=(e,t)=>{if(!e)return;let l=new FormData(e),o=e=>e instanceof r.N||e instanceof HTMLInputElement||e instanceof HTMLSelectElement||e instanceof HTMLTextAreaElement,n=Array.from(l.keys()).filter(e=>l.getAll(e).length>1),s=Array.from(e.querySelectorAll("*")).filter(e=>o(e)&&e.hasAttribute("multiple")).map(e=>e.getAttribute("name")),i=t||Array.from(new Set([...n,...s]));return Array.from(l.keys()).reduce((e,t)=>({...e,[t]:i.includes(t)?l.getAll(t):l.get(t)}),{})}}}]);