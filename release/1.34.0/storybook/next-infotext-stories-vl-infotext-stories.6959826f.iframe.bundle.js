...
`;var i=r("./libs/common/utilities/src/index.ts"),d=r("./node_modules/lit/directives/class-map.js"),c=r("./libs/common/utilities/src/css/global-styles-decorator.ts");let u={badge:!1,href:"",external:!1};class m extends i.fS{static get styles(){return[a]}static get properties(){return{badge:{type:Boolean},href:{type:String},external:{type:Boolean},value:{type:String,state:!0}}}connectedCallback(){super.connectedCallback(),this.adjustValue(),this.valueObserver=new MutationObserver(()=>this.adjustValue()),this.getValueSlot()&&this.valueObserver.observe(this.getValueSlot(),{subtree:!0,childList:!0}),window.addEventListener("resize",this.throttledAdjustValue),this.shadowRoot.adoptedStyleSheets=[...this.shadowRoot.adoptedStyleSheets,this.customStyleSheet]}disconnectedCallback(){super.disconnectedCallback(),this.valueObserver?.disconnect(),window.removeEventListener("resize",this.throttledAdjustValue)}render(){let e={"vl-infotext":!0,"vl-infotext--badge":this.badge};if(this.href){let t=this.external?"_blank":s.Ld;return(0,s.dy)`<a class=${(0,d.$)(e)} href=${this.href} target=${t}>${this.renderContent()}</a>`}return(0,s.dy)`<div class=${(0,d.$)(e)}>${this.renderContent()}</div>`}renderContent(){return(0,s.dy)`
