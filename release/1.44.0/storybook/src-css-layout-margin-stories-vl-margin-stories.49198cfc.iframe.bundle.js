...
`;x.storyName="vl-margin - default",x.parameters=r.Dw;let p=({})=>(0,t.qy)`
    <style>
        ${v}
    </style>
    <div class="sb-container">
...
`;p.storyName="vl-margin - small",p.parameters=r.Dw;let b=({})=>(0,t.qy)`
    <style>
        ${v}
    </style>
    <div class="sb-container">
...
`;b.storyName="vl-margin - medium",b.parameters=r.Dw;let u=({})=>(0,t.qy)`
    <style>
        ${v}
    </style>
    <div class="sb-container">
...
`;u.storyName="vl-margin - no",u.parameters=r.Dw;let h=({})=>(0,t.qy)`
    <style>
        ${v}
    </style>
    <div class="sb-container">
...
`;h.storyName="vl-margin - no bottom",h.parameters=r.Dw;let j=({})=>(0,t.qy)`
    <style>
        ${v}
    </style>
    <div class="sb-container">
...
`;j.storyName="vl-margin - no top",j.parameters=r.Dw,x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:'({}) => html`\n    <style>\n        ${marginCss}\n    </style>\n    <div class="sb-container">\n        <div class="sb-content">default</div>\n    </div>\n`',...x.parameters?.docs?.source}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:'({}) => html`\n    <style>\n        ${marginCss}\n    </style>\n    <div class="sb-container">\n        <div class="sb-content vl-margin-next--small">vl-margin-next--small</div>\n    </div>\n`',...p.parameters?.docs?.source}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:'({}) => html`\n    <style>\n        ${marginCss}\n    </style>\n    <div class="sb-container">\n        <div class="sb-content vl-margin-next--medium">vl-margin-next--medium</div>\n    </div>\n`',...b.parameters?.docs?.source}}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:'({}) => html`\n    <style>\n        ${marginCss}\n    </style>\n    <div class="sb-container">\n        <div class="sb-content vl-margin-next--no">vl-margin-next--no</div>\n    </div>\n`',...u.parameters?.docs?.source}}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:'({}) => html`\n    <style>\n        ${marginCss}\n    </style>\n    <div class="sb-container">\n        <div class="sb-content vl-margin-next--no-bottom">vl-margin-next--no-bottom</div>\n    </div>\n`',...h.parameters?.docs?.source}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:'({}) => html`\n    <style>\n        ${marginCss}\n    </style>\n    <div class="sb-container">\n        <div class="sb-content vl-margin-next--no-top">vl-margin-next--no-top</div>\n    </div>\n`',...j.parameters?.docs?.source}}};let y=["MarginDefault","MarginSmall","MarginMedium","MarginNo","MarginNoBottom","MarginNoTop"]}}]);