...
`;class c extends(0,i.W$)(HTMLElement){static{(0,i.YV)([s.d7,s.Gi,s.my])}static get _observedAttributes(){return["label","submit-label"]}static get _observedChildClassAttributes(){return["inline","block","alt"]}constructor(){super(`
      <style>
        ${n.YN}
        ${a.jn}
        ${a.K$}
