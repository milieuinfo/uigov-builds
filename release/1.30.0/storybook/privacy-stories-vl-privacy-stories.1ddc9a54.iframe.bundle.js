(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[6417],{"./libs/sections/src/privacy/stories/vl-privacy.stories.ts":(e,n,i)=>{"use strict";i.r(n),i.d(n,{PrivacyDefault:()=>V,PrivacyHeaderSlot:()=>x,__namedExportsOrder:()=>A,default:()=>D});var a=i("./node_modules/lit-html/lit-html.js"),r=i("./node_modules/lit/directives/unsafe-html.js"),t=i("./libs/common/utilities/src/index.ts"),o=i("./libs/components/src/index.ts"),d=i("./libs/elements/src/index.ts"),v=i("./node_modules/lit/index.js"),s=i("./node_modules/lit/decorators.js");let l=()=>[o.D3],g=({disableBackLink:e})=>(0,v.dy)`
    ...
    ></vl-functional-header>
`,p={date:"data-vl-date",disableBackLink:"data-vl-disable-back-link",version:"data-vl-version"},{date:m,disableBackLink:c,version:h}=p;class k extends t.fS{static{(0,t.YV)([d.CH,d.YY,d.Oj,d.Br,d.$z,d.jc,d.Gi,d.Fn,d.bs,d.gG,d.lo,d.aL,d.HD,d.M3,d.lV,d.Tj,d.oS,d.rL,d.r2,d.EK,d.xJ,d.lb,o.d4,o.Jy,o.Ui,o.Pz,...l()])}static get properties(){return{[m]:{type:String},[c]:{type:Boolean},[h]:{type:String}}}constructor(){super(),this.allowCustomCSS=!1,this[m]="3 maart 2021",this[c]=!1,this[h]="1.0.0"}render(){return(0,v.dy)`
            <style>
                ${d.CX}
            </style>
                    ...
                    <div is="vl-grid" data-vl-is-stacked>
                        ...
                        <div is="vl-column" data-vl-size="10">
                            <p is="vl-introduction">
                                ...
                                <span id="introduction-date">${this[m]}</span>
                            </p>
                        </div>
