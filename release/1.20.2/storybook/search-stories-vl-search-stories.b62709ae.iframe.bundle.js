"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[3543],{"./libs/components/src/search/vl-search.component.ts":(e,t,l)=>{l.d(t,{g:()=>c});var i=l("./libs/common/utilities/src/index.ts"),s=l("./libs/elements/src/index.ts"),n=l("./node_modules/@domg/govflanders-style/common/index.js"),a=l("./node_modules/@domg/govflanders-style/component/index.js"),r=l("./node_modules/lit/index.js");let o=(0,r.iv)`
    :root {
...
`,c=class extends(0,i.W$)(HTMLElement){static{(0,i.YV)([s.d7,s.Gi,s.my])}static get _observedAttributes(){return["label","submit-label"]}static get _observedChildClassAttributes(){return["inline","block","alt"]}constructor(){super(`
      <style>
        ${n.YN}
        ${a.jn}
        ${a.K$}
    ...
    `)}__getButtonTemplate(){let e=this._isInline?this.__iconTemplate():"";return this._template(`
        ...
        `)}__processInputSlot(){let e=this.querySelector('[slot="input"]');e?(customElements.whenDefined("vl-select").then(async()=>{e instanceof s.Kj&&(this.setAttribute("data-vl-has-input-slot",""),await e.ready(),this.__observeInputSlot(t=>{let l=e=>e.target.classList.contains("is-open"),i=e=>e.target.classList.contains("is-focused");t.find(e=>l(e)||i(e))||e.value?this.__inputSlotElement.classList.add("is-open"):this.__inputSlotElement.classList.remove("is-open")}),this.append(e._wrapperElement))}),this.__inputElement&&this.__inputElement.remove()):this.__inputSlotElement.remove()}__observeInputSlot(e){this._observer=new MutationObserver(e),this._observer.observe(this.__inputSlot,{attributes:!0,attributeFilter:["class"]})}};c=function(e,t,l,i){var s,n=arguments.length,a=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,l):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,l,i);else for(var r=e.length-1;r>=0;r--)(s=e[r])&&(a=(n<3?s(a):n>3?s(t,l,a):s(t,l))||a);return n>3&&a&&Object.defineProperty(t,l,a),a}([(0,i.a6)("vl-search")],c)},"./libs/components/src/search/stories/vl-search.stories.ts":(e,t,l)=>{l.r(t),l.d(t,{default:()=>n,searchDefault:()=>a});var i=l("./node_modules/lit-html/lit-html.js");l("./libs/components/src/search/vl-search.component.ts");var s=l("./libs/common/storybook/src/index.ts");let n={title:"Components/search",tags:["autodocs"],args:(0,s.T8)({}),argTypes:(0,s.xj)({})},a=(0,s.yg)({},()=>(0,i.dy)` <vl-search id="search-inline" data-vl-inline="" data-cy="search"></vl-search> `);a.storyName="vl-search - default",a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:'story({}, () => html` <vl-search id="search-inline" data-vl-inline="" data-cy="search"></vl-search> `)',...a.parameters?.docs?.source}}}}}]);