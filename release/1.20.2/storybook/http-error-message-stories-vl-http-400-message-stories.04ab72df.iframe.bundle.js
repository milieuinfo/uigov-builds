"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[2748],{"./libs/components/src/http-error-message/vl-http-400-message.component.ts":(e,t,s)=>{var l=s("./libs/common/utilities/src/index.ts"),r=s("./libs/elements/src/index.ts"),a=s("./node_modules/@domg/govflanders-style/common/index.js"),i=s("./node_modules/@domg/govflanders-style/component/index.js"),o=s("./node_modules/lit/index.js"),n=s("./libs/components/src/http-error-message/vl-http-error-message.component.ts");let c=class extends l.fS{static{(0,l.YV)([n.k,r.uu])}static get styles(){return[a.Oh,i.jn]}render(){return(0,o.dy)`
...
`,n=[r.$4,o],c=class extends(0,l.W$)(HTMLElement){static get _observedAttributes(){return["parameters"]}constructor(){super(`
          <style>
            ${r.YN}
            ${r.Oh}
            ${r.QT}
