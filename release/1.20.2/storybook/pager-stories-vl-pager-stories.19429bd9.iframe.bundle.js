"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[9478],{"./libs/components/src/pager/vl-pager.component.ts":(e,t,a)=>{a.d(t,{o:()=>g});var s=a("./libs/common/utilities/src/index.ts"),i=a("./node_modules/@domg/govflanders-style/component/index.js"),r=a("./node_modules/@domg/govflanders-style/common/index.js"),l=a("./node_modules/lit/index.js");let n=(0,l.iv)`
    [hidden] {
        display: none;
    }
...
`,g=class extends(0,s.W$)(HTMLElement){static get _observedAttributes(){return["total-items","items-per-page","current-page","pagination-disabled"]}static get _observedChildClassAttributes(){return["align-center","align-right"]}constructor(){super(),this.shadow(`
          <style>
            ${r.YN}
            ${i.wM}
            ${n}
    ...
    `);return t.firstElementChild.addEventListener("click",t=>{t.preventDefault(),this.setAttribute("data-vl-current-page",e)}),t}_getItemsPerPageContentTemplate(){return`${this.itemsPerPage} rijen`}_itemsPerPageChangedCallback(e,t){this._update()}_totalItemsChangedCallback(e,t){0===this.totalItems?this._hide(this._element):(this._show(this._element),this._update())}_currentPageChangedCallback(e,t){if(this._update(),e&&t!=e){let e={detail:{currentPage:Number(t),totalPage:this.totalPages,itemsPerPage:this.itemsPerPage,totalItems:this.totalItems},bubbles:!0};this.dispatchEvent(new CustomEvent("change",e))}}_paginationDisabledChangedCallback(e,t){null!==t?this.__removePageElements():this._updatePagination()}_hide(e){e.hidden=!0}_show(e){e.hidden=!1}_update(){this._updateInfoElement(),this._updatePagination(),this._updateListItems()}_updateInfoElement(){this._boundsElement.innerHTML=this._getBoundsTemplate(),this._itemsPerPageElementen.forEach(e=>{e.innerHTML=this._getItemsPerPageContentTemplate()})}_updatePagination(){if(this._isPagination&&(this.__removePageElements(),this.totalPages>1)){let e=this.__generatePagination(this.currentPage,this.totalPages),t=e.map(e=>this._getPageTemplate(e));t.forEach(e=>this._pagesListElement.insertBefore(e,this._pageForwardListItem))}}_updateListItems(){this.currentPage<=1?this._hide(this._pageBackListItem):this._show(this._pageBackListItem),this.currentPage>=this.totalPages?this._hide(this._pageForwardListItem):this._show(this._pageForwardListItem)}__generatePagination(e,t){let a=[];for(let s=Math.max(2,e-2);s<=Math.min(t-1,e+2);s++)a.push(s);return e-2>2&&a.unshift("skipped"),e+2<t-1&&a.push("skipped"),a.unshift(1),a.push(t),a}__addPageBackLinkListener(){this._pageBackLink.addEventListener("click",e=>{e.preventDefault(),this.currentPage-1<=0||this.setAttribute("data-vl-current-page",this.currentPage-1)})}__addPageForwardLinkListener(){this._pageForwardLink.addEventListener("click",e=>{e.preventDefault(),this.currentPage+1>this.totalPages||this.setAttribute("data-vl-current-page",this.currentPage+1)})}__removePageElements(){this._pageElements.forEach(e=>e.remove()),this._pageSkippedElements.forEach(e=>e.remove())}};g=function(e,t,a,s){var i,r=arguments.length,l=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,a):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,a,s);else for(var n=e.length-1;n>=0;n--)(i=e[n])&&(l=(r<3?i(l):r>3?i(t,a,l):i(t,a))||l);return r>3&&l&&Object.defineProperty(t,a,l),l}([(0,s.a6)("vl-pager")],g)},"./libs/components/src/pager/stories/vl-pager.stories.ts":(e,t,a)=>{a.r(t),a.d(t,{default:()=>n,pagerDefault:()=>o,pagerSinglePage:()=>p,pagerWithoutPageItems:()=>d});var s=a("./node_modules/lit-html/lit-html.js");a("./libs/components/src/pager/vl-pager.component.ts");var i=a("./node_modules/@storybook/addon-actions/dist/index.mjs");let r={totalItems:50,currentPage:1,itemsPerPage:7,paginationDisabled:!1,alignCenter:!1,alignRight:!1,change:(0,i.aD)("change")};var l=a("./libs/common/storybook/src/index.ts");let n={title:"Components/pager",tags:["autodocs"],args:(0,l.T8)(r),argTypes:(0,l.xj)({totalItems:{name:"data-vl-total-items",description:"This attribute determines the total number of elements.",table:{type:{summary:"number"},category:"Attributes",defaultValue:{summary:100}}},currentPage:{name:"data-vl-current-page",description:"This attribute determines the current page.",table:{type:{summary:"number"},category:"Attributes",defaultValue:{summary:1}}},itemsPerPage:{name:"data-vl-items-per-page",description:"This attribute determines the number of rows to show per page.",table:{type:{summary:"number"},category:"Attributes",defaultValue:{summary:10}}},paginationDisabled:{name:"data-vl-pagination-disabled",description:"This attribute determines if the page links should be disabled.",table:{type:{summary:"boolean"},category:"Attributes",defaultValue:{summary:"false"}}},alignCenter:{name:"data-vl-align-center",description:"This attribute is used to center the pagination.",table:{type:{summary:"boolean"},category:"Attributes",defaultValue:{summary:"false"}}},alignRight:{name:"data-vl-align-right",description:"This attribute is used to align the pagination to the right.",table:{type:{summary:"boolean"},category:"Attributes",defaultValue:{summary:"false"}}},change:{name:"change",description:"This event is triggered when a click on a pager item happens. In the detail of the event you can find the current page, total page number, items per page number and the total amount of items of the pagination.",table:{category:"Events"}}})},g=({totalItems:e,itemsPerPage:t,currentPage:a,paginationDisabled:i,alignCenter:r,alignRight:l,change:n})=>(0,s.dy)`
    <vl-pager
        ...
        data-cy="pager"
    ></vl-pager>
`,o=g.bind({});o.storyName="vl-pager - default";let p=g.bind({});p.storyName="vl-pager - single page",p.args={totalItems:10,itemsPerPage:10,currentPage:1,paginationDisabled:!1};let d=g.bind({});d.storyName="vl-pager - without page items",d.args={totalItems:100,itemsPerPage:10,currentPage:1,paginationDisabled:!0},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"pagerTemplate.bind({}) as any",...o.parameters?.docs?.source}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:"pagerTemplate.bind({}) as any",...p.parameters?.docs?.source}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"pagerTemplate.bind({}) as any",...d.parameters?.docs?.source}}}}}]);