...
></span>`;l.storyName="vl-icon - default",l.argTypes={content:{control:!1}};let r=({icon:e,size:t,light:a,rotate:o,fullRotate:l,content:r,before:i})=>(0,n.dy)`<p
    is="vl-icon-wrapper"
>
    <span
        is="vl-icon"
    ...
    ></span
    ><span>${r}</span>
</p>`;r.storyName="vl-icon - before",r.args={before:!0};let i=({icon:e,size:t,light:a,rotate:o,fullRotate:l,content:r,after:i})=>(0,n.dy)`<p
    is="vl-icon-wrapper"
>
    <span>${r}</span
    ><span
