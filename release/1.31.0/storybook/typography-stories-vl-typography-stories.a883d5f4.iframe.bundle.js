"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[6881],{"./libs/components/src/typography/stories/vl-typography.stories.ts":(e,t,i)=>{i.r(t),i.d(t,{__namedExportsOrder:()=>d,default:()=>r,typographyDefault:()=>n,typographyLists:()=>s,typographyMarkup:()=>u,typographyParameters:()=>m,typographyTable:()=>p,typographyTitles:()=>l});var a=i("./node_modules/lit-html/lit-html.js");i("./libs/components/src/typography/vl-typography.component.ts");var o=i("./libs/common/storybook/src/index.ts");let r={title:"Components/typography",tags:["autodocs"],args:{...o._O,parameters:'{"key1": "tempus" , "key2": "ipsum" }'},argTypes:{...(0,o.Wp)(),parameters:{name:"data-vl-parameters",description:"De key/value parameters die verwerkt en getoond zullen worden in het content element.",control:{disable:!0},table:{type:{summary:"string"}}}},parameters:{controls:{hideNoControlsWarning:!0}}},n=()=>(0,a.dy)` <vl-typography data-cy="typography">
    <p>
...
</vl-typography>`;n.storyName="vl-typography - default";let l=()=>(0,a.dy)` <vl-typography data-cy="typography">
    <h1>Heading 1</h1>
    <h2>Heading 2</h2>
    <h3>Heading 3</h3>
    <h4>Heading 4</h4>
    <h5>Heading 5</h5>
    <h6>Heading 6</h6>
</vl-typography>`;l.storyName="vl-typography - titles";let s=()=>(0,a.dy)` <vl-typography data-cy="typography">
    <ul>
...
</vl-typography>`;s.storyName="vl-typography - lists";let u=()=>(0,a.dy)` <vl-typography data-cy="typography">
    ...
    <p></p>
</vl-typography>`;u.storyName="vl-typography - markup";let p=()=>(0,a.dy)` <vl-typography data-cy="typography">
    <table>
        <caption>
            table title
        </caption>
...
</vl-typography>`;p.storyName="vl-typography - table";let m=({parameters:e,key1:t,key2:i})=>(0,a.dy)` <vl-typography data-vl-parameters=${e} data-cy="typography">
        <p>
...
`,s=[o.$4,l];class u extends(0,a.W$)(HTMLElement){static get _observedAttributes(){return["parameters"]}constructor(){super(`
        ...
        `),this._observer=this.__observeSlotElements(()=>this.__processSlotElements())}connectedCallback(){super.connectedCallback(),this.__processSlotElements()}disconnectedCallback(){this._observer.disconnect()}_parametersChangedCallback(e,t){this.__processSlotElements()}__processSlotElements(){this.__clearChildren();let e=this.dataset.vlParameters?JSON.parse(this.dataset.vlParameters):{},t=u.replaceTemplateParameters(this.innerHTML,e);this._element.insertAdjacentHTML("afterbegin",t)}__clearChildren(){for(;this._element.hasChildNodes();)this._element.firstChild.remove()}__observeSlotElements(e){let t=new MutationObserver(e);return t.observe(this,{attributes:!0,childList:!0,characterData:!0,subtree:!0}),t}static replaceTemplateParameters(e,t){return Object.keys(t).forEach(i=>e=e.replaceAll("${parameter."+i+"}",t[i])),e=e.replace(/\${parameter.\w+}/g,"")}}u=function(e,t,i,a){var o,r=arguments.length,n=r<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,a);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(n=(r<3?o(n):r>3?o(t,i,n):o(t,i))||n);return r>3&&n&&Object.defineProperty(t,i,n),n}([(0,a.a6)("vl-typography")],u)}}]);