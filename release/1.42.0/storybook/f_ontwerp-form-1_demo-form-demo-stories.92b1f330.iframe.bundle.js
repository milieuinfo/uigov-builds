"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[729],{"./docs/f_ontwerp/form/1_demo/form-demo.stories.ts":(e,t,l)=>{l.r(t),l.d(t,{Demo:()=>C,__namedExportsOrder:()=>R,default:()=>$});var r=l("../../node_modules/lit-html/lit-html.js"),o=l("../../libs/common/utilities/src/index.ts"),n=l("../../node_modules/lit/index.js"),s=l("../../libs/form/src/next/form-label/index.ts"),i=l("../../libs/form/src/next/error-message/index.ts"),a=l("../../libs/elements/src/index.ts"),c=l("../../libs/form/src/next/input-field/index.ts"),d=l("../../libs/form/src/next/input-field-masked/vl-input-field-masked.component.ts"),m=l("../../libs/form/src/next/textarea/vl-textarea.component.ts"),u=l("../../libs/form/src/next/select-rich/index.ts"),v=l("../../libs/form/src/next/select/vl-select.component.ts"),h=l("../../libs/form/src/next/checkbox/vl-checkbox.component.ts"),b=l("../../libs/form/src/next/radio-group/vl-radio.component.ts"),p=l("../../libs/form/src/next/radio-group/vl-radio-group.component.ts"),f=l("../../libs/form/src/next/datepicker/vl-datepicker.component.ts"),x=l("../../libs/form/src/next/upload/vl-upload.component.ts"),g=l("../../libs/components/src/next/button/index.ts"),k=l("../../libs/form/src/utils/index.ts");class w extends n.WF{static{(0,o.gy)([s.E,c.Y,d.j,m.m,f.M,u.A,v.Y,p.I,b.Z,x.f,h.v,i.X,g.Y])}static get styles(){return[a.hF,(0,n.AH)`
                form {
                    margin-top: 1rem;
                    max-width: 800px;
                }
...
`},"../../libs/form/src/next/radio-group/vl-radio.defaults.ts":(e,t,l)=>{l.d(t,{Q:()=>r});let r={id:"radio",name:"",value:null,label:"",block:!1,readonly:!1,disabled:!1,error:!1,success:!1,checked:!1}},"../../libs/form/src/next/select-rich/index.ts":(e,t,l)=>{l.d(t,{A:()=>r.Al});var r=l("../../libs/form/src/next/select-rich/vl-select-rich.component.ts");l("../../libs/form/src/next/select-rich/vl-select-rich.model.ts")},"../../libs/form/src/next/select/vl-select.component.ts":(e,t,l)=>{l.d(t,{Y:()=>v});var r=l("../../libs/common/utilities/src/index.ts"),o=l("../../node_modules/@domg/govflanders-style/common/index.js"),n=l("../../node_modules/@domg/govflanders-style/component/index.js"),s=l("../../node_modules/lit/index.js"),i=l("../../node_modules/lit/directives/class-map.js"),a=l("../../node_modules/lit/directives/live.js"),c=l("../../libs/form/src/next/form-control/form-control.ts");let d=(0,s.AH)`
    .vl-select {
        background-color: #fff;
        appearance: none;
...
`;var u=l("../../libs/form/src/next/select/vl-select.defaults.ts");class v extends c.M{static get styles(){return[o.h8,o.BI,d,n.py,m]}static get properties(){return{options:{type:Array},block:{type:Boolean},readonly:{type:Boolean},placeholder:{type:String},autocomplete:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},value:{type:String,state:!0}}}connectedCallback(){super.connectedCallback();let e=this.getSelectedOption();this.value=e?.value??null,this.initialOptions=JSON.parse(JSON.stringify(this.options))}updated(e){if(super.updated(e),e.has("options")){let e=this.getSelectedOption();this.value=e?.value??null}if(e.has("value")){let e={value:this.value};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-change",{composed:!0,bubbles:!0,detail:e})),this.dispatchInput&&(this.dispatchEvent(new CustomEvent("vl-input",{bubbles:!0,composed:!0,detail:e})),this.dispatchInput=!1),this.dispatchEventIfValid(e)}}render(){let e={"vl-select__container":!0,"vl-select__container--block":this.block},t={"vl-select":!0,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success,"vl-select--block":this.block},l=null!==this.value,r=this.options.some(e=>e.group);return(0,s.qy)`
        ...
        `}renderPlaceholder(e){return(0,s.qy)` <option class="vl-select__placeholder" value="" ?selected=${!e} disabled>
            ...
            <textarea
                ...
                @input=${this.onInput}
            />
        `}get validationTarget(){return this.shadowRoot?.querySelector("textarea")}resetFormControl(){super.resetFormControl(),this.value=this.initialValue}onInput(e){this.dispatchInput=!0,this.value=e?.target?.value}constructor(...e){super(...e),this.block=m.r.block,this.readonly=m.r.readonly,this.value=m.r.value,this.placeholder=m.r.placeholder,this.autocomplete=m.r.autocomplete,this.minLength=m.r.minLength,this.maxLength=m.r.maxLength,this.rows=m.r.rows,this.cols=m.r.cols,this.initialValue="",this.dispatchInput=!1}}u=function(e,t,l,r){var o,n=arguments.length,s=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,l):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,r);else for(var i=e.length-1;i>=0;i--)(o=e[i])&&(s=(n<3?o(s):n>3?o(t,l,s):o(t,l))||s);return n>3&&s&&Object.defineProperty(t,l,s),s}([(0,r.M1)("vl-textarea-next")],u)},"../../libs/form/src/next/textarea/vl-textarea.defaults.ts":(e,t,l)=>{l.d(t,{r:()=>r});let r={...l("../../libs/form/src/next/form-control/form-control.defaults.ts").i,block:!1,readonly:!1,value:"",placeholder:"",autocomplete:"",minLength:null,maxLength:null,rows:null,cols:null}},"../../libs/form/src/utils/index.ts":(e,t,l)=>{l.d(t,{S:()=>o});var r=l("../../libs/form/src/next/form-control/form-control.ts");let o=(e,t)=>{if(!e)return;let l=new FormData(e),o=e=>e instanceof r.M||e instanceof HTMLInputElement||e instanceof HTMLSelectElement||e instanceof HTMLTextAreaElement,n=Array.from(l.keys()).filter(e=>l.getAll(e).length>1),s=Array.from(e.querySelectorAll("*")).filter(e=>o(e)&&e.hasAttribute("multiple")).map(e=>e.getAttribute("name")),i=t||Array.from(new Set([...n,...s]));return Array.from(l.keys()).reduce((e,t)=>({...e,[t]:i.includes(t)?l.getAll(t):l.get(t)}),{})}}}]);