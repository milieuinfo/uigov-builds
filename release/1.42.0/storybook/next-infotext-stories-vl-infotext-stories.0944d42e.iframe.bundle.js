"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[977],{"../../node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs":(e,t,n)=>{n.d(t,{f:()=>x});var o=n("../../node_modules/react/index.js"),r=n("../../node_modules/react-dom/client.js"),s=new Map,a=({callback:e,children:t})=>{let n=(0,o.useRef)();return(0,o.useLayoutEffect)(()=>{n.current!==e&&(n.current=e,e())},[e]),t},l=async(e,t)=>{let n=await d(t);return new Promise(t=>{n.render(o.createElement(a,{callback:()=>t(null)},e))})},i=(e,t)=>{let n=s.get(e);n&&(n.unmount(),s.delete(e))},d=async e=>{let t=s.get(e);return t||(t=r.createRoot(e),s.set(e,t)),t},u=n("../../node_modules/@storybook/blocks/dist/index.mjs"),c={code:u.XA,a:u.zE,...u.Sw},m=class extends o.Component{constructor(){super(...arguments),this.state={hasError:!1}}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(e){let{showException:t}=this.props;t(e)}render(){let{hasError:e}=this.state,{children:t}=this.props;return e?null:o.createElement(o.Fragment,null,t)}},x=class{constructor(){this.render=async(e,t,r)=>{let s={...c,...t?.components},a=u.kQ;return new Promise((i,d)=>{n.e(814).then(n.bind(n,"../../node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/index.js")).then(({MDXProvider:n})=>l(o.createElement(m,{showException:d,key:Math.random()},o.createElement(n,{components:s},o.createElement(a,{context:e,docsParameter:t}))),r)).then(()=>i())})},this.unmount=e=>{i(e)}}}},"../../node_modules/@storybook/addon-docs/dist/index.mjs":(e,t,n)=>{n.d(t,{Hl:()=>o.Hl,W8:()=>o.W8,kL:()=>o.kL,ov:()=>o.ov}),n("../../node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs");var o=n("../../node_modules/@storybook/blocks/dist/index.mjs")},"../../libs/components/src/next/infotext/stories/vl-infotext.stories.ts":(e,t,n)=>{n.r(t),n.d(t,{InfotextBadge:()=>S,InfotextDefault:()=>j,InfotextLink:()=>k,__namedExportsOrder:()=>_,default:()=>b});var o=n("../../libs/common/storybook/src/index.ts"),r=n("../../node_modules/lit-html/lit-html.js"),s=n("../../libs/common/utilities/src/index.ts"),a=n("../../libs/common/utilities/src/css/index.ts"),l=n("../../node_modules/lit/index.js"),i=n("../../node_modules/lit/directives/class-map.js");let d=(0,l.AH)`
    .vl-infotext {
        display: flex;
