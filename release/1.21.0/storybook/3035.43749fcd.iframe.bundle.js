...
`;class c extends(0,l.W$)(HTMLElement){static{(0,l.YV)([i.Gi,i.gG])}static get _observedAttributes(){return["back","back-link","disable-back-link","hide-back-link","link","margin-bottom","sub-title","title"]}static get _observedClassAttributes(){return["full-width"]}get _classPrefix(){return"vl-functional-header--"}constructor(){super(`
          <style>
            ${o.YN}
            ${o.Oh}
            ${o.LF}
    ...
    `)}_getSubHeaderTemplate(e){return this._getSubHeaderTemplateWithValue(e.outerHTML)}_getSubHeaderTemplateWithValue(e){return this._template(`<li class="vl-functional-header__sub__action">${e}</li>`)}_titleChangedCallback(e,t){this._titleElement.innerText=t}_subTitleChangedCallback(e,t){this._subTitleElement.innerText=t}_linkChangedCallback(e,t){this._titleElement.href=t}_backChangedCallback(e,t){this._backLinkTextElement.innerText=t}_backLinkChangedCallback(e,t){this._backLinkElement.href=t||document.referrer}_marginBottomChangedCallback(e,t){let s=l.mt[t],i=this._shadow.querySelector(".vl-functional-header");s?i.style.marginBottom=s:i.style.removeProperty("margin-bottom")}_hideBackLinkChangedCallback(e,t){void 0!=t&&this._backLinkContainer?.remove()}_handleClickBackLink(e){this.hasAttribute("disable-back-link")&&e.preventDefault(),this.dispatchEvent(new CustomEvent("vl-click-back",{bubbles:!0,composed:!0}))}set backLinkEventListener(e){this._backLinkEventListener&&this._backLinkElement.removeEventListener("click",this._backLinkEventListener),this._backLinkEventListener=e,this._backLinkElement.addEventListener("click",this._backLinkEventListener)}__processSlotElements(){this.__processSlotActions()}__processSlotSubHeader(){this._subHeaderListElement.innerHTML="";let e=this.querySelector('[slot="sub-header"]');e?([...e.children].map(e=>this._getSubHeaderTemplate(e)).forEach(e=>this._subHeaderListElement.append(e)),this._defaultSubHeaderElement.hidden=!0):this._subHeaderElement.hidden=!0}__processSlotActions(){this._actionsListElement.innerHTML="";let e=this.querySelector('[slot="actions"]');e?[...e.children].map(e=>this._getActionTemplate(e)).forEach(e=>this._actionsListElement.append(e)):this._actionsElement.hidden=!0}__observeSlotElements(e){let t=new MutationObserver(e);return t.observe(this,{attributes:!0,childList:!0,characterData:!0,subtree:!0}),t}}c=function(e,t,s,l){var i,o=arguments.length,n=o<3?t:null===l?l=Object.getOwnPropertyDescriptor(t,s):l;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,s,l);else for(var r=e.length-1;r>=0;r--)(i=e[r])&&(n=(o<3?i(n):o>3?i(t,s,n):i(t,s))||n);return o>3&&n&&Object.defineProperty(t,s,n),n}([(0,l.a6)("vl-functional-header")],c)},"./libs/components/src/http-error-message/vl-http-400-message.component.ts":(e,t,s)=>{"use strict";var l=s("./libs/common/utilities/src/index.ts"),i=s("./libs/elements/src/index.ts"),o=s("./node_modules/@domg/govflanders-style/common/index.js"),n=s("./node_modules/@domg/govflanders-style/component/index.js"),r=s("./node_modules/lit/index.js"),a=s("./libs/components/src/http-error-message/vl-http-error-message.component.ts");class c extends l.fS{static{(0,l.YV)([a.k,i.uu])}static get styles(){return[o.Oh,n.jn]}render(){return(0,r.dy)`
        ...
        `)}connectedCallback(){super.connectedCallback(),this.__processAttributes()}get _title(){return this.dataset.vlTitle||this._defaults.title}get _image(){return this.dataset.vlImage||this._defaults.image}get _imageAlt(){return this.dataset.vlImageAlt||this._defaults.imageAlt}_titleChangedCallback(){this.__processTitle()}_imageChangedCallback(){this.__processImage()}_imageAltChangedCallback(){this.__processImageAlt()}__setImageAttribute(e,t){this.__imageForSmallScreensElement.setAttribute(e,t),this.__imageForNormalScreensElement.setAttribute(e,t)}get __titleElement(){return this._element.querySelector("#title")}get __textElement(){return this._element.querySelector("#text")}get __actionsElement(){return this._element.querySelector("#actions")}get __actionElement(){return this._element.querySelector("#actions > *")}get __imageForSmallScreensElement(){return this._element.querySelector("#image-small")}get __imageForNormalScreensElement(){return this._element.querySelector("#image-normal")}__processTitle(){this.__titleElement.textContent=this._title}__processImage(){this.__setImageAttribute("src",this._image)}__processImageAlt(){this.__setImageAttribute("alt",this._imageAlt)}__processAttributes(){this.__processTitle(),this.__processImage(),this.__processImageAlt()}}n=function(e,t,s,l){var i,o=arguments.length,n=o<3?t:null===l?l=Object.getOwnPropertyDescriptor(t,s):l;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,s,l);else for(var r=e.length-1;r>=0;r--)(i=e[r])&&(n=(o<3?i(n):o>3?i(t,s,n):i(t,s))||n);return o>3&&n&&Object.defineProperty(t,s,n),n}([(0,l.a6)("vl-http-error-message")],n)},"./libs/components/src/index.ts":(e,t,s)=>{"use strict";s.d(t,{b8:()=>l.b,P7:()=>i.P,EM:()=>o.E,d4:()=>n.d,Jy:()=>r.J,D3:()=>a.D,Ui:()=>c.U,M$:()=>d.M,Pr:()=>h.Pr,m5:()=>h.m5,g1:()=>m.g,vG:()=>u.v,e9:()=>p.e,Pz:()=>v.P});var l=s("./libs/components/src/accordion/vl-accordion.component.ts");s("./libs/components/src/accordion-list/vl-accordion-list.component.ts"),s("./libs/components/src/alert/vl-alert.component.ts"),s("./libs/components/src/alert/vl-alert.model.ts");var i=s("./libs/components/src/annotation/vl-annotation.component.ts");s("./libs/components/src/autocomplete/vl-autocomplete.component.ts"),s("./libs/components/src/breadcrumb/vl-breadcrumb.component.ts"),s("./libs/components/src/breadcrumb/vl-breadcrumb-item.component.ts"),s("./libs/components/src/next/cascader/vl-cascader.component.ts"),s("./libs/components/src/next/cascader/vl-cascader-item.component.ts"),s("./libs/components/src/next/cascader/vl-cascader.model.ts");var o=s("./libs/components/src/checkbox/vl-checkbox.component.ts");s("./libs/components/src/code-preview/vl-code-preview.component.ts");var n=s("./libs/components/src/contact-card/vl-contact-card.component.ts");s("./libs/components/src/content-header/vl-content-header.component.ts"),s("./libs/components/src/datepicker/vl-datepicker.component.ts"),s("./libs/components/src/description-data/vl-description-data.component.ts"),s("./libs/components/src/description-data/vl-description-data-item.component.ts");var r=s("./libs/components/src/document/vl-document.component.ts"),a=s("./libs/components/src/functional-header/vl-functional-header.component.ts");s("./libs/components/src/http-error-message/vl-http-400-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-401-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-403-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-404-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-405-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-408-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-410-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-411-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-412-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-413-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-414-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-415-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-500-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-501-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-502-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-503-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-504-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-505-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-506-message.component.ts"),s("./libs/components/src/http-error-message/vl-http-error-message.component.ts"),s("./libs/components/src/info-tile/vl-info-tile.component.ts");var c=s("./libs/components/src/infoblock/vl-infoblock.component.ts");s("./libs/components/src/input-slider/vl-input-slider.component.ts"),s("./libs/components/src/loader/vl-loader.component.ts");var d=s("./libs/components/src/modal/vl-modal.component.ts");s("./libs/components/src/pager/vl-pager.component.ts"),s("./libs/components/src/pill/vl-button-pill.component.ts"),s("./libs/components/src/pill/vl-pill.component.ts"),s("./libs/components/src/pill/vl-pill.model.ts");var h=s("./libs/components/src/popover/index.ts");s("./libs/components/src/progress-bar/vl-progress-bar.component.ts"),s("./libs/components/src/proza-message/vl-proza-message.component.ts"),s("./libs/components/src/proza-message/vl-proza-message-preloader.component.ts"),s("./libs/components/src/radio/vl-radio.component.ts"),s("./libs/components/src/radio/vl-radio-group.component.ts"),s("./libs/components/src/rich-data/vl-rich-data.component.ts"),s("./libs/components/src/rich-data-table/vl-rich-data-field.component.ts"),s("./libs/components/src/rich-data-table/vl-rich-data-sorter.component.ts"),s("./libs/components/src/rich-data-table/vl-rich-data-table.component.ts");var m=s("./libs/components/src/search/vl-search.component.ts");s("./libs/components/src/share-buttons/vl-share-button.component.ts"),s("./libs/components/src/share-buttons/vl-share-button.model.ts"),s("./libs/components/src/share-buttons/vl-share-buttons.component.ts");var u=s("./libs/components/src/side-sheet/vl-side-sheet.component.ts");s("./libs/components/src/spotlight/vl-spotlight.component.ts"),s("./libs/components/src/steps/vl-duration-step.component.ts"),s("./libs/components/src/steps/vl-step.component.ts"),s("./libs/components/src/steps/vl-steps.component.ts"),s("./libs/components/src/tabs/vl-tabs.component.ts"),s("./libs/components/src/template/vl-template.component.ts"),s("./libs/components/src/textarea/vl-textarea.element.ts"),s("./libs/components/src/textarea/vl-textarea-modal.component.ts"),s("./libs/components/src/toaster/vl-toaster.element.ts");var p=s("./libs/components/src/toggle-button/index.ts");s("./libs/components/src/tooltip/vl-tooltip.component.ts");var v=s("./libs/components/src/typography/vl-typography.component.ts");s("./libs/components/src/upload/vl-upload.component.ts"),s("./libs/components/src/wizard/vl-wizard.component.ts"),s("./libs/components/src/wizard/vl-wizard-pane.component.ts")},"./libs/components/src/info-tile/vl-info-tile.component.ts":(e,t,s)=>{"use strict";var l=s("./libs/common/utilities/src/index.ts"),i=s("./node_modules/@domg/govflanders-style/component/index.js"),o=s("./node_modules/@domg/govflanders-style/common/index.js"),n=s("./node_modules/lit/index.js");let r=(0,n.iv)`
