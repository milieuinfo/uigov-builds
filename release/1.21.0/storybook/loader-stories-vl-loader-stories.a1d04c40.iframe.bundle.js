"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[4399],{"./libs/components/src/loader/stories/vl-loader.stories.ts":(t,e,a)=>{a.r(e),a.d(e,{__namedExportsOrder:()=>d,default:()=>s,loaderDefault:()=>r,loaderLightWithoutText:()=>n,loaderWithCustomContent:()=>i});var l=a("./node_modules/lit-html/lit-html.js");a("./libs/components/src/loader/vl-loader.component.ts");var o=a("./libs/common/storybook/src/index.ts");let s={title:"Components/loader",tags:["autodocs"],args:{...o._O,light:!1,text:"Pagina is aan het laden",single:!1},argTypes:{...(0,o.Wp)(),light:{name:"data-vl-light",description:"Attribute is used to obtain an alternative rendering in combination with a dark background. ",table:{type:{summary:"boolean"},category:"Attributes",defaultValue:{summary:"false"}}},text:{name:"data-vl-text",description:"Attribute is used to display an informative text during loading. ",table:{type:{summary:"string"},category:"Attributes",defaultValue:{summary:""}}},single:{name:"data-vl-single",description:"Attribute is used to indicate that no text should be displayed. ",table:{type:{summary:"boolean"},category:"Attributes",defaultValue:{summary:"false"}}}}},r=({light:t,text:e,single:a})=>(0,l.dy)`
