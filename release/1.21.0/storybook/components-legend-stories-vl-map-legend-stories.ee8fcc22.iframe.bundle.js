"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[9867],{"./libs/map/src/components/legend/stories/vl-map-legend.stories.ts":(e,t,a)=>{a.r(t),a.d(t,{MapLegendFeaturesLayer:()=>w,MapLegendFeaturesLayerMultipleStyles:()=>_,MapLegendMultipleFeaturesLayers:()=>T,MapLegendWfsLayer:()=>z,MapLegendWmsLayer:()=>L,MapLegendWmsWfsLayer:()=>k,__namedExportsOrder:()=>S,default:()=>x}),a("./libs/map/src/vl-map.ts"),a("./libs/map/src/components/baselayer/vl-map-base-layer-grb-gray/vl-map-base-layer-grb-gray.ts"),a("./libs/map/src/components/layer-style/vl-map-layer-circle-style/vl-map-layer-circle-style.ts"),a("./libs/map/src/components/layer/vector-layer/vl-map-features-layer/vl-map-features-layer.ts");var r=a("./libs/map/src/components/legend/vl-map-legend.ts"),l=a("./libs/common/storybook/src/index.ts"),o=a("./node_modules/lit/index.js");a("./libs/map/src/components/layer-style/vl-map-layer-style.ts");let s={...l._O,bottom:"",left:"",placement:r.q.BOTTOM_RIGHT,right:"",top:""},n={...(0,l.Wp)(),bottom:{name:"bottom",description:'Bepaalt de "bottom" positie van de legende op de kaart.<br>Kan gebruikt worden in combinatie met data-vl-placement.',table:{type:{summary:l.vK.STRING},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.bottom}}},left:{name:"left",description:'Bepaalt de "left" positie van de legende op de kaart.<br>Kan gebruikt worden in combinatie met data-vl-placement.',table:{type:{summary:l.vK.STRING},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.left}}},placement:{name:"data-vl-placement",description:"Bepaalt de plaats van de legende op de kaart.",control:{type:"select",options:[r.q.TOP_LEFT,r.q.TOP_RIGHT,r.q.BOTTOM_LEFT,r.q.BOTTOM_RIGHT]},table:{type:{summary:`"${r.q.TOP_LEFT}" |
                "${r.q.TOP_RIGHT}" |
                "${r.q.BOTTOM_LEFT}" |
                "${r.q.BOTTOM_RIGHT}"`},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.placement}}},right:{name:"right",description:'Bepaalt de "right" positie van de legende op de kaart.<br>Kan gebruikt worden in combinatie met data-vl-placement.',table:{type:{summary:l.vK.STRING},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.right}}},top:{name:"top",description:'Bepaalt de "top" positie van de legende op de kaart.<br>Kan gebruikt worden in combinatie met data-vl-placement.',table:{type:{summary:l.vK.STRING},category:l.aA.ATTRIBUTES,defaultValue:{summary:s.top}}}},i=()=>{document.addEventListener("DOMContentLoaded",async()=>{let e=document.getElementById("map");await e.ready,document.querySelector("#style-1").appliesTo=e=>"style-1"===e.get("styleId"),document.querySelector("#style-2").appliesTo=e=>"style-2"===e.get("styleId"),document.querySelector("#style-3").appliesTo=e=>"style-3"===e.get("styleId")})},d=(0,l.yg)(s,({bottom:e,left:t,placement:a,right:r,top:l})=>(i(),(0,o.dy)` <vl-map id="map">
        ...
        <vl-map-legend
            ...
            left=${t}
        ></vl-map-legend>
    </vl-map>`));var p=a("./node_modules/lit-html/lit-html.js");let m=(0,l.yg)(s,({bottom:e,left:t,placement:a,right:r,top:l})=>(0,p.dy)` <vl-map id="map">
        <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
        ...
        <vl-map-legend
            ...
            left=${t}
        ></vl-map-legend>
    </vl-map>`);a("./libs/map/src/components/action/draw-action/measure-action/vl-map-measure-action.ts"),a("./libs/map/src/components/controls/measure-control/vl-map-measure-control.ts"),a("./libs/map/src/components/controls/vl-map-action-controls.ts");let c=(0,l.yg)(s,({bottom:e,left:t,placement:a,right:r,top:l})=>(0,p.dy)` <vl-map>
        <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
        ...
        <vl-map-legend
            ...
            left=${t}
        ></vl-map-legend>
    </vl-map>`);a("./libs/map/src/components/layer/vector-layer/vl-map-wfs-layer/vl-map-wfs-layer.ts");let u=(0,l.yg)(s,({bottom:e,left:t,placement:a,right:r,top:l})=>(0,o.dy)`
        <vl-map>
            <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
            <vl-map-wfs-layer
    ...
    `),g=(0,l.yg)(s,({bottom:e,left:t,placement:a,right:r,top:l})=>(0,o.dy)`
        <vl-map>
            <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
    ...
    `),y=(0,l.yg)(s,({bottom:e,left:t,placement:a,right:r,top:l})=>(0,o.dy)`
        <vl-map>
            <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
            <vl-map-tiled-wms-layer
                data-vl-layers="grondwater:beschermingszones_2014"
...
`,...i.CX,d,n.Z];var m=a("./libs/common/utilities/src/index.ts");let c={TOP_LEFT:"top_left",TOP_RIGHT:"top_right",BOTTOM_LEFT:"bottom_left",BOTTOM_RIGHT:"bottom_right"};class u extends m.fS{static get styles(){return[(0,r.iv)`
        ...
        </div>`:null}generateItemStyle(){let e=this.getPosition();return(e.left?`;left:${e.left}`:"")+(e.top?`;top:${e.top}`:"")+(e.right?`;right:${e.right}`:"")+(e.bottom?`;bottom:${e.bottom}`:"")}generateIconStyle(e){let t="";return e instanceof s.e&&(t="border-radius: 50%;"),`border: ${e.borderSize}px solid ${e.borderColor}; background-color:${e.color};${t}`}}u=function(e,t,a,r){var l,o=arguments.length,s=o<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,a):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,a,r);else for(var n=e.length-1;n>=0;n--)(l=e[n])&&(s=(o<3?l(s):o>3?l(t,a,s):l(t,a))||s);return o>3&&s&&Object.defineProperty(t,a,s),s}([(0,l.Mo)("vl-map-legend")],u)}}]);