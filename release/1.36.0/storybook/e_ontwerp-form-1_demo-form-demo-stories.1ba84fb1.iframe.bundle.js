...
`},"./libs/form/src/next/radio-group/vl-radio.defaults.ts":(e,t,l)=>{l.d(t,{Y:()=>r});let r={id:"radio",name:"",value:null,label:"",block:!1,readonly:!1,disabled:!1,error:!1,success:!1,checked:!1}},"./libs/form/src/next/select-rich/index.ts":(e,t,l)=>{l.d(t,{n:()=>r.W});var r=l("./libs/form/src/next/select-rich/vl-select-rich.component.ts");l("./libs/form/src/next/select-rich/vl-select-rich.model.ts")},"./libs/form/src/next/select/vl-select.component.ts":(e,t,l)=>{l.d(t,{k:()=>u});var r=l("./libs/common/utilities/src/index.ts"),o=l("./node_modules/@domg/govflanders-style/common/index.js"),n=l("./node_modules/@domg/govflanders-style/component/index.js"),s=l("./node_modules/lit/index.js"),i=l("./node_modules/lit/directives/class-map.js"),a=l("./node_modules/lit/directives/live.js"),c=l("./libs/form/src/next/form-control/form-control.ts");let d=(0,s.iv)`
    .vl-select {
        background-color: #fff;
        appearance: none;
...
`;var v=l("./libs/form/src/next/select/vl-select.defaults.ts");class u extends c.N{static get styles(){return[o.YN,o.Oh,d,n.oQ,m]}static get properties(){return{options:{type:Array},block:{type:Boolean},readonly:{type:Boolean},placeholder:{type:String},autocomplete:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},value:{type:String,state:!0}}}connectedCallback(){super.connectedCallback();let e=this.getSelectedOption();this.value=e?.value??null,this.initialOptions=JSON.parse(JSON.stringify(this.options))}updated(e){if(super.updated(e),e.has("options")){let e=this.getSelectedOption();this.value=e?.value??null}if(e.has("value")){let e={value:this.value};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-select",{composed:!0,bubbles:!0,detail:e})),this.dispatchEventIfValid(e)}}render(){let e={"vl-select__container":!0,"vl-select__container--block":this.block},t={"vl-select":!0,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success,"vl-select--block":this.block},l=null!==this.value,r=this.options.some(e=>e.group);return(0,s.dy)`
        ...
        `}renderPlaceholder(e){return(0,s.dy)` <option class="vl-select__placeholder" value="" ?selected=${!e} disabled>
            ${this.placeholder}
        </option>`}renderClearButton(){return(0,s.dy)` <button class="vl-select__button" aria-label="Verwijder keuze" @click=${this.clearValue}>
            <span class="vl-icon vl-vi vl-vi-close"></span>
        </button>`}renderGroupedOptions(){return Object.entries(this.getGroupedOptions()).map(([e,t])=>(0,s.dy)` <optgroup label=${e}>${this.renderSelectOptions(t)}</optgroup>`)}renderSelectOptions(e){return e.map(e=>(0,s.dy)` <option
                value=${e.value}
