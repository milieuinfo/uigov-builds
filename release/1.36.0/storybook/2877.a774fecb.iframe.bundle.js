"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[2877],{"./libs/form/src/next/select-rich/vl-select-rich.component.ts":(e,l,t)=>{t.d(l,{W:()=>v});var i=t("./libs/common/utilities/src/index.ts"),s=t("./node_modules/@domg/govflanders-style/common/index.js"),o=t("./node_modules/@domg/govflanders-style/component/index.js"),r=t("./node_modules/lit/index.js"),c=t("./node_modules/lit/directives/class-map.js"),a=t("./libs/form/src/next/form-control/form-control.ts");let n=(0,r.iv)`
    .vl-pill {
        display: inline-flex;
        max-width: 100%;
        align-items: center;
...
`;var p=t("./libs/form/src/next/select-rich/vl-select-rich.defaults.ts"),m=t("./libs/form/src/next/select-rich/vl-select-rich.model.ts");class v extends a.N{static get styles(){return[s.YN,s.Oh,o.K$,u,n,o.oQ,d]}static get properties(){return{options:{type:Array},placeholder:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},multiple:{type:Boolean},search:{type:Boolean},position:{type:String},resultLimit:{type:Number,attribute:"result-limit"},noResultsText:{type:String,attribute:"no-results-text"},noChoicesText:{type:String,attribute:"no-choices-text"},searchPlaceholder:{type:String,attribute:"search-placeholder"},value:{type:FormData,state:!0,hasChanged:(e,l)=>e instanceof FormData&&l instanceof FormData?JSON.stringify([...e.entries()])!==JSON.stringify([...l.entries()]):e!==l}}}constructor(){super(),this.options=p.V.options,this.placeholder=p.V.placeholder,this.notDeletable=p.V.notDeletable,this.multiple=p.V.multiple,this.search=p.V.search,this.position=p.V.position,this.resultLimit=p.V.resultLimit,this.noResultsText=p.V.noResultsText,this.noChoicesText=p.V.noChoicesText,this.searchPlaceholder=p.V.searchPlaceholder,this.value=null,this.choices=null,this.initialOptions=[],this.onClickChoices=e=>{e.stopPropagation(),this.disabled||this.choices?.showDropdown()},this.onSearchInput=e=>{let l=e?.target?.value;this.dispatchEvent(new CustomEvent("vl-select-search",{bubbles:!0,composed:!0,detail:{value:l}}))},this.submitFormOnEnter=!1}firstUpdated(e){super.firstUpdated(e),this.choices=new m.ay(this.validationTarget,this.getChoicesConfig()),this.initialOptions=[...JSON.parse(JSON.stringify(this.options))],setTimeout(()=>{this.getChoicesElement()?.addEventListener("click",this.onClickChoices),this.internals.labels[0]?.addEventListener("click",this.onClickChoices),this.value||this.setValue(null),this.choices?.input?.element?.addEventListener("input",this.onSearchInput)},0)}updated(e){if(super.updated(e),this.choices){if(e.has("options")&&(this.choices.clearStore(),this.choices.setChoices(this.getOptions(),"value","label",!0),this.onChange()),e.has("value")){let e={value:this.getSelected()};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-select",{bubbles:!0,composed:!0,detail:e})),this.dispatchEventIfValid(e)}e.has("disabled")&&(this.disabled?this.choices.disable():this.choices.enable()),e.has("error")&&this.internals.setValidity({customError:this.error},"custom-error"),e.has("resultLimit")&&(this.choices.config.searchResultLimit=this.resultLimit)}}disconnectedCallback(){super.disconnectedCallback(),this.getChoicesElement()?.removeEventListener("click",this.onClickChoices),this.internals.labels[0]?.removeEventListener("click",this.onClickChoices),this.choices?.input?.element?.removeEventListener("input",this.onSearchInput)}render(){let e={"vl-select":!this.multiple,"vl-multiselect":this.multiple,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success};return(0,r.dy)`
        ...
        `}get validationTarget(){return this.shadowRoot?.querySelector("select")}resetFormControl(){super.resetFormControl(),this.options=[...this.initialOptions]}getSelected(){return this.multiple?this.getSelectedValues():this.getSelectedValues()[0]||null}getSelectedValues(){return Array.from(this.validationTarget.selectedOptions).filter(e=>e.value).map(e=>e.value)}collectFormData(){let e=this.name||this.id,l=this.getSelectedValues();return l?.length?l.reduce((l,t,i)=>(i?l.append(e,t):l.set(e,t),l),new FormData):null}getChoicesElement(){return this.shadowRoot?.querySelector(".js-vl-select")}getChoicesConfig(){return{shouldSort:!1,removeItemButton:!this.notDeletable,removeItems:!this.notDeletable,searchEnabled:this.search,placeholder:!!this.placeholder,placeholderValue:this.placeholder,position:this.position,noResultsText:this.noResultsText,searchResultLimit:this.resultLimit,noChoicesText:this.noChoicesText,searchPlaceholderValue:this.searchPlaceholder,classNames:{...m.$e,containerOuter:"js-vl-select",containerInner:"vl-select__inner",input:"vl-input-field",inputCloned:"vl-input-field-cloned",list:"vl-select__list",listItems:"vl-select__list--multiple",listSingle:"vl-select__list--single",listDropdown:"vl-select__list--dropdown",item:"vl-select__item",itemSelectable:"vl-select__item--selectable",itemDisabled:"vl-select__item--disabled",itemChoice:"vl-select__item--choice",placeholder:"vl-select__placeholder",group:"vl-select__group",groupHeading:"vl-select__heading",button:"vl-select__button"},callbackOnCreateTemplates:e=>({containerOuter:()=>e(`<div
                        ...
                        `):e(`<div class="
                                ...
                                </div>`),itemList:()=>this.multiple?e('<div class="vl-input-field vl-select__list--multiple"></div>'):e('<div class="vl-input-field"></div>'),input:()=>e('<input type="text" class="vl-input-field vl-input-field-cloned" autocomplete="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" aria-label="zoek item">'),dropdown:()=>e('<div class="vl-select__list vl-select__list--dropdown" role="group" id="vl-select__list"></div>'),choiceList:()=>e('<div class="vl-select__list" role="listbox" aria-label="item lijst" tabindex="0"></div>')})}}getOptions(){let e=[...this.options];if(this.placeholder&&!this.multiple){let l={value:"",label:this.placeholder,placeholder:!0,disabled:!0,selected:!0};e.unshift(l)}return e}onChange(){this.value=this.collectFormData()}}v=function(e,l,t,i){var s,o=arguments.length,r=o<3?l:null===i?i=Object.getOwnPropertyDescriptor(l,t):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,l,t,i);else for(var c=e.length-1;c>=0;c--)(s=e[c])&&(r=(o<3?s(r):o>3?s(l,t,r):s(l,t))||r);return o>3&&r&&Object.defineProperty(l,t,r),r}([(0,i.a6)("vl-select-rich-next")],v)},"./libs/form/src/next/select-rich/vl-select-rich.defaults.ts":(e,l,t)=>{t.d(l,{V:()=>o});var i=t("./libs/form/src/next/form-control/form-control.defaults.ts"),s=t("./libs/form/src/next/select-rich/vl-select-rich.model.ts");let o={...i.E,options:[],placeholder:"",notDeletable:!1,multiple:!1,search:!1,position:s.Wo.AUTO,resultLimit:4,noResultsText:"Geen resultaten gevonden",noChoicesText:"Geen resterende opties gevonden",searchPlaceholder:"Zoek item"}},"./libs/form/src/next/select-rich/vl-select-rich.model.ts":(e,l,t)=>{t.d(l,{$e:()=>o,Wo:()=>c,ay:()=>r});var i=t("./node_modules/choices.js/public/assets/scripts/choices.js"),s=t.n(i);let o=i.DEFAULT_CLASSNAMES,r=s(),c={AUTO:"auto",TOP:"top",BOTTOM:"bottom"}}}]);