"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[1985],{"../../libs/components/src/next/tabs/vl-tabs.component.ts":(t,e,a)=>{a.d(e,{q:()=>w});var s=a("../../libs/common/utilities/src/index.ts"),i=a("../../libs/elements/src/index.ts"),l=a("../../node_modules/@domg/govflanders-style/common/index.js"),o=a("../../node_modules/@domg/govflanders-style/component/index.js");a("../../node_modules/@govflanders/vl-ui-util/dist/js/util.js");var n=a("../../node_modules/lit/index.js");class r extends s.jW{static get is(){return"vl-tab-section-next"}connectedCallback(){super.connectedCallback(),this.processClasses(),this.processAttributes()}createRenderRoot(){return this}processClasses(){this.classList.add("vl-tab__pane")}processAttributes(){this.setAttribute("tab-pane",""),this.setAttribute("tabindex","0"),this.setAttribute("role","tabpanel"),this.setAttribute("hidden","hidden"),this.setAttribute("aria-labelledby",`${this.id}-tab`)}}r=function(t,e,a,s){var i,l=arguments.length,o=l<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,a):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,a,s);else for(var n=t.length-1;n>=0;n--)(i=t[n])&&(o=(l<3?i(o):l>3?i(e,a,o):i(e,a))||o);return l>3&&o&&Object.defineProperty(e,a,o),o}([(0,s.M1)("vl-tab-section-next")],r);class b extends s.jW{static get is(){return"vl-tab-next"}static get properties(){return{href:{type:String},disableLink:{type:Boolean,attribute:"disable-link"},withinFunctionalHeader:{type:Boolean,attribute:"within-functional-header"}}}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.processClasses(),this.processLinkElement()}updated(t){super.updated(t),t.has("href")&&!this.hasAttribute("disable-link")&&(this.linkElement?.setAttribute("href",this.href),this.linkElement?.setAttribute("aria-controls",`${this.href}-pane`)),t.has("id")&&this.linkElement&&(this.linkElement.id=this.id),t.has("withinFunctionalHeader")&&(this.withinFunctionalHeader?this.linkElement?.classList.add("vl-link"):this.linkElement?.classList.remove("vl-link"))}activate(){this.linkElement?.click()}get isActive(){return this.classList.contains("vl-tab--active")}get linkElement(){return this.querySelector(".vl-tab__link")}get linkElementTemplate(){let t=document.createElement("a");return t.classList.add("vl-tab__link"),t.setAttribute("tab",""),t}processClasses(){this.classList.add("vl-tab")}processLinkElement(){let t=this.linkElementTemplate,e=this.querySelector("slot");e&&t.appendChild(e),t.addEventListener("click",t=>{this.dispatchActiveTabChangedEvent(t)}),this.appendChild(t)}dispatchActiveTabChangedEvent(t){this.isActive||this.dispatchEvent(new CustomEvent("change",{detail:{activeTab:this.id},composed:!0})),t.screenX&&t.screenY&&this.dispatchEvent(new CustomEvent("vl-click",{detail:{activeTab:this.id},composed:!0}))}constructor(...t){super(...t),this.href="",this.disableLink=!1,this.withinFunctionalHeader=!1}}b=function(t,e,a,s){var i,l=arguments.length,o=l<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,a):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,a,s);else for(var n=t.length-1;n>=0;n--)(i=t[n])&&(o=(l<3?i(o):l>3?i(e,a,o):i(e,a))||o);return l>3&&o&&Object.defineProperty(e,a,o),o}([(0,s.M1)("vl-tab-next")],b);class d extends s.jW{static get is(){return"vl-tabs-pane-next"}static get properties(){return{id:{type:String},title:{type:String}}}render(){return(0,n.qy)` <slot></slot>`}connectedCallback(){super.connectedCallback(),this.processTitleSlot()}disconnectedCallback(){this.titleSlotObserver&&this.titleSlotObserver.disconnect()}get paneId(){return this.getAttribute("id")||""}get paneTitle(){return this.getAttribute("title")||""}get titleSlot(){return this.querySelector('[slot="title"]')}processTitleSlot(){this.titleSlot&&(this.moveTabPaneTitleSlot(),this.titleSlotObserver=this.observeTitleSlot(()=>this.moveTabPaneTitleSlot()))}moveTabPaneTitleSlot(){if(this.titleSlot){let t=this.titleSlot.cloneNode(!0);t.setAttribute("slot",`${this.paneId}-title-slot`);let e=this.parentElement?.querySelector(`[slot="${this.paneId}-title-slot"]`);e?this.parentElement?.replaceChild(t,e):this.parentElement?.appendChild(t)}}observeTitleSlot(t){let e=new MutationObserver(e=>t(e));return this.titleSlot&&e.observe(this.titleSlot,{childList:!0,subtree:!0,characterData:!0}),e}titleChangedCallback(t,e){if(this.hasAttribute("observe-title")){let t=this.parentElement?.shadowRoot?.querySelector(`a.vl-tab__link#${this.paneId}`);t&&(t.innerHTML=`<slot name="${this.paneId}-title-slot">${e}</slot>`)}}constructor(...t){super(...t),this.titleSlotObserver=null}}d=function(t,e,a,s){var i,l=arguments.length,o=l<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,a):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,a,s);else for(var n=t.length-1;n>=0;n--)(i=t[n])&&(o=(l<3?i(o):l>3?i(e,a,o):i(e,a))||o);return l>3&&o&&Object.defineProperty(e,a,o),o}([(0,s.M1)("vl-tabs-pane-next")],d);let c=(0,n.AH)`
    :root {
...
`;var h=a("../../node_modules/@govflanders/vl-ui-util/src/js/breakpoint.js"),v="vl-tab--active",p="vl-tab",u="tabs-toggle",f="show",m=new h.A;m.dress();class g{constructor(){this.currentTabIndexForCurrentTabsContainer=-1}resetTabIndexesForTabs(t){vl.util.each(t,t=>{t.setAttribute("tabindex","-1"),t.setAttribute("aria-selected","false"),"function"==typeof t.closest&&vl.util.removeClass(t.closest(".".concat(p)),v)})}resetTabPanes(t){vl.util.each(t,t=>{t.setAttribute("hidden","hidden"),t.setAttribute("".concat(f),"false")})}showTabPaneForTab(t,e){t.setAttribute("tabindex","0"),"function"==typeof t.closest&&vl.util.addClass(t.closest(".".concat(p)),v),t.setAttribute("aria-selected",!0),null==e||e.setAttribute("hidden",""),null==e||e.setAttribute("".concat(f),"true")}updateResponsiveBtnLabelForTabsContainerWithTab(t,e){t.querySelector("[".concat(u,"] span")).innerHTML=e.innerHTML}clickEvent(t){if(t.target&&"function"==typeof t.target.closest){var e=t.target.closest("[".concat("tabs","]")),a=e.querySelector("[".concat(u,"]")),s=e.querySelector("".concat("[tabs-list]")),i="true"===s.getAttribute(f);s.setAttribute(f,i?"false":"true"),s.setAttribute("aria-hidden",i?"true":"false"),a.setAttribute("aria-expanded",i?"true":"false"),a.setAttribute("close",i?"false":"true")}}setupResponsiveToggleBtnForTabsContainer(t){var e=t.shadowRoot,a=null==e?void 0:e.querySelector("[".concat(u,"]")),s=t.getAttribute("display-style"),i=m._getBreakpoint();a&&("xsmall"===i||"small"===i||"collapsed"===s)&&a.addEventListener("click",this.clickEvent,{signal:t.disconnectedSignal})}dress(t){var e=t.shadowRoot,a=e.querySelectorAll("".concat("[tab]")),s=e.querySelectorAll("".concat("[tab-pane]")),i=window.location.hash,l=e.querySelector("[href$='".concat(i,"']"));vl.util.each(a,(t,i)=>{t.addEventListener("focus",()=>{this.currentTabIndexForCurrentTabsContainer=i,t.click()}),t.addEventListener("click",()=>{this.resetTabIndexesForTabs(a),this.resetTabPanes(s),this.showTabPaneForTab(t,s[i]),this.updateResponsiveBtnLabelForTabsContainerWithTab(e,t),e.querySelector("[".concat(u,"]")).click()})}),l&&l.click(),e.addEventListener("keydown",t=>{switch(t.keyCode){case 37:var e=this.currentTabIndexForCurrentTabsContainer-1;e<0&&(e=a.length-1);var s=a[e];s&&s.focus();break;case 39:var i=this.currentTabIndexForCurrentTabsContainer+1;i>=a.length&&(i=0);var l=a[i];l&&l.focus()}});var o=t.getAttribute("display-style");this.setupResponsiveToggleBtnForTabsContainer(t),("tabs"!==o||"collapsed"!==o)&&window.addEventListener("resize",vl.util.debounce(()=>{var a=m._getBreakpoint();e.querySelector("[".concat(u,"]")).removeEventListener("click",this.clickEvent,!1),("xsmall"===a||"small"===a)&&this.setupResponsiveToggleBtnForTabsContainer(t)},0),{signal:t.disconnectedSignal})}}"tabsNext"in vl||(vl.tabsNext=new g);let y=(0,n.AH)`
    .vl-tab__link {
        cursor: pointer;
    }
