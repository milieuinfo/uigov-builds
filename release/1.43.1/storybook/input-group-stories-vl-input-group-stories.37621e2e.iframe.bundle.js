"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[8479],{"../../libs/elements/src/input-group/stories/vl-input-group.stories.ts":(t,n,i)=>{i.r(n),i.d(n,{__namedExportsOrder:()=>r,default:()=>o,inputGroupDefault:()=>u,inputGroupWithButtonLeft:()=>l,inputGroupWithInputAddonRight:()=>p,inputGroupWithTextAddonLeft:()=>s,inputGroupWithTextAddonRight:()=>a});var e=i("../../node_modules/lit-html/lit-html.js");i("../../libs/elements/src/input-group/vl-input-group.element.ts"),i("../../libs/elements/src/button/vl-button.element.ts"),i("../../libs/elements/src/input-field/vl-input-field.element.ts"),i("../../libs/elements/src/input-addon/vl-input-addon.element.ts"),i("../../libs/elements/src/icon/vl-icon.element.ts"),i("../../libs/elements/src/text/vl-text.element.ts");let o={id:"elements-input-group",title:"Elements/input-group",tags:["autodocs"],parameters:{controls:{hideNoControlsWarning:!0}}},u=()=>(0,e.qy)`
...
`;u.storyName="vl-input-group - default";let p=()=>(0,e.qy)`
    <div is="vl-input-group" data-cy="input-group">
        <input is="vl-input-field" type="text" />
        <button is="vl-button-input-addon" type="button">
            <span is="vl-icon" data-vl-icon="location"></span>
...
`;p.storyName="vl-input-group - with input addon right";let s=()=>(0,e.qy)`
    <div is="vl-input-group" data-cy="input-group">
        <button is="vl-button" type="button">Locatie kiezen</button>
        <input is="vl-input-field" type="text" />
    </div>
`;s.storyName="vl-input-group - with text addon left";let a=()=>(0,e.qy)`
    <div is="vl-input-group" data-cy="input-group">
        <input is="vl-input-field" type="text" />
        <button is="vl-button" type="button">Locatie kiezen</button>
    </div>
`;a.storyName="vl-input-group - with text addon right";let l=()=>(0,e.qy)`
    <div is="vl-input-group" data-cy="input-group">
