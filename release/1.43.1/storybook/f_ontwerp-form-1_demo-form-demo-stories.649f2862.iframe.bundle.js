"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[729],{"./docs/f_ontwerp/form/1_demo/form-demo.stories.ts":(e,t,l)=>{l.r(t),l.d(t,{Demo:()=>C,__namedExportsOrder:()=>R,default:()=>O});var r=l("../../node_modules/lit-html/lit-html.js"),o=l("../../libs/common/utilities/src/index.ts"),n=l("../../libs/components/src/next/button/index.ts"),s=l("../../libs/components/src/next/text/vl-text.component.ts"),i=l("../../libs/elements/src/index.ts"),a=l("../../libs/form/src/next/checkbox/vl-checkbox.component.ts"),c=l("../../libs/form/src/next/datepicker/vl-datepicker.component.ts"),d=l("../../libs/form/src/next/error-message/index.ts"),m=l("../../libs/form/src/next/form-label/index.ts"),v=l("../../libs/form/src/next/input-field/index.ts"),u=l("../../libs/form/src/next/input-field-masked/vl-input-field-masked.component.ts"),h=l("../../libs/form/src/next/radio-group/vl-radio.component.ts"),b=l("../../libs/form/src/next/radio-group/vl-radio-group.component.ts"),p=l("../../libs/form/src/next/select/index.ts"),f=l("../../libs/form/src/next/select-rich/index.ts"),x=l("../../libs/form/src/next/textarea/vl-textarea.component.ts"),g=l("../../libs/form/src/next/upload/vl-upload.component.ts"),k=l("../../libs/form/src/utils/index.ts"),w=l("../../node_modules/lit/index.js");class y extends w.WF{static{(0,o.gy)([m.E,v.Y,u.j,x.m,c.M,f.A,p.Y,b.I,h.Z,g.f,a.v,d.X,n.Y,s.T])}static get styles(){return[i.hF,(0,w.AH)`
                form {
                    margin-top: 1rem;
                    max-width: 800px;
                }
...
`;var a=l("../../libs/components/src/next/text/vl-text.defaults.ts");class c extends r.jW{static get styles(){return[i]}static get properties(){return{bold:{type:Boolean},italic:{type:Boolean},underline:{type:Boolean},success:{type:Boolean},warning:{type:Boolean},error:{type:Boolean},annotation:{type:Boolean},small:{type:Boolean}}}render(){let e={"vl-text-next--bold":this.bold,"vl-text-next--italic":this.italic,"vl-text-next--underline":this.underline,"vl-text-next--success":this.success,"vl-text-next--warning":this.warning,"vl-text-next--error":this.error,"vl-text-next--annotation":this.annotation,"vl-text-next--small":this.small};return(0,o.qy)`
            <span class="vl-text-next ${(0,n.H)(e)}">
                <slot></slot>
            </span>
        `}constructor(...e){super(...e),this.bold=a.O.bold,this.italic=a.O.italic,this.underline=a.O.underline,this.success=a.O.success,this.warning=a.O.warning,this.error=a.O.error,this.annotation=a.O.annotation,this.small=a.O.small}}c=function(e,t,l,r){var o,n=arguments.length,s=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,l):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,r);else for(var i=e.length-1;i>=0;i--)(o=e[i])&&(s=(n<3?o(s):n>3?o(t,l,s):o(t,l))||s);return n>3&&s&&Object.defineProperty(t,l,s),s}([(0,r.M1)("vl-text-next")],c)},"../../libs/components/src/next/text/vl-text.defaults.ts":(e,t,l)=>{l.d(t,{O:()=>r});let r={bold:!1,italic:!1,underline:!1,success:!1,warning:!1,error:!1,annotation:!1,small:!1}},"../../libs/form/src/next/checkbox/vl-checkbox.component.ts":(e,t,l)=>{l.d(t,{v:()=>v});var r=l("../../libs/common/utilities/src/index.ts"),o=l("../../libs/elements/src/index.ts"),n=l("../../node_modules/@domg/govflanders-style/common/index.js"),s=l("../../node_modules/@domg/govflanders-style/component/index.js"),i=l("../../node_modules/lit/index.js"),a=l("../../node_modules/lit/directives/class-map.js"),c=l("../../libs/form/src/next/form-control/form-control.ts");let d=(0,i.AH)`
    :host {
...
`},"../../libs/form/src/next/radio-group/vl-radio.defaults.ts":(e,t,l)=>{l.d(t,{Q:()=>r});let r={id:"radio",name:"",value:null,label:"",block:!1,readonly:!1,disabled:!1,error:!1,success:!1,checked:!1}},"../../libs/form/src/next/select-rich/index.ts":(e,t,l)=>{l.d(t,{A:()=>r.Al});var r=l("../../libs/form/src/next/select-rich/vl-select-rich.component.ts");l("../../libs/form/src/next/select-rich/vl-select-rich.model.ts")},"../../libs/form/src/next/select/index.ts":(e,t,l)=>{l.d(t,{Y:()=>r.Y});var r=l("../../libs/form/src/next/select/vl-select.component.ts")},"../../libs/form/src/next/select/vl-select.component.ts":(e,t,l)=>{l.d(t,{Y:()=>u});var r=l("../../libs/common/utilities/src/index.ts"),o=l("../../node_modules/@domg/govflanders-style/common/index.js"),n=l("../../node_modules/@domg/govflanders-style/component/index.js"),s=l("../../node_modules/lit/index.js"),i=l("../../node_modules/lit/directives/class-map.js"),a=l("../../node_modules/lit/directives/live.js"),c=l("../../libs/form/src/next/form-control/form-control.ts");let d=(0,s.AH)`
    .vl-select {
        background-color: #fff;
        appearance: none;
