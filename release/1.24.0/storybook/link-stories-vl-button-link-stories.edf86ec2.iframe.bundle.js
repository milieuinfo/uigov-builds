"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[2741],{"./libs/elements/src/link/stories/vl-button-link.stories.ts":(a,t,e)=>{e.r(t),e.d(t,{__namedExportsOrder:()=>i,buttonLinkDefault:()=>r,buttonLinkWithIcon:()=>s,default:()=>o});var l=e("./node_modules/lit-html/lit-html.js"),n=e("./libs/elements/src/link/stories/vl-link.stories-arg.ts");e("./libs/elements/src/link/vl-button-link.element.ts"),e("./libs/elements/src/icon/vl-icon.element.ts");let o={title:"Elements/link/button-link",tags:["autodocs"],args:n.Fr,argTypes:n.QK},r=({block:a,error:t,content:e,inline:n,small:o,large:r,bold:s})=>(0,l.dy)` <button
        is="vl-button-link"
        ?data-vl-block=${a}
        ?data-vl-error=${t}
        ?data-vl-inline=${n}
