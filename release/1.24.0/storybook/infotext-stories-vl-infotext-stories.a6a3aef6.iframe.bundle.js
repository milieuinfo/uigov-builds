"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[2568],{"./libs/elements/src/infotext/stories/vl-infotext.stories.ts":(e,t,a)=>{a.r(t),a.d(t,{__namedExportsOrder:()=>o,default:()=>s,infotextDefault:()=>i,infotextWithComplexContent:()=>l,infotextWithLink:()=>d});var n=a("./node_modules/lit-html/lit-html.js");a("./libs/elements/src/infotext/vl-infotext.element.ts");let s={title:"Elements/infotext",tags:["autodocs"],args:{badge:!1},argTypes:{badge:{name:"data-vl-badge",type:{summary:"boolean"},description:"Attribute gets used to create a badge styling.",table:{defaultValue:{summary:"false"}}}},parameters:{controls:{hideNoControlsWarning:!0}}},i=({badge:e})=>(0,n.dy)`
...
`;i.storyName="vl-infotext - default";let d=({badge:e})=>(0,n.dy)`
...
`;d.storyName="vl-infotext - with link";let l=()=>(0,n.dy)`
