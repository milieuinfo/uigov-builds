...
`;u.storyName="vl-multiselect - default";let m=({block:e,error:t,success:o,disabled:l})=>(0,n.qy)`
    <select
        is="vl-multiselect"
        ?data-vl-block=${e}
        ?data-vl-error=${t}
...
`;m.storyName="vl-multiselect - predefined option";let p=({block:e,error:t,success:o,disabled:l})=>(0,n.qy)`
    <select
        is="vl-multiselect"
        ?data-vl-block=${e}
        ?data-vl-error=${t}
