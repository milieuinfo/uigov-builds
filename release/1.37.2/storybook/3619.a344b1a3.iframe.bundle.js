"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[3619],{"../../libs/map/src/actions/map-actions.uig-css.ts":(e,t,o)=>{o.d(t,{A:()=>r});var n=o("../../node_modules/lit/index.js");let r=(0,n.AH)`
    @charset "UTF-8";
    :root {
...
`,...A.hF,k,x.A];class z extends(0,n.H3)(HTMLElement){static get _observedClassAttributes(){return["no-border","full-height"]}get _classPrefix(){return"vl-map--"}constructor(){super(`
          <style>
           ${L}
          </style>
          <div id='map'>
