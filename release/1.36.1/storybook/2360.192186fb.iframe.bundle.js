(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[2360],{"./node_modules/memoizerific sync recursive":e=>{function o(e){var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}o.keys=()=>[],o.resolve=o,o.id="./node_modules/memoizerific sync recursive",e.exports=o},"./libs/common/utilities/src/css/global-styles-decorator.ts":(e,o,n)=>{"use strict";n.d(o,{Q:()=>g});var t=n("./node_modules/lit/index.js");let c=(0,t.iv)`
    :root {
        --vl-white: #ffffff;
...
`;var l="https://cdn.omgeving.vlaanderen.be/domg/govflanders-font/22.0.2",f="FlandersArtSans",v="FlandersArtSerif",b="vlaanderen-icon-classic",a="".concat(l,"/iconfont/").concat(b);let F=(0,t.iv)`
    :root {
        /* Flanders font */
        --vl-font: ${(0,t.$m)(f)}, sans-serif;
        --vl-accent-font: ${(0,t.$m)(v)}, serif;
        ...
        /* Icon font */
        --vl-icon-font: ${(0,t.$m)(b)};
    }
`,s=(e,o,n,c)=>(0,t.iv)`
    @font-face {
        font-family: ${(0,t.$m)(e)};
        src: url(${(0,t.$m)(`${o}.woff2`)}) format('woff2'),
            url(${(0,t.$m)(`${o}.woff`)}) format('woff');
        font-weight: ${(0,t.$m)(n)};
        font-style: ${(0,t.$m)(c)};
    }
`,d=(0,t.iv)`
    ...
    /* Icon font */
    ${s(b,a,"normal","normal")}
`;var m=n("./libs/common/utilities/src/css/mixin/media-queries.mixin.css.ts");let u=[c,r,i,F,d,(0,t.iv)`
    html {
...
`];class h{static{this.registered=!1}static register(){this.registered||(document.adoptedStyleSheets=[...document.adoptedStyleSheets,...u.map(e=>e.styleSheet)],this.registered=!0,console.log("RegisterGlobalStyles: global styling toegevoegd aan het document"))}}let g=()=>e=>{h.register()}},"./libs/common/utilities/src/css/icon/icon.css.ts":(e,o,n)=>{"use strict";n.d(o,{Z:()=>i});var t=n("./node_modules/lit/index.js");let c=(0,t.iv)`
        ...
        `;var r=n("./libs/common/utilities/src/css/mixin/outline.mixin.css.ts");let i=(0,t.iv)`
    ${(0,t.$m)(c)}
...
`},"./libs/common/utilities/src/css/mixin/media-queries.mixin.css.ts":(e,o,n)=>{"use strict";n.d(o,{R:()=>c,Y:()=>r});var t=n("./node_modules/lit/index.js");let c=e=>(0,t.iv)`
...
`},"./libs/common/utilities/src/css/mixin/outline.mixin.css.ts":(e,o,n)=>{"use strict";n.d(o,{B:()=>c});var t=n("./node_modules/lit/index.js");let c=()=>(0,t.iv)`
    box-shadow: none;
