"use strict";(self.webpackChunkuigov_web_components=self.webpackChunkuigov_web_components||[]).push([[9867],{"./libs/map/src/components/legend/stories/vl-map-legend.stories.ts":(e,a,t)=>{t.r(a),t.d(a,{MapLegendCustomItems:()=>F,MapLegendFeaturesLayer:()=>L,MapLegendFeaturesLayerMultipleStyles:()=>z,MapLegendLayoutVertical:()=>O,MapLegendMultipleFeaturesLayers:()=>C,MapLegendWfsLayer:()=>S,MapLegendWmsLayer:()=>j,MapLegendWmsWfsLayer:()=>$,__namedExportsOrder:()=>k,default:()=>w}),t("./libs/map/src/vl-map.ts"),t("./libs/map/src/components/baselayer/vl-map-base-layer-grb-gray/vl-map-base-layer-grb-gray.ts"),t("./libs/map/src/components/layer-style/vl-map-layer-circle-style/vl-map-layer-circle-style.ts"),t("./libs/map/src/components/layer/vector-layer/vl-map-features-layer/vl-map-features-layer.ts");var r=t("./libs/map/src/components/legend/vl-map-legend.ts"),l=t("./libs/common/storybook/src/index.ts"),s=t("./node_modules/lit/index.js");t("./libs/map/src/components/layer-style/vl-map-layer-style.ts");let o={...l._O,bottom:"",left:"",placement:r.q.BOTTOM_RIGHT,right:"",top:"",layoutVertical:!1,hideTitle:!1,version:null},n={...(0,l.Wp)(),bottom:{name:"bottom",description:'Bepaalt de "bottom" positie van de legende op de kaart.<br>Kan gebruikt worden in combinatie met data-vl-placement.',table:{type:{summary:l.vK.STRING},category:l.aA.ATTRIBUTES,defaultValue:{summary:o.bottom}}},left:{name:"left",description:'Bepaalt de "left" positie van de legende op de kaart.<br>Kan gebruikt worden in combinatie met data-vl-placement.',table:{type:{summary:l.vK.STRING},category:l.aA.ATTRIBUTES,defaultValue:{summary:o.left}}},placement:{name:"data-vl-placement",description:"Bepaalt de plaats van de legende op de kaart.",control:{type:l.Hy.SELECT},options:Object.values(r.q),table:{type:{summary:(0,l.G_)(Object.values(r.q))},category:l.aA.ATTRIBUTES,defaultValue:{summary:o.placement}}},right:{name:"right",description:'Bepaalt de "right" positie van de legende op de kaart.<br>Kan gebruikt worden in combinatie met data-vl-placement.',table:{type:{summary:l.vK.STRING},category:l.aA.ATTRIBUTES,defaultValue:{summary:o.right}}},top:{name:"top",description:'Bepaalt de "top" positie van de legende op de kaart.<br>Kan gebruikt worden in combinatie met data-vl-placement.',table:{type:{summary:l.vK.STRING},category:l.aA.ATTRIBUTES,defaultValue:{summary:o.top}}},layoutVertical:{name:"data-vl-layout-vertical",description:"Zet de layout van de legende in verticale positie.",table:{type:{summary:l.vK.BOOLEAN},category:l.aA.ATTRIBUTES,defaultValue:{summary:o.layoutVertical}}},hideTitle:{name:"data-vl-hide-title",description:'Laat de "Legende" titel weg.',table:{type:{summary:l.vK.BOOLEAN},category:l.aA.ATTRIBUTES,defaultValue:{summary:o.hideTitle}}},version:{name:"data-vl-version",description:'Voeg een "version" parameter toe aan de legende url.',table:{type:{summary:l.vK.STRING},category:l.aA.ATTRIBUTES,defaultValue:{summary:o.version}}}},d=()=>{document.addEventListener("DOMContentLoaded",async()=>{let e=document.getElementById("map");await e?.ready,document.querySelector("#style-1").appliesTo=e=>"style-1"===e.get("styleId"),document.querySelector("#style-2").appliesTo=e=>"style-2"===e.get("styleId"),document.querySelector("#style-3").appliesTo=e=>"style-3"===e.get("styleId")})},i=(0,l.yg)(o,({bottom:e,left:a,placement:t,right:r,top:l,layoutVertical:o})=>(d(),(0,s.dy)` <vl-map id="map">
        ...
        <vl-map-legend
            ...
            left=${a}
        ></vl-map-legend>
    </vl-map>`));var m=t("./node_modules/lit-html/lit-html.js");let p=(0,l.yg)(o,({bottom:e,left:a,placement:t,right:r,top:l,layoutVertical:s,hideTitle:o})=>(0,m.dy)` <vl-map id="map">
        <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
        ...
        <vl-map-legend
            ...
            left=${a}
        ></vl-map-legend>
    </vl-map>`);t("./libs/map/src/components/layer/vector-layer/vl-map-wfs-layer/vl-map-wfs-layer.ts");let y=(0,l.yg)(o,({bottom:e,left:a,placement:t,right:r,top:l,layoutVertical:o})=>(0,s.dy)`
        <vl-map>
            <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
            <vl-map-wfs-layer
    ...
    `),u=(0,l.yg)(o,({bottom:e,left:a,placement:t,right:r,top:l,layoutVertical:o})=>(0,s.dy)`
        <vl-map>
            <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
    ...
    `),v=(0,l.yg)(o,({bottom:e,left:a,placement:t,right:r,top:l,layoutVertical:o})=>(0,s.dy)`
        <vl-map>
            <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
            <vl-map-tiled-wms-layer
                data-vl-layers="grondwater:beschermingszones_2014"
    ...
    `);t("./libs/map/src/components/legend-item/vl-map-legend-item.ts");let g=(0,l.yg)(o,({bottom:e,left:a,placement:t,right:r,top:l,layoutVertical:s})=>(0,m.dy)` <vl-map>
        <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
        <vl-map-action-controls>
            <vl-map-measure-control></vl-map-measure-control>
        </vl-map-action-controls>
    ...
    </vl-map>`);t("./libs/map/src/components/layer/wms-layer/vl-map-tiled-wms-layer/vl-map-tiled-wms-layer.ts");let b=(0,l.yg)(o,({bottom:e,left:a,placement:t,right:r,top:l})=>(d(),(0,s.dy)`
        <vl-map>
            <vl-map-baselayer-grb-gray></vl-map-baselayer-grb-gray>
            <vl-map-tiled-wms-layer
                data-vl-layers="grondwater:beschermingszones_2014"
