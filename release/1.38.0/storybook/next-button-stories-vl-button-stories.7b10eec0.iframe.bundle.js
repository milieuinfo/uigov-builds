"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[1321],{"../../node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs":(n,e,o)=>{o.d(e,{f:()=>b});var t=o("../../node_modules/react/index.js"),r=o("../../node_modules/react-dom/client.js"),l=new Map,a=({callback:n,children:e})=>{let o=(0,t.useRef)();return(0,t.useLayoutEffect)(()=>{o.current!==n&&(o.current=n,n())},[n]),e},i=async(n,e)=>{let o=await d(e);return new Promise(e=>{o.render(t.createElement(a,{callback:()=>e(null)},n))})},c=(n,e)=>{let o=l.get(n);o&&(o.unmount(),l.delete(n))},d=async n=>{let e=l.get(n);return e||(e=r.createRoot(n),l.set(n,e)),e},s=o("../../node_modules/@storybook/blocks/dist/index.mjs"),u={code:s.XA,a:s.zE,...s.Sw},g=class extends t.Component{constructor(){super(...arguments),this.state={hasError:!1}}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(n){let{showException:e}=this.props;e(n)}render(){let{hasError:n}=this.state,{children:e}=this.props;return n?null:t.createElement(t.Fragment,null,e)}},b=class{constructor(){this.render=async(n,e,r)=>{let l={...u,...e?.components},a=s.kQ;return new Promise((c,d)=>{o.e(814).then(o.bind(o,"../../node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/index.js")).then(({MDXProvider:o})=>i(t.createElement(g,{showException:d,key:Math.random()},t.createElement(o,{components:l},t.createElement(a,{context:n,docsParameter:e}))),r)).then(()=>c())})},this.unmount=n=>{c(n)}}}},"../../node_modules/@storybook/addon-docs/dist/index.mjs":(n,e,o)=>{o.d(e,{Hl:()=>t.Hl,W8:()=>t.W8,kL:()=>t.kL,ov:()=>t.ov}),o("../../node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs");var t=o("../../node_modules/@storybook/blocks/dist/index.mjs")},"../../libs/components/src/next/button/stories/vl-button.stories.ts":(n,e,o)=>{o.r(e),o.d(e,{ButtonBlock:()=>j,ButtonDisabled:()=>f,ButtonError:()=>w,ButtonIcon:()=>E,ButtonIconOnly:()=>O,ButtonLarge:()=>T,ButtonLoading:()=>V,ButtonNarrow:()=>B,ButtonPrimary:()=>h,ButtonSecondary:()=>x,ButtonTertiary:()=>k,ButtonToggle:()=>z,ButtonWide:()=>S,__namedExportsOrder:()=>A,default:()=>v});var t=o("../../libs/common/storybook/src/index.ts"),r=o("../../libs/common/utilities/src/constants/index.ts"),l=o("../../node_modules/@storybook/addon-actions/dist/index.mjs"),a=o("../../libs/components/src/next/button/vl-button.defaults.ts");let i={...t.D8,...a.j,defaultSlot:"",onVlClick:(0,l.XI)("vl-click"),onVlToggle:(0,l.XI)("vl-toggle")},c={...(0,t.RN)(!0),type:{name:"type",description:"Het type van de button.",table:{type:{summary:t.QE.STRING},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.type}}},disabled:{name:"disabled",description:"Duidt aan dat de button uitgeschakeld is.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.disabled}}},error:{name:"error",description:"Beeldt de button af als een error button.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.error}}},block:{name:"block",description:"Duidt aan dat de button de volledige breedte van zijn parent mag innemen.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.block}}},large:{name:"large",description:"Beeldt de button groot af.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.large}}},wide:{name:"wide",description:"Beeldt de button breed af.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.wide}}},narrow:{name:"narrow",description:"Beeldt de button smal af.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.narrow}}},secondary:{name:"secondary",description:"Beeldt de button af als een secondary button.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.secondary}}},tertiary:{name:"tertiary",description:"Beeldt de button af als een tertiary button.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.tertiary}}},loading:{name:"loading",description:"Beeldt de button af als een loading button.<br/>We raden aan dit enkel te gebruiken voor primary buttons.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.loading}}},icon:{name:"icon",description:"Beeldt een icoon af in de button.<br/>Standaard wordt dit icoon voor de tekst afgebeeld.",table:{type:{summary:t.QE.STRING},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.icon}}},iconPlacement:{name:"icon-placement",description:"De positie van het icoon ten opzichte van de tekst.",control:{type:t.VH.SELECT},options:Object.values(r.aK),table:{type:{summary:(0,t.uf)(Object.values(r.aK))},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.iconPlacement}}},iconOnly:{name:"icon-only",description:"Beeldt de button correct af als er enkel een icoon is en geen tekst.<br/>Te gebruiken in combinatie met het `icon` attribuut.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.iconOnly}}},toggle:{name:"toggle",description:"Beeldt de button af als een toggle button.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.toggle}}},on:{name:"on",description:"Duidt aan dat de toggle button aan staat.<br>Te gebruiken in combinatie met het `toggle` attribuut.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.on}}},controlled:{name:"controlled",description:"Duidt aan dat de state van de toggle button gecontroleerd wordt door een parent component.<br>De button zal zijn eigen `on` attribuut niet veranderen.<br>Te gebruiken in combinatie met het `toggle` attribuut.",table:{type:{summary:t.QE.BOOLEAN},category:t.R6.ATTRIBUTES,defaultValue:{summary:i.controlled}}},defaultSlot:{name:"[default]",description:"De content van de button.",table:{type:{summary:t.QE.HTML},category:t.R6.SLOTS,defaultValue:{summary:i.defaultSlot}}},onVlClick:{name:"vl-click",description:"Event dat afgevuurd wordt bij het klikken op de button.",table:{category:t.R6.EVENTS}},onVlToggle:{name:"vl-toggle",description:"Event dat afgevuurd wordt als het `on` attribuut van de button verandert.",table:{type:{summary:"{ on: boolean }"},category:t.R6.EVENTS}}};var d=o("../../node_modules/lit/index.js"),s=o("../../libs/components/src/next/button/vl-button.component.ts"),u=o("../../libs/common/utilities/src/index.ts"),g=o("../../node_modules/lit/directives/unsafe-html.js");o("../../node_modules/react/index.js");var b=o("../../node_modules/react/jsx-runtime.js"),m=o("../../node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),p=o("../../node_modules/@storybook/addon-docs/dist/index.mjs");function y(n){let e=Object.assign({h1:"h1",p:"p",code:"code",a:"a",h2:"h2",pre:"pre",h3:"h3"},(0,m.RP)(),n.components),{VluxMetaData:o}=e;return o||function(n,e){throw Error("Expected "+(e?"component":"object")+" `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}("VluxMetaData",!0),(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(e.h1,{id:"button---next",children:"Button - next"}),"\n",(0,b.jsx)(o,{id:"components-next-button"}),"\n",(0,b.jsxs)(e.p,{children:["Gebruik de ",(0,b.jsx)(e.code,{children:"button-next"})," component om een button af te beelden op een pagina."]}),"\n",(0,b.jsxs)(e.p,{children:["Dit component is de volgende versie van de ",(0,b.jsx)(e.a,{href:"/docs/elements-button-button--documentatie",children:"vl-button"})," component."]}),"\n",(0,b.jsx)(e.h2,{id:"voorbeeld",children:"Voorbeeld"}),"\n",(0,b.jsx)(e.pre,{children:(0,b.jsx)(e.code,{className:"language-js",children:"import { VlButtonComponent } from '@domg-wc/components/next/button';\n"})}),"\n",(0,b.jsx)(e.pre,{children:(0,b.jsx)(e.code,{className:"language-html",children:"<vl-button-next></vl-button-next>\n"})}),"\n",(0,b.jsx)(p.Hl,{of:h}),"\n",(0,b.jsx)(e.h2,{id:"configuratie",children:"Configuratie"}),"\n",(0,b.jsx)(p.ov,{of:h}),"\n",(0,b.jsx)(e.h2,{id:"varianten",children:"Varianten"}),"\n",(0,b.jsx)(e.h3,{id:"secondary",children:"Secondary"}),"\n",(0,b.jsx)(e.p,{children:"Gebruik een secondary button om een 1 of meerdere buttons af te beelden in combinatie met een primary button."}),"\n",(0,b.jsx)(p.Hl,{of:x}),"\n",(0,b.jsx)(e.h3,{id:"tertiary",children:"Tertiary"}),"\n",(0,b.jsxs)(e.p,{children:["Gebruik een tertiary button om een 1 of meerdere buttons af te beelden in combinatie met een primary button.",(0,b.jsx)("br",{}),"\nEen tertiary button is subtieler dan een secondary button."]}),"\n",(0,b.jsx)(p.Hl,{of:k}),"\n",(0,b.jsx)(e.h3,{id:"disabled",children:"Disabled"}),"\n",(0,b.jsx)(e.p,{children:"Gebruik een disabled button om aan te tonen dat een actie niet uitgevoerd kan worden."}),"\n",(0,b.jsx)(p.Hl,{of:f}),"\n",(0,b.jsx)(e.h3,{id:"error",children:"Error"}),"\n",(0,b.jsx)(e.p,{children:"Gebruik een error button om de belangrijkheid van een actie aan te tonen."}),"\n",(0,b.jsx)(p.Hl,{of:w}),"\n",(0,b.jsx)(e.h3,{id:"block",children:"Block"}),"\n",(0,b.jsx)(p.Hl,{of:j}),"\n",(0,b.jsx)(e.h3,{id:"large",children:"Large"}),"\n",(0,b.jsx)(p.Hl,{of:T}),"\n",(0,b.jsx)(e.h3,{id:"wide",children:"Wide"}),"\n",(0,b.jsx)(p.Hl,{of:S}),"\n",(0,b.jsx)(e.h3,{id:"narrow",children:"Narrow"}),"\n",(0,b.jsx)(p.Hl,{of:B}),"\n",(0,b.jsx)(e.h3,{id:"loading",children:"Loading"}),"\n",(0,b.jsxs)(e.p,{children:["Gebruik een loading button om aan te tonen dat een actie enige tijd in beslag neemt.",(0,b.jsx)("br",{}),"\nGedurende het uitvoeren van de actie kan je de button als een loading button afbeelden.",(0,b.jsx)("br",{}),"\nWe raden aan een loading button enkel te gebruiken voor primary buttons.",(0,b.jsx)("br",{}),"\nIndien je wil dat de loading button ook disabled is, kan je het ",(0,b.jsx)(e.code,{children:"disabled"})," attribuut in combinatie met het ",(0,b.jsx)(e.code,{children:"loading"})," attribuut gebruiken."]}),"\n",(0,b.jsx)(p.Hl,{of:V}),"\n",(0,b.jsx)(e.h3,{id:"icoon",children:"Icoon"}),"\n",(0,b.jsx)(p.Hl,{of:E}),"\n",(0,b.jsx)(e.h3,{id:"enkel-icoon",children:"Enkel icoon"}),"\n",(0,b.jsx)(p.Hl,{of:O}),"\n",(0,b.jsx)(e.h3,{id:"toggle",children:"Toggle"}),"\n",(0,b.jsxs)(e.p,{children:["Gebruik een toggle button om aan te duiden dat een actie aan of uit staat.",(0,b.jsx)("br",{}),"\nDe button wordt aan- of uitgezet door er op te klikken.",(0,b.jsx)("br",{}),"\nGebruik het ",(0,b.jsx)(e.code,{children:"on"})," attribuut om de button programmatorisch aan- of uit te zetten.",(0,b.jsx)("br",{}),"\nGebruik het ",(0,b.jsx)(e.code,{children:"controlled"})," attribuut als je wil dat de button zich niet zelf aan- of uitzet, gebruik dan het ",(0,b.jsx)(e.code,{children:"on"})," attribuut om de button aan- of uit te zetten."]}),"\n",(0,b.jsx)(p.Hl,{of:z}),"\n",(0,b.jsx)(e.h2,{id:"referenties",children:"Referenties"}),"\n",(0,b.jsx)(e.h3,{id:"digitaal-vlaanderen",children:"Digitaal Vlaanderen"}),"\n",(0,b.jsx)(e.p,{children:(0,b.jsx)(e.a,{href:"https://overheid.vlaanderen.be/webuniversum/v3/documentation/atoms/vl-ui-button",target:"_blank",rel:"nofollow noopener noreferrer",children:"Documentatie Digitaal Vlaanderen - Button"})})]})}(0,u.gy)([s.Y]);let v={id:"components-next-button",title:"Components-next/button",tags:["autodocs"],args:i,argTypes:c,parameters:{docs:{page:function(n={}){let{wrapper:e}=Object.assign({},(0,m.RP)(),n.components);return e?(0,b.jsx)(e,Object.assign({},n,{children:(0,b.jsx)(y,n)})):y(n)}}}},$=(0,t._7)(i,({type:n,disabled:e,error:o,block:t,large:r,wide:l,narrow:a,secondary:i,tertiary:c,loading:s,icon:u,iconPlacement:b,iconOnly:m,toggle:p,on:y,controlled:v,defaultSlot:$,onVlClick:h,onVlToggle:x})=>(0,d.qy)`
        <vl-button-next
            type=${n}
            ?disabled=${e}
            ?error=${o}
    ...
    `),h=$.bind({});h.storyName="vl-button-next - primary",h.args={defaultSlot:"Klik op mij"};let x=$.bind({});x.storyName="vl-button-next - secondary",x.args={defaultSlot:"Klik op mij",secondary:!0};let k=$.bind({});k.storyName="vl-button-next - tertiary",k.args={defaultSlot:"Klik op mij",tertiary:!0};let f=$.bind({});f.storyName="vl-button-next - disabled",f.args={defaultSlot:"Klik op mij",disabled:!0};let w=$.bind({});w.storyName="vl-button-next - error",w.args={defaultSlot:"Klik op mij",error:!0};let j=$.bind({});j.storyName="vl-button-next - block",j.args={defaultSlot:"Klik op mij",block:!0};let T=$.bind({});T.storyName="vl-button-next - large",T.args={defaultSlot:"Klik op mij",large:!0};let S=$.bind({});S.storyName="vl-button-next - wide",S.args={defaultSlot:"Klik op mij",wide:!0};let B=$.bind({});B.storyName="vl-button-next - narrow",B.args={defaultSlot:"Klik op mij",narrow:!0};let V=$.bind({});V.storyName="vl-button-next - loading",V.args={defaultSlot:"Klik op mij",loading:!0};let E=$.bind({});E.storyName="vl-button-next - icon",E.args={defaultSlot:"Klik op mij",icon:"location"};let O=$.bind({});O.storyName="vl-button-next - icon only",O.args={icon:"location",iconOnly:!0};let z=$.bind({});z.storyName="vl-button-next - toggle",z.args={defaultSlot:"Klik op mij",toggle:!0},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...h.parameters?.docs?.source}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...x.parameters?.docs?.source}}},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...k.parameters?.docs?.source}}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...f.parameters?.docs?.source}}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...w.parameters?.docs?.source}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...j.parameters?.docs?.source}}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...T.parameters?.docs?.source}}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...S.parameters?.docs?.source}}},B.parameters={...B.parameters,docs:{...B.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...B.parameters?.docs?.source}}},V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...V.parameters?.docs?.source}}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...E.parameters?.docs?.source}}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...O.parameters?.docs?.source}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:"story(buttonArgs, ({\n  type,\n  disabled,\n  error,\n  block,\n  large,\n  wide,\n  narrow,\n  secondary,\n  tertiary,\n  loading,\n  icon,\n  iconPlacement,\n  iconOnly,\n  toggle,\n  on,\n  controlled,\n  defaultSlot,\n  onVlClick,\n  onVlToggle\n}) => html`\n        <vl-button-next\n            type=${type}\n            ?disabled=${disabled}\n            ?error=${error}\n            ?block=${block}\n            ?large=${large}\n            ?wide=${wide}\n            ?narrow=${narrow}\n            ?secondary=${secondary}\n            ?tertiary=${tertiary}\n            ?loading=${loading}\n            icon=${icon}\n            icon-placement=${iconPlacement}\n            ?icon-only=${iconOnly}\n            ?toggle=${toggle}\n            ?on=${on}\n            ?controlled=${controlled}\n            @vl-click=${onVlClick}\n            @vl-toggle=${onVlToggle}\n        >\n            ${unsafeHTML(defaultSlot)}\n        </vl-button-next>\n    `)",...z.parameters?.docs?.source}}};let A=["ButtonPrimary","ButtonSecondary","ButtonTertiary","ButtonDisabled","ButtonError","ButtonBlock","ButtonLarge","ButtonWide","ButtonNarrow","ButtonLoading","ButtonIcon","ButtonIconOnly","ButtonToggle"]},"../../node_modules/lit/directives/unsafe-html.js":(n,e,o)=>{o.d(e,{_:()=>a});var t=o("../../node_modules/lit-html/lit-html.js"),r=o("../../node_modules/lit-html/directive.js");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class l extends r.WL{constructor(n){if(super(n),this.et=t.s6,n.type!==r.OA.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(n){if(n===t.s6||null==n)return this.vt=void 0,this.et=n;if(n===t.c0)return n;if("string"!=typeof n)throw Error(this.constructor.directiveName+"() called with a non-string value");if(n===this.et)return this.vt;this.et=n;var e=[n];return e.raw=e,this.vt={_$litType$:this.constructor.resultType,strings:e,values:[]}}}l.directiveName="unsafeHTML",l.resultType=1;var a=(0,r.u$)(l)},"../../node_modules/react-dom/client.js":(n,e,o)=>{var t=o("../../node_modules/react-dom/index.js");e.createRoot=t.createRoot,e.hydrateRoot=t.hydrateRoot},"../../libs/common/utilities/src/constants/index.ts":(n,e,o)=>{o.d(e,{J3:()=>t.J3,aK:()=>t.aK,qm:()=>t.qm});var t=o("../../libs/common/utilities/src/constants/constants.ts")},"../../libs/components/src/next/button/vl-button.component.ts":(n,e,o)=>{o.d(e,{Y:()=>y});var t=o("../../libs/common/utilities/src/index.ts"),r=o("../../libs/common/utilities/src/css/global-styles-decorator.ts"),l=o("../../libs/common/utilities/src/css/icon/icon.css.ts"),a=o("../../node_modules/lit/index.js"),i=o("../../node_modules/lit/directives/class-map.js"),c=o("../../libs/common/utilities/src/css/mixin/media-queries.mixin.css.ts"),d=o("../../libs/common/utilities/src/css/mixin/outline.mixin.css.ts");let s="0.2rem",u="0.1rem",g=`calc(${s} - ${u})`,b="waving-light",m=(0,a.AH)`
...
`)(b,"var(--vl-action-color--disabled)")}
    ...
    button {
        ...
        border: ${(0,a.iz)(s)} solid var(--vl-action-color);
        ...
        &.secondary {
            ...
            background-color: transparent;
            border: ${(0,a.iz)(s)} solid currentColor;
        ...
        &.loading {
            ...
            &::after {
                animation: ${(0,a.iz)(b)} infinite 1s linear;
                content: '';
                display: block;
                position: absolute;
                top: 50%;
