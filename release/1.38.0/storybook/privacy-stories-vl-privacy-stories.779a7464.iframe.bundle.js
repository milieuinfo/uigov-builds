"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[2567],{"../../libs/sections/src/privacy/stories/vl-privacy.stories.ts":(e,n,i)=>{i.r(n),i.d(n,{PrivacyDefault:()=>V,PrivacyHeaderSlot:()=>x,__namedExportsOrder:()=>A,default:()=>D});var a=i("../../node_modules/lit-html/lit-html.js"),r=i("../../node_modules/lit/directives/unsafe-html.js"),t=i("../../libs/common/utilities/src/index.ts"),o=i("../../libs/components/src/index.ts"),d=i("../../libs/elements/src/index.ts"),v=i("../../node_modules/lit/index.js"),s=i("../../node_modules/lit/decorators.js");let l=()=>[o.a7],g=({disableBackLink:e})=>(0,v.qy)`
    ...
    ></vl-functional-header>
`,p={date:"data-vl-date",disableBackLink:"data-vl-disable-back-link",version:"data-vl-version"},{date:c,disableBackLink:m,version:h}=p;class k extends t.jW{static{(0,t.gy)([d.D,d.dI,d.mq,d.xf,d.e$,d.tk,d.yF,d.Z$,d.zY,d.nJ,d.Lp,d.mR,d.io,d.RC,d.Q1,d.i$,d.hg,d.$I,d.Vg,d.$q,d.xC,d.gs,o.Y4,o.FQ,o.Pq,o.Ic,...l()])}static get properties(){return{[c]:{type:String},[m]:{type:Boolean},[h]:{type:String}}}constructor(){super(),this.allowCustomCSS=!1,this[c]="3 maart 2021",this[m]=!1,this[h]="1.0.0"}render(){return(0,v.qy)`
            <style>
                ${d.hF}
            </style>
            <slot name="header">${g(p)}</slot>
                    ...
                    <div is="vl-grid" data-vl-is-stacked>
                        ...
                        <div is="vl-column" data-vl-size="10">
                            <p is="vl-introduction">
                                <span>Versie</span>
                                <span id="introduction-version">${this[h]}</span> -
                                <span id="introduction-date">${this[c]}</span>
                            </p>
                        </div>
    ...
    `),V=O.bind({});V.storyName="vl-privacy - default";let x=O.bind({});x.storyName="vl-privacy - header slot",x.args={headerSlot:`
    <vl-functional-header
        slot="header"
        data-vl-title="Departement Omgeving"
        data-vl-sub-title="Privacy"
        ...
        data-vl-back="Start"
    ></vl-functional-header>
`},V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:"story(privacyArgs, ({\n  date,\n  disableBackLink,\n  version,\n  onClickBack,\n  headerSlot\n}) => html`\n        <vl-privacy\n            data-vl-date=${date}\n            ?data-vl-disable-back-link=${disableBackLink}\n            data-vl-version=${version}\n            @vl-click-back=${onClickBack}\n        >\n            ${unsafeHTML(headerSlot)}\n        </vl-privacy>\n    `)",...V.parameters?.docs?.source}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:"story(privacyArgs, ({\n  date,\n  disableBackLink,\n  version,\n  onClickBack,\n  headerSlot\n}) => html`\n        <vl-privacy\n            data-vl-date=${date}\n            ?data-vl-disable-back-link=${disableBackLink}\n            data-vl-version=${version}\n            @vl-click-back=${onClickBack}\n        >\n            ${unsafeHTML(headerSlot)}\n        </vl-privacy>\n    `)",...x.parameters?.docs?.source}}};let A=["PrivacyDefault","PrivacyHeaderSlot"]},"../../node_modules/lit/directives/unsafe-html.js":(e,n,i)=>{i.d(n,{_:()=>o});var a=i("../../node_modules/lit-html/lit-html.js"),r=i("../../node_modules/lit-html/directive.js");/**
 * @license
