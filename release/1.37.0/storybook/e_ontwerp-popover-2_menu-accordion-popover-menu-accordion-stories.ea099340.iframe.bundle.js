...
`,u=`
    ...
    .js-vl-accordion--open > .vl-accordion__button-container {padding: 15px 15px 0 15px}
    .vl-accordion__subtitle {margin: 0;}
`;class m extends s.WF{static{(0,c.gy)([v.iT,v.cW,v.nW])}static get styles(){return[p.hF,(0,s.AH)``]}render(){return(0,s.qy)`
            <style>
                .laaginfo {
                    display: flex;
                }
            ...
            <div class="panel">
                <vl-accordion data-vl-toggle-text="Stedelijk woongebied" data-vl-custom-css=${d}>
                    <span class="laaginfo">
                        <div class="laaginfo__image">
                            <img is="vl-image" class="laaginfo__image" src="cat.jpeg" alt="Example image" />
                        </div>
