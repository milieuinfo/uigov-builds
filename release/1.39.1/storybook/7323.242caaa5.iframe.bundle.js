"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[7323],{"../../libs/common/utilities/src/css/global-styles-decorator.ts":(e,o,n)=>{n.d(o,{n:()=>g});var t=n("../../node_modules/lit/index.js");let c=(0,t.AH)`
    :root {
        --vl-white: #ffffff;
...
`;var i="https://cdn.omgeving.vlaanderen.be/domg/govflanders-font/22.0.2",f="FlandersArtSans",v="FlandersArtSerif",b="vlaanderen-icon-classic",a="".concat(i,"/iconfont/").concat(b);let F=(0,t.AH)`
    :root {
        /* Flanders font */
...
`,d=(0,t.AH)`
    /* Flanders font */
    ${s(f,`${i}/flanders/sans/${f}-Light`,300,"normal")}
    ${s(f,`${i}/flanders/sans/${f}-Regular`,400,"normal")}
    ${s(f,`${i}/flanders/sans/${f}-Medium`,500,"normal")}
    ${s(f,`${i}/flanders/sans/${f}-Bold`,700,"normal")}

    ${s(f,`${i}/flanders/italic/${f}-Light`,300,"italic")}
    ${s(f,`${i}/flanders/italic/${f}-Regular`,400,"italic")}
    ${s(f,`${i}/flanders/italic/${f}-Medium`,500,"italic")}
    ${s(f,`${i}/flanders/italic/${f}-Bold`,700,"italic")}

    ${s(v,`${i}/flanders/serif/${v}-Light`,300,"normal")}
    ${s(v,`${i}/flanders/serif/${v}-Regular`,400,"normal")}
    ${s(v,`${i}/flanders/serif/${v}-Medium`,500,"normal")}
    ${s(v,`${i}/flanders/serif/${v}-Bold`,700,"normal")}

    /* Icon font */
    ${s(b,a,"normal","normal")}
`;var m=n("../../libs/common/utilities/src/css/mixin/media-queries.mixin.css.ts");let h=[c,r,l,F,d,(0,t.AH)`
    html {
...
`];class u{static{this.registered=!1}static register(){this.registered||(document.adoptedStyleSheets=[...document.adoptedStyleSheets,...h.map(e=>e.styleSheet)],this.registered=!0,console.log("RegisterGlobalStyles: global styling toegevoegd aan het document"))}}let g=()=>e=>{u.register()}},"../../libs/common/utilities/src/css/icon/icon.css.ts":(e,o,n)=>{n.d(o,{A:()=>l});var t=n("../../node_modules/lit/index.js");let c=(0,t.AH)`
        ...
        `;var r=n("../../libs/common/utilities/src/css/mixin/outline.mixin.css.ts");let l=(0,t.AH)`
    ${(0,t.iz)(c)}
...
`},"../../libs/common/utilities/src/css/mixin/media-queries.mixin.css.ts":(e,o,n)=>{n.d(o,{M:()=>r,i:()=>c});var t=n("../../node_modules/lit/index.js");let c=e=>(0,t.AH)`
...
`},"../../libs/common/utilities/src/css/mixin/outline.mixin.css.ts":(e,o,n)=>{n.d(o,{H:()=>c});var t=n("../../node_modules/lit/index.js");let c=()=>(0,t.AH)`
    box-shadow: none;
