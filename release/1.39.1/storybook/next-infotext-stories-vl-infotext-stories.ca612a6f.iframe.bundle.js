"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[977],{"../../node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs":(e,t,o)=>{o.d(t,{f:()=>f});var n=o("../../node_modules/react/index.js"),r=o("../../node_modules/react-dom/client.js"),l=new Map,a=({callback:e,children:t})=>{let o=(0,n.useRef)();return(0,n.useLayoutEffect)(()=>{o.current!==e&&(o.current=e,e())},[e]),t},s=async(e,t)=>{let o=await d(t);return new Promise(t=>{o.render(n.createElement(a,{callback:()=>t(null)},e))})},i=(e,t)=>{let o=l.get(e);o&&(o.unmount(),l.delete(e))},d=async e=>{let t=l.get(e);return t||(t=r.createRoot(e),l.set(e,t)),t},c=o("../../node_modules/@storybook/blocks/dist/index.mjs"),m={code:c.XA,a:c.zE,...c.Sw},u=class extends n.Component{constructor(){super(...arguments),this.state={hasError:!1}}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(e){let{showException:t}=this.props;t(e)}render(){let{hasError:e}=this.state,{children:t}=this.props;return e?null:n.createElement(n.Fragment,null,t)}},f=class{constructor(){this.render=async(e,t,r)=>{let l={...m,...t?.components},a=c.kQ;return new Promise((i,d)=>{o.e(814).then(o.bind(o,"../../node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/index.js")).then(({MDXProvider:o})=>s(n.createElement(u,{showException:d,key:Math.random()},n.createElement(o,{components:l},n.createElement(a,{context:e,docsParameter:t}))),r)).then(()=>i())})},this.unmount=e=>{i(e)}}}},"../../node_modules/@storybook/addon-docs/dist/index.mjs":(e,t,o)=>{o.d(t,{Hl:()=>n.Hl,W8:()=>n.W8,kL:()=>n.kL,ov:()=>n.ov}),o("../../node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs");var n=o("../../node_modules/@storybook/blocks/dist/index.mjs")},"../../libs/components/src/next/infotext/stories/vl-infotext.stories.ts":(e,t,o)=>{o.r(t),o.d(t,{InfotextBadge:()=>S,InfotextDefault:()=>j,InfotextLink:()=>k,__namedExportsOrder:()=>w,default:()=>y});var n=o("../../libs/common/storybook/src/index.ts"),r=o("../../node_modules/lit-html/lit-html.js"),l=o("../../libs/common/utilities/src/index.ts"),a=o("../../libs/common/utilities/src/css/global-styles-decorator.ts"),s=o("../../node_modules/lit/index.js"),i=o("../../node_modules/lit/directives/class-map.js"),d=o("../../libs/common/utilities/src/css/mixin/media-queries.mixin.css.ts");let c=(0,s.AH)`
    .vl-infotext {
        display: flex;
...
`;var s="https://cdn.omgeving.vlaanderen.be/domg/govflanders-font/22.0.2",i="FlandersArtSans",d="FlandersArtSerif",c="vlaanderen-icon-classic",m="".concat(s,"/iconfont/").concat(c);let u=(0,n.AH)`
    :root {
        /* Flanders font */
...
`,v=(0,n.AH)`
    /* Flanders font */
    ${f(i,`${s}/flanders/sans/${i}-Light`,300,"normal")}
    ${f(i,`${s}/flanders/sans/${i}-Regular`,400,"normal")}
    ${f(i,`${s}/flanders/sans/${i}-Medium`,500,"normal")}
    ${f(i,`${s}/flanders/sans/${i}-Bold`,700,"normal")}

    ${f(i,`${s}/flanders/italic/${i}-Light`,300,"italic")}
    ${f(i,`${s}/flanders/italic/${i}-Regular`,400,"italic")}
    ${f(i,`${s}/flanders/italic/${i}-Medium`,500,"italic")}
    ${f(i,`${s}/flanders/italic/${i}-Bold`,700,"italic")}

    ${f(d,`${s}/flanders/serif/${d}-Light`,300,"normal")}
    ${f(d,`${s}/flanders/serif/${d}-Regular`,400,"normal")}
    ${f(d,`${s}/flanders/serif/${d}-Medium`,500,"normal")}
    ${f(d,`${s}/flanders/serif/${d}-Bold`,700,"normal")}

    /* Icon font */
    ${f(c,m,"normal","normal")}
`;var h=o("../../libs/common/utilities/src/css/mixin/media-queries.mixin.css.ts");let x=[r,l,a,u,v,(0,n.AH)`
    html {
