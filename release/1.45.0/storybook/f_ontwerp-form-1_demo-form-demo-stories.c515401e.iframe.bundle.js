"use strict";(self.webpackChunkstorybook=self.webpackChunkstorybook||[]).push([[729],{"./docs/f_ontwerp/form/1_demo/form-demo.stories.ts":(e,t,l)=>{l.r(t),l.d(t,{Demo:()=>O,__namedExportsOrder:()=>R,default:()=>V});var o=l("../../node_modules/lit-html/lit-html.js"),r=l("../../libs/common/utilities/src/index.ts"),n=l("../../libs/components/src/next/button/index.ts"),s=l("../../libs/components/src/next/text/vl-text.component.ts"),i=l("../../libs/elements/src/index.ts"),a=l("../../libs/form/src/next/checkbox/vl-checkbox.component.ts"),c=l("../../libs/form/src/next/datepicker/vl-datepicker.component.ts"),d=l("../../libs/form/src/next/error-message/index.ts"),m=l("../../libs/form/src/next/form-label/index.ts"),v=l("../../libs/form/src/next/input-field/index.ts"),u=l("../../libs/form/src/next/input-field-masked/vl-input-field-masked.component.ts"),h=l("../../libs/form/src/next/radio-group/vl-radio.component.ts"),b=l("../../libs/form/src/next/radio-group/vl-radio-group.component.ts"),p=l("../../libs/form/src/next/select/index.ts"),f=l("../../libs/form/src/next/select-rich/index.ts"),x=l("../../libs/form/src/next/textarea/vl-textarea.component.ts"),g=l("../../libs/form/src/next/upload/vl-upload.component.ts"),k=l("../../libs/form/src/utils/index.ts"),y=l("../../node_modules/lit/index.js");class w extends y.WF{static{(0,r.gy)([m.E,v.Y,u.j,x.m,c.M,f.A,p.Y,b.I,h.Z,g.f,a.v,d.X,n.Y,s.T])}static get styles(){return[i.hF,(0,y.AH)`
                form {
                    margin-top: 1rem;
                    max-width: 800px;
                }
...
`;var a=l("../../libs/components/src/next/text/vl-text.defaults.ts");class c extends o.jW{static get styles(){return[i]}static get properties(){return{bold:{type:Boolean},italic:{type:Boolean},underline:{type:Boolean},success:{type:Boolean},warning:{type:Boolean},error:{type:Boolean},annotation:{type:Boolean},small:{type:Boolean}}}render(){let e={"vl-text-next--bold":this.bold,"vl-text-next--italic":this.italic,"vl-text-next--underline":this.underline,"vl-text-next--success":this.success,"vl-text-next--warning":this.warning,"vl-text-next--error":this.error,"vl-text-next--annotation":this.annotation,"vl-text-next--small":this.small};return(0,r.qy)`
            <span class="vl-text-next ${(0,n.H)(e)}">
                <slot></slot>
            </span>
        `}constructor(...e){super(...e),this.bold=a.O.bold,this.italic=a.O.italic,this.underline=a.O.underline,this.success=a.O.success,this.warning=a.O.warning,this.error=a.O.error,this.annotation=a.O.annotation,this.small=a.O.small}}c=function(e,t,l,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,l):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,o);else for(var i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n<3?r(s):n>3?r(t,l,s):r(t,l))||s);return n>3&&s&&Object.defineProperty(t,l,s),s}([(0,o.M1)("vl-text-next")],c)},"../../libs/components/src/next/text/vl-text.defaults.ts":(e,t,l)=>{l.d(t,{O:()=>o});let o={bold:!1,italic:!1,underline:!1,success:!1,warning:!1,error:!1,annotation:!1,small:!1}},"../../libs/form/src/next/checkbox/vl-checkbox.component.ts":(e,t,l)=>{l.d(t,{v:()=>v});var o=l("../../libs/common/utilities/src/index.ts"),r=l("../../libs/elements/src/index.ts"),n=l("../../node_modules/@domg/govflanders-style/common/index.js"),s=l("../../node_modules/@domg/govflanders-style/component/index.js"),i=l("../../node_modules/lit/index.js"),a=l("../../node_modules/lit/directives/class-map.js"),c=l("../../libs/form/src/next/form-control/form-control.ts");let d=(0,i.AH)`
    :host {
...
`;var m=l("../../libs/form/src/next/checkbox/vl-checkbox.defaults.ts");class v extends c.M{static get styles(){return[n.h8,n.BI,r.hF,s.Bc,d]}static get properties(){return{block:{type:Boolean},value:{type:String},checked:{type:Boolean,reflect:!0},isSwitch:{type:Boolean,attribute:"switch"}}}connectedCallback(){super.connectedCallback(),this.initialValue||(this.initialValue=this.value,this.initialCheckedValue=this.checked)}updated(e){if(super.updated(e),e.has("checked")||e.has("value")){let e=this.checked?this.value||"on":null,t={checked:this.checked};this.checked&&(t.value=e),this.setValue(e),this.dispatchEvent(new CustomEvent("vl-change",{composed:!0,bubbles:!0,detail:t})),this.dispatchInput&&(this.dispatchEvent(new CustomEvent("vl-input",{bubbles:!0,composed:!0,detail:t})),this.dispatchInput=!1),this.dispatchEventIfValid(t)}}render(){return(0,i.qy)` ${this.isSwitch?this.renderCheckboxSwitch():this.renderCheckboxDefault()} `}renderCheckboxDefault(){let e={"vl-checkbox":!0,"vl-checkbox--disabled":this.disabled,"vl-checkbox--error":this.isInvalid||this.error,"vl-checkbox--success":this.success,"vl-checkbox--block":this.block};return(0,i.qy)`
        ...
        `}get validationTarget(){return this.shadowRoot?.querySelector("input")}resetFormControl(){super.resetFormControl(),this.checked=this.initialCheckedValue,this.value=this.initialValue}toggle(){this.checked=!this.checked,this.dispatchInput=!0}constructor(...e){super(...e),this.block=m.o.block,this.value=m.o.value,this.checked=m.o.checked,this.isSwitch=m.o.isSwitch,this.initialValue=null,this.initialCheckedValue=!1,this.dispatchInput=!1}}v=function(e,t,l,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,l):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,o);else for(var i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n<3?r(s):n>3?r(t,l,s):r(t,l))||s);return n>3&&s&&Object.defineProperty(t,l,s),s}([(0,o.M1)("vl-checkbox-next")],v)},"../../libs/form/src/next/checkbox/vl-checkbox.defaults.ts":(e,t,l)=>{l.d(t,{o:()=>o});let o={...l("../../libs/form/src/next/form-control/form-control.defaults.ts").i,block:!1,value:null,checked:!1,isSwitch:!1}},"../../libs/form/src/next/error-message/index.ts":(e,t,l)=>{l.d(t,{X:()=>o.X});var o=l("../../libs/form/src/next/error-message/vl-error-message.component.ts")},"../../libs/form/src/next/form-label/index.ts":(e,t,l)=>{l.d(t,{E:()=>o.E});var o=l("../../libs/form/src/next/form-label/vl-form-label.component.ts")},"../../libs/form/src/next/form-label/vl-form-label.component.ts":(e,t,l)=>{l.d(t,{E:()=>c});var o=l("../../libs/common/utilities/src/index.ts"),r=l("../../node_modules/@domg/govflanders-style/common/index.js"),n=l("../../node_modules/lit/index.js"),s=l("../../node_modules/lit/directives/class-map.js");let i=(0,n.AH)`
    .vl-form__label {
        font-size: 1.6rem;
        font-weight: 500;
        color: #4d4d4b;
...
`;var a=l("../../libs/form/src/next/form-label/vl-form-label.defaults.ts");class c extends o.jW{static get styles(){return[r.h8,i]}static get properties(){return{for:{type:String},label:{type:String},block:{type:Boolean},light:{type:Boolean}}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.focusFormControl)}updated(e){super.updated(e);let t=this.getFormControl();t?.setAttribute("label",this.label)}disconnectedCallback(){super.disconnectedCallback();let e=this.getFormControl();e?.removeAttribute("label"),this.removeEventListener("click",this.focusFormControl)}render(){let e={"vl-form__label":!0,"vl-form__label--block":this.block,"vl-form__label--light":this.light};return(0,n.qy)` <label for=${this.for} class=${(0,s.H)(e)} part="label"> ${this.label} </label> `}getFormControl(){let e=this.closest("form");return e?.querySelector(`[id="${this.for}"]`)}focusFormControl(){let e=this.getFormControl();e?.focus()}constructor(...e){super(...e),this.for=a.x.for,this.label=a.x.label,this.block=a.x.block,this.light=a.x.light}}c=function(e,t,l,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,l):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,o);else for(var i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n<3?r(s):n>3?r(t,l,s):r(t,l))||s);return n>3&&s&&Object.defineProperty(t,l,s),s}([(0,o.M1)("vl-form-label-next")],c)},"../../libs/form/src/next/form-label/vl-form-label.defaults.ts":(e,t,l)=>{l.d(t,{x:()=>o});let o={for:"",label:"",block:!1,light:!1}},"../../libs/form/src/next/input-field-masked/masks.ts":(e,t,l)=>{l.d(t,{S:()=>o});let o={iban:{blocks:[4,4,4,4],prefix:"BE",numericOnly:!0,numeralPositiveOnly:!0,regex:/^[A-Z]{2}[0-9]{14}$/},rrn:{blocks:[2,2,2,3,2],delimiters:[".",".","-","."],numericOnly:!0,numeralPositiveOnly:!0,regex:/^[0-9]{11}$/},uuid:{blocks:[8,4,4,4,12],delimiter:"-",regex:/^[0-9a-fA-F]{32}$/,customTransformFn:e=>e.replace(/[^0-9a-fA-F-]/g,"")},date:{date:!0,datePattern:["d","m","Y"],delimiter:".",regex:/^[0-9]{8}$/},numerical:{numeral:!0,numeralDecimalMark:",",delimiter:".",regex:/^[0-9]+(.[0-9]+)?$/},price:{numeral:!0,prefix:"€",rawValueTrimPrefix:!0,numeralDecimalMark:",",delimiter:".",regex:/^[0-9]+(.[0-9]+)?$/},phone:{blocks:[3,2,2,2,2],prefix:"+32",numericOnly:!0,numeralPositiveOnly:!0,delimiter:" ",regex:/^\+[0-9]{10}$/},phoneinternational:{blocks:[99],numericOnly:!0,numeralPositiveOnly:!0,regex:/^[0-9]*$/},mobile:{blocks:[3,3,2,2,2],prefix:"+32",numericOnly:!0,numeralPositiveOnly:!0,delimiter:" ",regex:/^\+[0-9]{11}$/}}},"../../libs/form/src/next/input-field-masked/vl-input-field-masked.component.ts":(e,t,l)=>{l.d(t,{j:()=>m});var o=l("../../libs/common/utilities/src/index.ts"),r=l("../../node_modules/cleave.js/dist/cleave-esm.js"),n=l("../../libs/form/src/next/input-field/vl-input-field.component.ts"),s=l("../../libs/form/src/next/input-field-masked/masks.ts");let i={key:"patternMismatch",message:"Value does not meet the given mask pattern.",isValid(e,t){let{disableMaskValidation:l,cleaveInstance:o}=e,r=e.regex||e.maskOptions?.regex;if(!t||l||!r||!o)return!0;let n=o.getRawValue();return new RegExp(r).test(n)}},a={attribute:"min",key:"rangeUnderflow",message:e=>e.minExclusive?`Value must be greater than ${e.min}.`:`Value must be greater than or equal to ${e.min}.`,isValid(e,t){let{min:l,minExclusive:o,cleaveInstance:r}=e;if(!t||!l&&0!==l||!r)return!0;let n=r.getRawValue();return!(parseFloat(n)<l)&&(!o||parseFloat(n)!==l)}},c={attribute:"max",key:"rangeOverflow",message:e=>e.maxExclusive?`Value must be lesser than ${e.max}.`:`Value must be lesser than or equal to ${e.max}.`,isValid(e,t){let{max:l,maxExclusive:o,cleaveInstance:r}=e;if(!t||!l&&0!==l||!r)return!0;let n=r.getRawValue();return!(parseFloat(n)>l)&&(!o||parseFloat(n)!==l)}};var d=l("../../libs/form/src/next/input-field-masked/vl-input-field-masked.defaults.ts");class m extends n.Y{static{this.formControlValidators=[...n.Y.formControlValidators,i,a,c]}static get properties(){return{mask:{type:String},maskPrefix:{type:String,attribute:"mask-prefix"},rawValue:{type:Boolean,attribute:"raw-value"},disableMaskValidation:{type:Boolean,attribute:"disable-mask-validation"}}}connectedCallback(){super.connectedCallback(),this.maskOptions={...s.S[this.mask],onValueChanged:e=>{this.handleValueChanged(e?.target?.value)}},this.maskOptions&&(this.maskOptions.numericOnly?this.inputMode="numeric":"date"===this.mask?this.inputMode="decimal":this.inputMode="text",this.maskPrefix&&(this.maskOptions.prefix=this.maskPrefix),this.value.startsWith(this.maskOptions.prefix||"")||(this.value=this.maskOptions.prefix+this.value))}firstUpdated(e){super.firstUpdated(e),this.maskOptions&&(this.cleaveInstance=new r.A(this.validationTarget,this.maskOptions))}resetFormControl(){super.resetFormControl(),this.initialValue.startsWith(this.maskOptions?.prefix||"")?this.value=this.initialValue:this.value=this.maskOptions?.prefix+this.initialValue}getRawValue(){return this.cleaveInstance?.getRawValue()}onInput(){this.dispatchInput=!0}onUpdated(e){if(e.has("value")||e.has("rawValue")){let e=this.rawValue?this.getRawValue()||"":this.value;(this.value===this.maskOptions?.prefix||this.getRawValue()===this.maskOptions?.prefix)&&(e="");let t={value:e};this.setValue(e),this.dispatchEvent(new CustomEvent("vl-change",{composed:!0,bubbles:!0,detail:t})),this.dispatchInput&&(this.dispatchEvent(new CustomEvent("vl-input",{composed:!0,bubbles:!0,detail:t})),this.dispatchInput=!1),this.dispatchEventIfValid(t)}}handleValueChanged(e){let t=this.maskOptions?.customTransformFn,l=t?t(e):e;this.value=l}constructor(...e){super(...e),this.mask=d.e.mask,this.maskPrefix=d.e.maskPrefix,this.rawValue=d.e.rawValue,this.disableMaskValidation=d.e.disableMaskValidation,this.maskOptions=null,this.cleaveInstance=null}}m=function(e,t,l,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,l):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,o);else for(var i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n<3?r(s):n>3?r(t,l,s):r(t,l))||s);return n>3&&s&&Object.defineProperty(t,l,s),s}([(0,o.M1)("vl-input-field-masked-next")],m)},"../../libs/form/src/next/input-field-masked/vl-input-field-masked.defaults.ts":(e,t,l)=>{l.d(t,{e:()=>o});let o={...l("../../libs/form/src/next/input-field/vl-input-field.defaults.ts").f,mask:"",maskPrefix:"",rawValue:!1,disableMaskValidation:!1}},"../../libs/form/src/next/input-field/index.ts":(e,t,l)=>{l.d(t,{Y:()=>o.Y});var o=l("../../libs/form/src/next/input-field/vl-input-field.component.ts")},"../../libs/form/src/next/radio-group/vl-radio-group.component.ts":(e,t,l)=>{l.d(t,{I:()=>m});var o=l("../../libs/common/utilities/src/index.ts"),r=l("../../libs/elements/src/index.ts"),n=l("../../node_modules/@domg/govflanders-style/common/index.js"),s=l("../../node_modules/@domg/govflanders-style/component/index.js"),i=l("../../node_modules/lit/index.js"),a=l("../../libs/form/src/next/form-control/form-control.ts"),c=l("../../libs/form/src/next/radio-group/vl-radio-group.defaults.ts"),d=l("../../libs/form/src/next/radio-group/vl-radio.component.uig-css.ts");class m extends a.M{static get styles(){return[n.h8,n.BI,r.hF,s.T9,d.A]}static get properties(){return{readonly:{type:Boolean},value:{type:String,reflect:!0},block:{type:Boolean}}}connectedCallback(){super.connectedCallback(),this.addEventListener("vl-change",this.updateGroupAfterCheck),this.addEventListener("keydown",this.handleKeyDown)}firstUpdated(e){super.firstUpdated(e),this.initialValue||(this.initialValue=this.value)}updated(e){super.updated(e),e.has("value")&&(this.setValue(this.value),this.checkRadioForValue(this.value)),e.has("name")&&this.updateRadiosForAttribute("name"),e.has("block")&&this.updateRadiosForAttribute("block"),e.has("readonly")&&(this.updateRadiosForAttribute("readonly"),this.preventDefaultEventOnAllInputsOfAllRadio(this.readonly)),e.has("disabled")&&this.updateRadiosForAttribute("disabled"),e.has("error")&&this.updateRadiosForAttribute("error"),e.has("isInvalid")&&this.getRadios()?.forEach(e=>{this.isInvalid?(e.setAttribute("error",""),e?.validationTarget?.setAttribute("aria-invalid","true")):(e.removeAttribute("error"),e?.validationTarget?.removeAttribute("aria-invalid"))}),e.has("success")&&this.updateRadiosForAttribute("success")}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("vl-change",this.updateGroupAfterCheck)}render(){return(0,i.qy)`
            <fieldset>
                <legend class="vl-u-visually-hidden">${this.label}</legend>
                <slot></slot>
            </fieldset>
        `}resetFormControl(){super.resetFormControl(),this.resetAllRadios(),this.resetToInitialValue()}get validationTarget(){let e=this.getRadios()[0];return e?e.validationTarget:null}resetToInitialValue(){this.setValue(this.initialValue),this.checkRadioForValue(this.initialValue),this.value=this.initialValue}checkRadioForValue(e){this.getRadios()?.forEach(t=>{e&&t.getAttribute("value")===e?t.setAttribute("checked",""):t.removeAttribute("checked")})}resetAllRadios(){this.getRadios()?.forEach(e=>{e.removeAttribute("checked")})}preventDefaultEventOnAllInputsOfAllRadio(e){this.getRadios()?.forEach(t=>{e?t.addEventListener("click",this.preventDefaultAndFocus):t.removeEventListener("click",this.preventDefaultAndFocus)})}updateRadiosForAttribute(e){this.getRadios()?.forEach(t=>this[e]?t.setAttribute(e,""):t.removeAttribute(e))}getRadios(){return Array.from(this.querySelectorAll("vl-radio-next"))}checkSelectedRadio(e){this.getRadios()?.forEach(t=>{let l=t.getAttribute("value");t!==e?t.removeAttribute("checked"):(t.hasAttribute("checked")||t.setAttribute("checked",""),this.value=l,this.setValue(l))})}navigateRadioButtons(e){let t;let l=this.getRadios(),o=l.findIndex(e=>e.hasAttribute("checked"));"ArrowLeft"===e||"ArrowUp"===e?(t=o-1)<0&&(t=l.length-1):("ArrowRight"===e||"ArrowDown"===e)&&(t=o+1)>=l.length&&(t=0),this.checkSelectedRadio(l[t]),l[t].focus()}updateGroupAfterCheck(e){let t=e.target;this.checkSelectedRadio(t)}constructor(...e){super(...e),this.readonly=c.P.readonly,this.value=c.P.value,this.initialValue=null,this.preventDefaultAndFocus=e=>{let t=e.target;t?.validationTarget?.focus(),e.preventDefault()},this.handleKeyDown=e=>{if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown"].includes(e.code)&&(e.preventDefault(),this.navigateRadioButtons(e.code)),"Space"===e.code){let e=this.getRadios()?.find(e=>e===document.activeElement);e&&!e.hasAttribute("checked")&&this.checkSelectedRadio(e)}}}}m=function(e,t,l,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,l):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,o);else for(var i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n<3?r(s):n>3?r(t,l,s):r(t,l))||s);return n>3&&s&&Object.defineProperty(t,l,s),s}([(0,o.M1)("vl-radio-group-next")],m)},"../../libs/form/src/next/radio-group/vl-radio-group.defaults.ts":(e,t,l)=>{l.d(t,{P:()=>o});let o={...l("../../libs/form/src/next/form-control/form-control.defaults.ts").i,readonly:!1,value:null}},"../../libs/form/src/next/radio-group/vl-radio.component.ts":(e,t,l)=>{l.d(t,{Z:()=>v});var o=l("../../libs/common/utilities/src/index.ts"),r=l("../../libs/elements/src/index.ts"),n=l("../../node_modules/@domg/govflanders-style/common/index.js"),s=l("../../node_modules/@domg/govflanders-style/component/index.js"),i=l("../../node_modules/lit/index.js"),a=l("../../node_modules/lit/directives/class-map.js"),c=l("../../node_modules/lit/directives/live.js"),d=l("../../libs/form/src/next/radio-group/vl-radio.component.uig-css.ts"),m=l("../../libs/form/src/next/radio-group/vl-radio.defaults.ts");class v extends o.jW{static{this.shadowRootOptions={...i.WF.shadowRootOptions,delegatesFocus:!0}}static get styles(){return[n.h8,n.BI,r.hF,s.T9,d.A]}static get properties(){return{id:{type:String},name:{type:String},value:{type:String},label:{type:String},disabled:{type:Boolean},readonly:{type:Boolean},error:{type:Boolean},success:{type:Boolean},block:{type:Boolean},checked:{type:Boolean,reflect:!0}}}updated(e){if(super.updated(e),(e.has("checked")||e.has("value"))&&this.checked){let e={checked:!0,value:this.value};this.dispatchEvent(new CustomEvent("vl-change",{composed:!0,bubbles:!0,detail:e})),this.dispatchInput&&(this.dispatchEvent(new CustomEvent("vl-input",{bubbles:!0,composed:!0,detail:e})),this.dispatchInput=!1),this.dispatchEvent(new CustomEvent("vl-valid",{composed:!0,bubbles:!0,detail:e}))}}render(){let e={"vl-radio":!0,"vl-radio--block":this.block,"vl-radio--disabled":this.disabled,"vl-radio--error":this.error,"vl-radio--success":this.success};return(0,i.qy)`
        ...
        `}get validationTarget(){return this.shadowRoot?.querySelector("input")}onChange(){this.checked=!this.checked}onInput(){this.dispatchInput=!0}constructor(...e){super(...e),this.id=m.Q.id,this.name=m.Q.name,this.value=m.Q.value,this.label=m.Q.label,this.block=m.Q.block,this.readonly=m.Q.readonly,this.disabled=m.Q.disabled,this.error=m.Q.error,this.success=m.Q.success,this.checked=m.Q.checked,this.dispatchInput=!1}}v=function(e,t,l,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,l):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,o);else for(var i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n<3?r(s):n>3?r(t,l,s):r(t,l))||s);return n>3&&s&&Object.defineProperty(t,l,s),s}([(0,o.M1)("vl-radio-next")],v)},"../../libs/form/src/next/radio-group/vl-radio.component.uig-css.ts":(e,t,l)=>{l.d(t,{A:()=>r});var o=l("../../node_modules/lit/index.js");let r=(0,o.AH)`
...
`},"../../libs/form/src/next/radio-group/vl-radio.defaults.ts":(e,t,l)=>{l.d(t,{Q:()=>o});let o={id:"radio",name:"",value:null,label:"",block:!1,readonly:!1,disabled:!1,error:!1,success:!1,checked:!1}},"../../libs/form/src/next/select-rich/index.ts":(e,t,l)=>{l.d(t,{A:()=>o.Al});var o=l("../../libs/form/src/next/select-rich/vl-select-rich.component.ts");l("../../libs/form/src/next/select-rich/vl-select-rich.model.ts")},"../../libs/form/src/next/select/index.ts":(e,t,l)=>{l.d(t,{Y:()=>o.Y});var o=l("../../libs/form/src/next/select/vl-select.component.ts")},"../../libs/form/src/next/select/vl-select.component.ts":(e,t,l)=>{l.d(t,{Y:()=>u});var o=l("../../libs/common/utilities/src/index.ts"),r=l("../../node_modules/@domg/govflanders-style/common/index.js"),n=l("../../node_modules/@domg/govflanders-style/component/index.js"),s=l("../../node_modules/lit/index.js"),i=l("../../node_modules/lit/directives/class-map.js"),a=l("../../node_modules/lit/directives/live.js"),c=l("../../libs/form/src/next/form-control/form-control.ts");let d=(0,s.AH)`
    .vl-select {
        background-color: #fff;
        appearance: none;
        display: inline-block;
...
`;var v=l("../../libs/form/src/next/select/vl-select.defaults.ts");class u extends c.M{static get styles(){return[r.h8,r.BI,d,n.py,m]}static get properties(){return{options:{type:Array},block:{type:Boolean},readonly:{type:Boolean},placeholder:{type:String},autocomplete:{type:String},notDeletable:{type:Boolean,attribute:"not-deletable"},value:{type:String,state:!0}}}connectedCallback(){super.connectedCallback();let e=this.getSelectedOption();this.value=e?.value??null,this.initialOptions=JSON.parse(JSON.stringify(this.options))}updated(e){if(super.updated(e),e.has("options")){let e=this.getSelectedOption();this.value=e?.value??null}if(e.has("value")){let e={value:this.value};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-change",{composed:!0,bubbles:!0,detail:e})),this.dispatchInput&&(this.dispatchEvent(new CustomEvent("vl-input",{bubbles:!0,composed:!0,detail:e})),this.dispatchInput=!1),this.dispatchEventIfValid(e)}}render(){let e={"vl-select__container":!0,"vl-select__container--block":this.block},t={"vl-select":!0,"vl-select--disabled":this.disabled,"vl-select--error":this.isInvalid||this.error,"vl-select--success":this.success,"vl-select--block":this.block},l=null!==this.value,o=this.options.some(e=>e.group);return(0,s.qy)`
        ...
        `}renderGroupedOptions(){return Object.entries(this.getGroupedOptions()).map(([e,t])=>(0,s.qy)` <optgroup label=${e}>${this.renderSelectOptions(t)}</optgroup>`)}renderSelectOptions(e){return e.map(e=>(0,s.qy)` <option
            ...
            >
                ${e.label||e.value}
            </option>`)}get validationTarget(){return this.shadowRoot?.querySelector("select")}resetFormControl(){for(super.resetFormControl();this.options.length;)this.options.pop();this.initialOptions.forEach(e=>this.options.push({...e})),this.value&&this.requestUpdate("options")}onChange(e){this.value=e?.target?.value}onSelect(){this.dispatchInput=!0}clearValue(){this.dispatchInput=!0,this.value=null}getSelectedOption(){return[...this.options].reverse().find(e=>e.selected)}getGroupedOptions(){return this.options.reduce((e,t)=>{let l=t.group||this.DEFAULT_GROUP_LABEL;return e[l]?e[l].push(t):e[l]=[t],e},{})}constructor(...e){super(...e),this.options=v.p.options,this.block=v.p.block,this.placeholder=v.p.placeholder,this.autocomplete=v.p.autocomplete,this.notDeletable=v.p.notDeletable,this.value=null,this.initialOptions=[],this.DEFAULT_GROUP_LABEL="Overig",this.dispatchInput=!1}}u=function(e,t,l,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,l):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,o);else for(var i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n<3?r(s):n>3?r(t,l,s):r(t,l))||s);return n>3&&s&&Object.defineProperty(t,l,s),s}([(0,o.M1)("vl-select-next")],u)},"../../libs/form/src/next/select/vl-select.defaults.ts":(e,t,l)=>{l.d(t,{p:()=>o});let o={...l("../../libs/form/src/next/form-control/form-control.defaults.ts").i,options:[],block:!1,placeholder:"",autocomplete:"",notDeletable:!1}},"../../libs/form/src/next/textarea/vl-textarea.component.ts":(e,t,l)=>{l.d(t,{m:()=>v});var o=l("../../libs/common/utilities/src/index.ts"),r=l("../../node_modules/@domg/govflanders-style/common/index.js"),n=l("../../node_modules/@domg/govflanders-style/component/index.js"),s=l("../../node_modules/@open-wc/form-control/src/validators.js"),i=l("../../node_modules/lit/index.js"),a=l("../../node_modules/lit/directives/class-map.js"),c=l("../../node_modules/lit/directives/live.js"),d=l("../../libs/form/src/next/form-control/form-control.ts"),m=l("../../libs/form/src/next/textarea/vl-textarea.defaults.ts");class v extends d.M{static{this.formControlValidators=[...d.M.formControlValidators,s.bO,s.jD]}static get styles(){return[r.h8,r.BI,n.ag]}static get properties(){return{block:{type:Boolean},readonly:{type:Boolean},value:{type:String,reflect:!0},placeholder:{type:String},autocomplete:{type:String},minLength:{type:Number,attribute:"min-length"},maxLength:{type:Number,attribute:"max-length"},rows:{type:Number},cols:{type:Number}}}connectedCallback(){super.connectedCallback(),this.initialValue||(this.initialValue=this.value)}updated(e){if(super.updated(e),e.has("value")){let e={value:this.value};this.setValue(this.value),this.dispatchEvent(new CustomEvent("vl-change",{composed:!0,bubbles:!0,detail:e})),this.dispatchInput&&(this.dispatchEvent(new CustomEvent("vl-input",{composed:!0,bubbles:!0,detail:e})),this.dispatchInput=!1),this.dispatchEventIfValid(e)}}render(){let e={"vl-textarea":!0,"vl-textarea--disabled":this.disabled,"vl-textarea--error":this.isInvalid||this.error,"vl-textarea--success":this.success,"vl-textarea--block":this.block};return(0,i.qy)`
            <textarea
                id=${this.id||i.s6}
                name=${this.name||i.s6}
                class=${(0,a.H)(e)}
                ...
                @input=${this.onInput}
            />
        `}get validationTarget(){return this.shadowRoot?.querySelector("textarea")}resetFormControl(){super.resetFormControl(),this.value=this.initialValue}onInput(e){this.dispatchInput=!0,this.value=e?.target?.value}constructor(...e){super(...e),this.block=m.r.block,this.readonly=m.r.readonly,this.value=m.r.value,this.placeholder=m.r.placeholder,this.autocomplete=m.r.autocomplete,this.minLength=m.r.minLength,this.maxLength=m.r.maxLength,this.rows=m.r.rows,this.cols=m.r.cols,this.initialValue="",this.dispatchInput=!1}}v=function(e,t,l,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,l):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,l,o);else for(var i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n<3?r(s):n>3?r(t,l,s):r(t,l))||s);return n>3&&s&&Object.defineProperty(t,l,s),s}([(0,o.M1)("vl-textarea-next")],v)},"../../libs/form/src/next/textarea/vl-textarea.defaults.ts":(e,t,l)=>{l.d(t,{r:()=>o});let o={...l("../../libs/form/src/next/form-control/form-control.defaults.ts").i,block:!1,readonly:!1,value:"",placeholder:"",autocomplete:"",minLength:null,maxLength:null,rows:null,cols:null}},"../../libs/form/src/utils/index.ts":(e,t,l)=>{l.d(t,{S:()=>r});var o=l("../../libs/form/src/next/form-control/form-control.ts");let r=(e,t)=>{if(!e)return;let l=new FormData(e),r=e=>e instanceof o.M||e instanceof HTMLInputElement||e instanceof HTMLSelectElement||e instanceof HTMLTextAreaElement,n=Array.from(l.keys()).filter(e=>l.getAll(e).length>1),s=Array.from(e.querySelectorAll("*")).filter(e=>r(e)&&e.hasAttribute("multiple")).map(e=>e.getAttribute("name")),i=t||Array.from(new Set([...n,...s]));return Array.from(l.keys()).reduce((e,t)=>({...e,[t]:i.includes(t)?l.getAll(t):l.get(t)}),{})}}}]);