...
`,...d.oi,y,b.D];var f=o("../../libs/map/src/vl-map.model.ts");class m extends(0,n.H3)(HTMLElement){constructor(){super(`
          <style>
            ${u.join("")}
          </style>
          <div id='map'>
