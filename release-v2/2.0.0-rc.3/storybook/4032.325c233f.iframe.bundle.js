            ...
            <div class="vl-group vl-group--input-group" id="datepicker-wrapper">
                ${this.flatpickrInstance?.isMobile&&!this.disableMobileNativeInput?u.s6:(0,u.qy)`
                          <input
                              ...
                              aria-invalid=${this.isInvalid||u.s6}
                              ?required=${this.required}
                              ?disabled=${this.disabled}
                              ?error=${this.error}
                              ?readonly=${this.readonly}
                              .value=${(0,c.V)(this.inputValue)}
                              placeholder=${this.placeholder||u.s6}
                              autocomplete=${this.autocomplete||u.s6}
                              pattern=${this.pattern||u.s6}
                              inputmode=${this.cleaveInstance?"numeric":u.s6}
                              @focus="${this.onInputFocus}"
                              @blur="${this.onInputBlur}"
                              @input=${this.cleaveInstance?u.s6:this.onInput}
                          />
                          <button
                              id="toggle-calendar"
                              type="button"
