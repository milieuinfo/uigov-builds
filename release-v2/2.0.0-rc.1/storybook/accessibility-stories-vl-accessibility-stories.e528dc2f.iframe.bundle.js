...
`,h=({compliance:e,evaluation:i})=>(0,s.qy)`
    ...
    </div>`,j=()=>[m.Y,u.P,p.L],L=({application:e,compliance:i,date:t,dateModified:n,evaluation:a,limitations:l})=>(0,s.qy)` <section id="content" is="vl-region">
