...
`;class y extends a.F9{static{(0,a.gy)([k.L,r.IM])}constructor({title:e,name:n,purpose:t,domain:i,processor:o,validity:a}={}){super(`
            <style>
                ${l.oi.join("")}
                ${f}
            </style>
    ...
    `)}static get _observedAttributes(){return["date","disable-back-link","hide-back-link","version"]}_versionChangedCallback(e,n){(this._shadow?.getElementById("introduction-version")).innerText=n}_dateChangedCallback(e,n){(this._shadow?.getElementById("introduction-date")).innerText=n}_disableBackLinkChangedCallback(){let e=this._shadow?.querySelector("vl-functional-header");this.hasAttribute("disable-back-link")?e?.setAttribute("disable-back-link",""):e?.removeAttribute("disable-back-link")}_hideBackLinkChangedCallback(){let e=this._shadow?.querySelector("vl-functional-header");this.hasAttribute("hide-back-link")?e?.setAttribute("hide-back-link",""):e?.removeAttribute("hide-back-link")}}C=function(e,n,t,i){var o,a=arguments.length,l=a<3?n:null===i?i=Object.getOwnPropertyDescriptor(n,t):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,n,t,i);else for(var r=e.length-1;r>=0;r--)(o=e[r])&&(l=(a<3?o(l):a>3?o(n,t,l):o(n,t))||l);return a>3&&l&&Object.defineProperty(n,t,l),l}([(0,a.M1)("vl-cookie-statement")],C);var B=t("../../node_modules/lit/directives/unsafe-html.js");let D={date:"3 maart 2021",disableBackLink:!1,hideBackLink:!1,version:"1.0.0",onClickBack:(0,t("../../node_modules/@storybook/addon-actions/dist/index.mjs").XI)("vl-click-back"),headerSlot:""},E={date:{name:"date",description:"De datum waarop de pagina werd uitgegeven.",table:{type:{summary:i.QE.STRING},category:i.R6.ATTRIBUTES,defaultValue:{summary:D.date}}},disableBackLink:{name:"disable-back-link",description:"Zet de terug-link uit.",table:{type:{summary:i.QE.BOOLEAN},category:i.R6.ATTRIBUTES,defaultValue:{summary:D.disableBackLink}}},hideBackLink:{name:"hide-back-link",description:"Verwijdert de terug-link.",table:{type:{summary:i.QE.BOOLEAN},category:i.R6.ATTRIBUTES,defaultValue:{summary:D.hideBackLink}}},version:{name:"version",description:"De pagina versie.",table:{type:{summary:i.QE.STRING},category:i.R6.ATTRIBUTES,defaultValue:{summary:D.version}}},onClickBack:{name:"vl-click-back",description:"Afgevuurd na het klikken op de terug-link.",table:{type:{summary:"-"},category:i.R6.EVENTS}},headerSlot:{name:"header",description:"Hiermee kan je de standaard functional header vervangen door een header naar keuze.",table:{type:{summary:i.QE.HTML},category:i.R6.SLOTS,defaultValue:D.headerSlot}}};t("../../node_modules/react/index.js");var A=t("../../node_modules/react/jsx-runtime.js"),L=t("../../node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),_=t("../../node_modules/@storybook/blocks/dist/index.mjs");function T(e){let n=Object.assign({h1:"h1",p:"p",h2:"h2",pre:"pre",code:"code",ul:"ul",li:"li",a:"a",h3:"h3"},(0,L.RP)(),e.components),{FluxMetaData:t}=n;return t||function(e,n){throw Error("Expected "+(n?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}("FluxMetaData",!0),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(n.h1,{id:"cookie-statement",children:"Cookie Statement"}),"\n",(0,A.jsx)(t,{id:"components-compliance-cookie-statement"}),"\n",(0,A.jsx)(n.p,{children:"Cookieverklaring pagina."}),"\n",(0,A.jsx)(n.h2,{id:"voorbeeld",children:"Voorbeeld"}),"\n",(0,A.jsx)(n.pre,{children:(0,A.jsx)(n.code,{className:"language-js",children:"import { VlCookieStatement } from '@domg-wc/components/compliance';\n"})}),"\n",(0,A.jsx)(n.pre,{children:(0,A.jsx)(n.code,{className:"language-html",children:"<vl-cookie-statement></vl-cookie-statement>\n"})}),"\n",(0,A.jsx)(_.Hl,{of:I}),"\n",(0,A.jsx)(n.h2,{id:"configuratie",children:"Configuratie"}),"\n",(0,A.jsx)(_.ov,{of:I}),"\n",(0,A.jsx)(n.h2,{id:"header-slot",children:"Header Slot"}),"\n",(0,A.jsxs)(n.p,{children:["Standaard wordt deze template gebruikt om de ",(0,A.jsx)(n.code,{children:"functional-header"})," te bepalen in dit component."]}),"\n",(0,A.jsx)(_.kL,{code:'import { html } from \'lit\';\nimport { VlFunctionalHeaderComponent } from \'../../../block/functional-header\';\nexport const cookieStatementHeaderElements = ()=>[\n        VlFunctionalHeaderComponent\n    ];\nexport const header = ()=>html`\n    <vl-functional-header\n        title="Departement Omgeving"\n        sub-title="Cookieverklaring"\n        link="https://omgeving.vlaanderen.be"\n    ></vl-functional-header>\n`;\n',language:"ts",dark:!0}),"\n",(0,A.jsxs)(n.p,{children:["Als je wijzigingen wil aanbrengen in de functional header, kan je de standaard ",(0,A.jsx)(n.code,{children:"vl-functional-header"})," vervangen door een\nander, eventueel aangepaste header element."]}),"\n",(0,A.jsx)(n.p,{children:"Je kan dit bijvoorbeeld vervangen door:"}),"\n",(0,A.jsxs)(n.ul,{children:["\n",(0,A.jsxs)(n.li,{children:["een ",(0,A.jsx)(n.a,{href:"/docs/components-block-content-header--content-header-default",children:"vl-content-header"})]}),"\n",(0,A.jsxs)(n.li,{children:["of een ",(0,A.jsx)(n.a,{href:"/docs/components-block-functional-header--functional-header-default",children:"vl-functional-header"})," met andere opties dan de standaard ",(0,A.jsx)(n.code,{children:"functional-header"})," van dit component."]}),"\n"]}),"\n",(0,A.jsxs)(n.p,{children:["In het voorbeeld hieronder kan je zien hoe je voor de ",(0,A.jsx)(n.code,{children:"vl-functional-header"})," bij de teruglink (",(0,A.jsx)(n.code,{children:"back"}),') "Start"\nals label kan geven in plaats van "Terug".']}),"\n",(0,A.jsx)(_.Hl,{of:$}),"\n",(0,A.jsx)(n.h2,{id:"referenties",children:"Referenties"}),"\n",(0,A.jsx)(n.h3,{id:"legacy-documentatie",children:"Legacy Documentatie"}),"\n",(0,A.jsx)(n.p,{children:(0,A.jsx)(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/storybook/?path=/docs/legacy-vl-cookie-statement--default",target:"_blank",rel:"nofollow noopener noreferrer",children:"Legacy Storybook - Cookie Statement"})}),"\n",(0,A.jsx)(n.p,{children:(0,A.jsx)(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/doc/VlCookieStatement.html",target:"_blank",rel:"nofollow noopener noreferrer",children:"Legacy Documentatie - Cookie Statement"})}),"\n",(0,A.jsx)(n.p,{children:(0,A.jsx)(n.a,{href:"https://webcomponenten.omgeving.vlaanderen.be/demo/vl-cookie-statement.html",target:"_blank",rel:"nofollow noopener noreferrer",children:"Legacy Demo - Cookie Statement"})})]})}let R={id:"components-compliance-cookie-statement",title:"Components - Compliance/cookie-statement",tags:["autodocs"],args:D,argTypes:E,parameters:{layout:"fullscreen",docs:{page:function(e={}){let{wrapper:n}=Object.assign({},(0,L.RP)(),e.components);return n?(0,A.jsx)(n,Object.assign({},e,{children:(0,A.jsx)(T,e)})):T(e)}}}},z=(0,i._7)(D,({date:e,disableBackLink:n,hideBackLink:t,version:i,onClickBack:a,headerSlot:l})=>(0,o.qy)`
        <vl-cookie-statement
            date=${e}
            ?disable-back-link=${n}
            ?hide-back-link=${t}
    ...
    `),I=z.bind({});I.storyName="vl-cookie-statement - default";let $=z.bind({});$.storyName="vl-cookie-statement - header slot",$.args={headerSlot:`
    <vl-functional-header
        slot="header"
        title="Departement Omgeving"
        sub-title="Cookieverklaring"
